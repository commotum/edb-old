...
public final class datafy$fn__17220
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.datafy", (String)"ObjectToData");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__17222;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__17222 = var2;
        v__6457__auto__17222 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return datafy$fn__17220.invokeStatic();
    }
}
