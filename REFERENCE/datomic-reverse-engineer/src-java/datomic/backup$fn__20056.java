...
public final class backup$fn__20056
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.backup", (String)"IValueBackup");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__20058;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__20058 = var2;
        v__6457__auto__20058 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return backup$fn__20056.invokeStatic();
    }
}
