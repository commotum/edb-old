...
public final class simple_kv$fn__16683
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.simple-kv", (String)"KV");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__16685;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__16685 = var2;
        v__6457__auto__16685 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return simple_kv$fn__16683.invokeStatic();
    }
}
