...
public final class ClusteredFulltext$reify__14730
...
IObj {
    ...
    public ClusteredFulltext$reify__14730(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public ClusteredFulltext$reify__14730(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new ClusteredFulltext$reify__14730(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical((Object)((IFn)const__1.getRawRoot()).invoke(gtarget), (Object)this.gclass)) {
            ...
            gtarget = null;
            object = ((ClusteredFulltext)object2).olookup;
        } else {
            object = this;
        }
        return object;
