...
import datomic.cassandra_values$get_value$fn__20561$fn__20565;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public final class cassandra_values$get_value$fn__20561
extends AFunction {
    Object session;
    Object id;
    Object table;
    ...
    public cassandra_values$get_value$fn__20561(Object object, Object object2, Object object3) {
        this.session = object;
        this.id = object2;
        this.table = object3;
    }

    public Object invoke(Object p1__20554_SHARP_) {
        Object object;
        IPersistentMap iPersistentMap;
        ILookupThunk iLookupThunk = __thunk__4__;
        IPersistentMap m_20562 = RT.mapUniqueKeys((Object[])new Object[]{const__1, const__2, const__3, this.id, const__4, p1__20554_SHARP_});
        Logger logger = LoggerFactory.getLogger((String)"datomic.cassandra-values");
        if (logger.isDebugEnabled()) {
            Logger logger2 = logger;
            logger = null;
            logger2.debug((String)((IFn)const__5.getRawRoot()).invoke(((IFn)const__6.getRawRoot()).invoke((Object)m_20562, (Object)const__7, (Object)const__8)));
        }
        long start__8981__auto__20572 = System.nanoTime();
        Object object2 = p1__20554_SHARP_;
        p1__20554_SHARP_ = null;
        Object result__8982__auto__20573 = ((IFn)new cassandra_values$get_value$fn__20561$fn__20565(this.session, this.id, this.table, object2)).invoke();
        long elapsed_20563 = Numbers.minus((long)System.nanoTime(), (long)start__8981__auto__20572);
        Object msec_20564 = ((IFn)const__10.getRawRoot()).invoke((Object)Numbers.num((long)elapsed_20563));
        IFn iFn = (IFn)const__11.getRawRoot();
        IPersistentMap iPersistentMap2 = m_20562;
        m_20562 = null;
        Object object3 = msec_20564;
        msec_20564 = null;
        ...
        Object object5 = result__8982__auto__20573;
        ...
        if (object6 != null && object6 != Boolean.FALSE) {
            ...
            Object object7 = result__8982__auto__20573;
        ...
        Object endmsg__8984__auto__20570 = iFn.invoke(object4, iPersistentMap);
        Logger logger3 = LoggerFactory.getLogger((String)"datomic.cassandra-values");
        if (logger3.isDebugEnabled()) {
            Logger logger4 = logger3;
            logger3 = null;
            Object object9 = endmsg__8984__auto__20570;
            endmsg__8984__auto__20570 = null;
            logger4.debug((String)((IFn)const__5.getRawRoot()).invoke(object9));
        }
        Object object10 = ((IFn)const__16.getRawRoot()).invoke(result__8982__auto__20573, (Object)const__17);
        if (object10 != null && object10 != Boolean.FALSE) {
            ILookupThunk iLookupThunk4 = __thunk__2__;
            Object object11 = result__8982__auto__20573;
            result__8982__auto__20573 = null;
            ...
            Object object12 = result__8982__auto__20573;
            result__8982__auto__20573 = null;
