...
public final class aws_monitor$fn__23571
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.aws-monitor", (String)"Qn");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__23573;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__23573 = var2;
        v__6457__auto__23573 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return aws_monitor$fn__23571.invokeStatic();
    }
}
