...
import datomic.db$fn__13367$__GT_MemLog__13382;
import datomic.db$fn__13367$map__GT_MemLog__13384;
import java.util.Arrays;

public final class db$fn__13367
extends AFunction {
    ...
    public static final Var const__5 = RT.var((String)"datomic.db", (String)"map->MemLog");
    ...
    public static final Object const__12 = RT.classForName((String)"datomic.db.MemLog");

    public static Object invokeStatic() {
        const__0.setMeta((IPersistentMap)const__4);
        const__5.setMeta((IPersistentMap)const__6);
        ((Namespace)RT.CURRENT_NS.deref()).importClass(RT.classForNameNonLoading((String)"datomic.db.MemLog"));
        Var var = const__0;
        var.setMeta((IPersistentMap)const__9);
        var.bindRoot((Object)new db$fn__13367$__GT_MemLog__13382());
        Var var2 = const__5;
        var2.setMeta((IPersistentMap)const__11);
        var2.bindRoot((Object)new db$fn__13367$map__GT_MemLog__13384());
        return const__12;
    }

    public Object invoke() {
        return db$fn__13367.invokeStatic();
    }
}
