...
import datomic.garbage.fressian$fn__16592$__GT_GarbageDir__16607;
import datomic.garbage.fressian$fn__16592$map__GT_GarbageDir__16609;
import java.util.Arrays;

public final class fressian$fn__16592
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.garbage.fressian", (String)"->GarbageDir");
    ...
    public static final Var const__5 = RT.var((String)"datomic.garbage.fressian", (String)"map->GarbageDir");
    ...
    public static final Object const__12 = RT.classForName((String)"datomic.garbage.fressian.GarbageDir");

    public static Object invokeStatic() {
        const__0.setMeta((IPersistentMap)const__4);
        const__5.setMeta((IPersistentMap)const__6);
        ((Namespace)RT.CURRENT_NS.deref()).importClass(RT.classForNameNonLoading((String)"datomic.garbage.fressian.GarbageDir"));
        Var var = const__0;
        var.setMeta((IPersistentMap)const__9);
        var.bindRoot((Object)new fressian$fn__16592$__GT_GarbageDir__16607());
        Var var2 = const__5;
        var2.setMeta((IPersistentMap)const__11);
        var2.bindRoot((Object)new fressian$fn__16592$map__GT_GarbageDir__16609());
        return const__12;
    }

    public Object invoke() {
        return fressian$fn__16592.invokeStatic();
    }
}
