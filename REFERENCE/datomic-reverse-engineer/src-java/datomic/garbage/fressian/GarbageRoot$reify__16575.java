...
public final class GarbageRoot$reify__16575
...
IObj {
    ...
    public GarbageRoot$reify__16575(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public GarbageRoot$reify__16575(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new GarbageRoot$reify__16575(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical((Object)((IFn)const__1.getRawRoot()).invoke(gtarget), (Object)this.gclass)) {
            ...
            gtarget = null;
            object = ((GarbageRoot)object2).children;
        } else {
            object = this;
        }
        return object;
