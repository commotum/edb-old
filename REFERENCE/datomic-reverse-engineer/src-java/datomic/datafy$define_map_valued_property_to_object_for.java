...
import datomic.datafy$define_map_valued_property_to_object_for$fn__17345;

public final class datafy$define_map_valued_property_to_object_for
extends RestFn {
    ...
    public static Object invokeStatic(Object _AMPERSAND_form, Object _AMPERSAND_env, ISeq descs) {
        ISeq iSeq = descs;
        descs = null;
        return ((IFn)const__0.getRawRoot()).invoke(((IFn)const__1.getRawRoot()).invoke(((IFn)const__2.getRawRoot()).invoke((Object)const__3), ((IFn)const__4.getRawRoot()).invoke((Object)new datafy$define_map_valued_property_to_object_for$fn__17345(), (Object)iSeq)));
    }
    ...
    public Object doInvoke(Object object, Object object2, Object object3) {
        ...
        object3 = null;
        return datafy$define_map_valued_property_to_object_for.invokeStatic(object4, object5, iSeq);
    }
