...
public final class impl$fn__343
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.cache.impl", (String)"CacheRemove");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__345;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__345 = var2;
        v__6457__auto__345 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return impl$fn__343.invokeStatic();
    }
}
