...
public final class caffeine$fn__585
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.cache.caffeine", (String)"CacheGet");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__587;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__587 = var2;
        v__6457__auto__587 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return caffeine$fn__585.invokeStatic();
    }
}
