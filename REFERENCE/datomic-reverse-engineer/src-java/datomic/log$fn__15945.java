...
public final class log$fn__15945
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.log", (String)"LogSeek");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__15947;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__15947 = var2;
        v__6457__auto__15947 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return log$fn__15945.invokeStatic();
    }
}
