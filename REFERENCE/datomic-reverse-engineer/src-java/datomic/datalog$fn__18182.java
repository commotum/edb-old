...
public final class datalog$fn__18182
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.datalog", (String)"ExtRel");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__18184;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__18184 = var2;
        v__6457__auto__18184 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return datalog$fn__18182.invokeStatic();
    }
}
