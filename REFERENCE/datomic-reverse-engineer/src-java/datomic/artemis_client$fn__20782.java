...
public final class artemis_client$fn__20782
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.artemis-client", (String)"HornetImpl");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__20784;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__20784 = var2;
        v__6457__auto__20784 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return artemis_client$fn__20782.invokeStatic();
    }
}
