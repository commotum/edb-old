...
public final class puts_pool$fn__9832
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.valcache.puts-pool", (String)"PutsPool");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__9834;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__9834 = var2;
        v__6457__auto__9834 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return puts_pool$fn__9832.invokeStatic();
    }
}
