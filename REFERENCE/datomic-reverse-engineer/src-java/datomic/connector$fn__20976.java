...
public final class connector$fn__20976
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.connector", (String)"Startable");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__20978;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__20978 = var2;
        v__6457__auto__20978 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return connector$fn__20976.invokeStatic();
    }
}
