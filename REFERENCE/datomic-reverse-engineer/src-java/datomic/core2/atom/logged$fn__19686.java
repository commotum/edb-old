...
public final class logged$fn__19686
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.core2.atom.logged", (String)"LoggedAtomImpl");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6812__auto__19688;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6812__auto__19688 = var2;
        v__6812__auto__19688 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return logged$fn__19686.invokeStatic();
    }
}
