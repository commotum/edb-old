(do
  ...
  (defn extend-memory-size*
    ([& klass+impls]
      (loop [seq_9675 (seq (partition 2 klass+impls)) chunk_9676 nil count_9677 0 i_9678 0]
        (if (< i_9678 count_9677)
          (let [vec__9679 (.nth ^clojure.lang.Indexed chunk_9676 (int i_9678))
                klass (nth vec__9679 (int 0) nil)
                f (nth vec__9679 (int 1) nil)]
            (extend klass MemorySize* {:memory-size* f})
            (when klass (register-memory-size-handler! klass f))
            (recur seq_9675 chunk_9676 count_9677 (inc i_9678)))
          (let [temp__5825__auto__ (seq seq_9675)]
            (when temp__5825__auto__
              (let [seq_9675 temp__5825__auto__]
                (if (chunked-seq? seq_9675)
                  (let [c__6090__auto__ (chunk-first seq_9675)]
                    (recur
                      (chunk-rest seq_9675)
                      c__6090__auto__
                      (int (count c__6090__auto__))
                      (int 0)))
                  (let [vec__9682 (first seq_9675)
                        klass (nth vec__9682 (int 0) nil)
                        f (nth vec__9682 (int 1) nil)]
                    (extend klass MemorySize* {:memory-size* f})
                    (when klass (register-memory-size-handler! klass f))
                    (recur (next seq_9675) nil 0 0))))))))))
  (reset-meta!
    #'extend-memory-size*
    (assoc
       ...
       (seq
         (concat
           ...
           (mapcat
             (fn fn__9691
               ([p__9690]
                 (let [vec__9692 p__9690
                       atype (nth vec__9692 (int 0) nil)
                       size (nth vec__9692 (int 1) nil)]
                   (apply
                     vector
                     (seq
                       (-> (clojure.core/list 'datomic.memory-size/array-type)
                        ...
                        (concat
                          (clojure.core/list
                            (with-meta
                              (apply vector (seq (concat (clojure.core/list 'x__9689__auto__))))
                              (apply
                                hash-map
                                (seq
                                  (concat
                                      ...
                                      (clojure.core/list
                                        (seq
                                          (concat
                                            ...
                                            (clojure.core/list 'x__9689__auto__)))))))))))
                        (seq)
                        (clojure.core/list)
                        (concat)))))))
  ...
  (extend-memory-size*
    ...
    (fn Long_array (^long [x__9689__auto__] (+ 16 (* 8 (count x__9689__auto__)))))
    (array-type java.lang.Integer/TYPE)
    (fn Integer_array (^long [x__9689__auto__] (+ 16 (* 4 (count x__9689__auto__)))))
    (array-type java.lang.Boolean/TYPE)
    (fn Boolean_array (^long [x__9689__auto__] (+ 16 (* 1 (count x__9689__auto__)))))
    (array-type java.lang.Double/TYPE)
    (fn Double_array (^long [x__9689__auto__] (+ 16 (* 8 (count x__9689__auto__)))))
    (array-type java.lang.Float/TYPE)
    (fn Float_array (^long [x__9689__auto__] (+ 16 (* 4 (count x__9689__auto__)))))
    (array-type java.lang.Short/TYPE)
    (fn Short_array (^long [x__9689__auto__] (+ 16 (* 2 (count x__9689__auto__)))))
    (array-type java.lang.Character/TYPE)
    (fn Character_array (^long [x__9689__auto__] (+ 16 (* 2 (count x__9689__auto__)))))
    (array-type java.lang.Byte/TYPE)
    (fn Byte_array (^long [x__9689__auto__] (+ 16 (* 1 (count x__9689__auto__))))))
  (defn hinted-fn
    ([kls fntail]
      (let [vec__9713 fntail
            seq__9714 (seq vec__9713)
            first__9715 (first seq__9714)
            seq__9714 (next seq__9714)
            vec__9716 first__9715
            target (nth vec__9716 (int 0) nil)
            body seq__9714]
        (seq
          (concat
            (clojure.core/list 'clojure.core/fn)
  ...
  (defn fn-ize
    ([type+handlers]
      (mapcat
        (fn fn__9721
          ([p__9720]
            (let [vec__9722 p__9720
                  klass (nth vec__9722 (int 0) nil)
                  fntail (nth vec__9722 (int 1) nil)]
        ...
        (.longValue
          (let [cls (.getClass o)]
            (if (.isArray ^java.lang.Class cls)
              (let [a o
                    a__6580__auto__ a
                    l__6581__auto__ (alength ^"[Ljava.lang.Object;" a__6580__auto__)]
                (loop [idx 0 ret 16]
                  (if (< idx l__6581__auto__)
                    (recur
                      (inc (int idx))
