  ...
  (defn card-problems
    ([db es]
      (mapv
        (fn fn__32337
          ([p__32336]
            (let [vec__32338 p__32336
                  e (nth vec__32338 (int 0) nil)
                  a (nth vec__32338 (int 1) nil)]
        ...
        (sort-by
          ...
          (filter
            (fn fn__32343
              ([p__32342]
                (let [vec__32344 p__32342
                      e (nth vec__32344 (int 0) nil)
                      a (nth vec__32344 (int 1) nil)
                      cv (nth vec__32344 (int 2) nil)]
                  (> cv 1))))
            (d/q
              [:find
               '?e
    ...
    ([uri checkfile]
      (try
        (let [cr (tools/connection-resources uri)
              map__32355 (tools/db-resources cr)
              map__32355 (if (seq? map__32355)
                           (if (next map__32355)
                             (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                               (to-array map__32355))
                             (if (seq map__32355) (first map__32355) {}))
                           map__32355)
              db (get map__32355 :db)
              map__32356 (repair/read-desc-file checkfile)
              map__32356 (if (seq? map__32356)
                           (if (next map__32356)
                             (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                               (to-array map__32356))
                             (if (seq map__32356) (first map__32356) {}))
                           map__32356)
              ts (get map__32356 :ts)
              es (ts->es cr ts)]
          (pp/pprint
