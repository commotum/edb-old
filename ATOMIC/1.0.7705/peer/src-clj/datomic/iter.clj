(do
    ...
    (next
      ...
      (let [temp__5802__auto__ (.next ^datomic.iter.Iter iter)]
        (if temp__5802__auto__
          ...
          (let [vec__10619 iters
                seq__10620 (seq vec__10619)
                first__10621 (first seq__10620)
                seq__10620 (next seq__10620)
                nxt first__10621
                more seq__10620]
  ...
  (defn concat
    ([iters]
      (let [vec__10627 (clojure.core/filter identity iters)
            seq__10628 (seq vec__10627)
            first__10629 (first seq__10628)
            seq__10628 (next seq__10628)
            iter first__10629
            iters seq__10628]
