(do
  ...
  (defn attr-with-opts->valfn
    ([p__15163]
      (let [vec__15164 p__15163
        ...
        (apply
          comp
          (let [G__15168 [identity] G__15168 (if xform (cons (try-xform xform) G__15168) G__15168)]
              ...
              mk_xf (fn mk_xf
                      ([path subspec def_subspec]
                        (let [vec__15224 (cond
                          ...
                          (if _subspec
                            (fn fn__15227 ([e] (pull* db _subspec _recursed prefer-aevt? e)))
                            identity))))
  ...
  (defn index-pull
    ([db arg-map]
      (let [map__15250 (parse-index-pull-arg-map arg-map)
