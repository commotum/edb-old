---
title: "Console | Datomic"
source: "https://docs.datomic.com/resources/console.html"
description: "Discover how to use the Datomic Console for managing databases, running queries, and exploring data easily."
word_count: 1180
---
...
![console-window.png](_images/00_datomic_pro_console/console-window.png)
...
![console-specify-db.png](_images/00_datomic_pro_console/console-specify-db.png)
...
![console-schema.png](_images/00_datomic_pro_console/console-schema.png)
...
![console-query.png](_images/00_datomic_pro_console/console-query.png)
...
![console-dataset.png](_images/00_datomic_pro_console/console-dataset.png)
...
![console-entities.png](_images/00_datomic_pro_console/console-entities.png)
...
![console-transactions.png](_images/00_datomic_pro_console/console-transactions.png)
...
![console-indexes.png](_images/00_datomic_pro_console/console-indexes.png)
...
![console-datasources.png](_images/00_datomic_pro_console/console-datasources.png)
...
![console-query-with-db-input.png](_images/00_datomic_pro_console/console-query-with-db-input.png)

In the first example, the data source *mbrainz* is bound to *$*, which is used by default in the *where* clause.

![console-query-with-db1-input.png](_images/00_datomic_pro_console/console-query-with-db1-input.png)
...
![console-query-with-tuple-input.png](_images/00_datomic_pro_console/console-query-with-tuple-input.png)
