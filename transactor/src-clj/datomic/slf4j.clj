(do
                   ...
                   (concat
                     ...
                     (if log_begin?
                       (apply
                         ...
                         (seq
                           (concat
                             (clojure.core/list '___8583__auto__)
                             (clojure.core/list
                               (seq
                                 (concat
                                   (clojure.core/list level)
                       ...
                       [])
                     (clojure.core/list 'start__8584__auto__)
                     (clojure.core/list
                       (seq (concat (clojure.core/list 'java.lang.System/nanoTime))))
                     (clojure.core/list 'result__8585__auto__)
                     (clojure.core/list
                       (seq
                         (concat
                           ...
                           (clojure.core/list
                             (seq
                               (concat
                                 ...
                                 (clojure.core/list 't__8586__auto__)
                                 (clojure.core/list
                                   (apply
                                     hash-map
                                     (seq
                 ...
                 (concat
                   ...
                   (clojure.core/list
                     (apply
                       ...
                       (seq
                         (concat
                           (clojure.core/list 'endmsg__8587__auto__)
                           (clojure.core/list
                             (seq
                               (concat
    ...
    (when-not (and
      ...
      (.bindRoot
        ...
        (clojure.lang.MultiFn.
          "redact"
          (fn fn__8598 ([data redact?] (class data)))
          :default
  ...
  (defmethod
    ...
    ([data redact?]
      (reduce-kv
        (fn fn__8604 ([m k v] (assoc m k (if (^clojure.lang.IFn redact? k) "<redacted>" v))))
        {}
        data)))
  (defmethod
    redact
    ...
    fn__8608
    ([data redact?] (mapv (fn fn__8609 ([p1__8607#] (redact p1__8607# redact?))) data)))
  (defmethod redact :default fn__8612 ([data redact?] data)))