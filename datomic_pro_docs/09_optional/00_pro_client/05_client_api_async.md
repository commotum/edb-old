---
title: "datomic.client.api.async documentation"
source: "https://docs.datomic.com/client-api/datomic.client.api.async.html"
word_count: 1929
---
...
or before the point where the given components would reside.
...
```
Returns datoms starting at or after the point in the index where
the components would reside, iterating forward to the end of the
index. Callers must supply their own termination logic.
