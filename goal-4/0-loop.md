...
4. Add permanent regressions; exercise public APIs, actual PostgreSQL and evolving
   application/EDN workflows in proportion to the risk.
5. Check immutable bases, exact data/identity, limits, failures and receipt-first
   compatibility. Measure complete paths, not only a favorable helper.
