(do
  ...
  (defn cx
    (^long [a b]
      (let [cmp (reify
            ...
            alist (fn alist
                    ([x]
                      (let [xs (seq x) G__8681 (java.util.ArrayList. ^java.util.Collection xs)]
                        (Collections/sort ^java.util.List G__8681 ^java.util.Comparator cmp)
                        G__8681)))
  ...
  (defn map->env
    ([m]
      (reduce
        (fn fn__8695
          ([m p__8694]
            (let [vec__8696 p__8694
                  k (nth vec__8696 (unchecked-int 0) nil)
                  v (nth vec__8696 (unchecked-int 1) nil)]
    ...
    ([m & predfns]
      (let [predfns (partition 2 predfns)]
        (reduce
          (fn fn__8706
            ([m p__8705]
              (let [vec__8707 p__8705
                    k (nth vec__8707 (unchecked-int 0) nil)
                    v (nth vec__8707 (unchecked-int 1) nil)
                    temp__5802__auto__ (some
                                         (fn fn__8711
                                           ([p__8710]
                                             (let [vec__8712 p__8710
                                                   p (nth vec__8712 (unchecked-int 0) nil)
                                                   f (nth vec__8712 (unchecked-int 1) nil)]
  ...
  (defn await-derefs
    ([msec coll]
      (let [timed_out (java.lang.Object.)
            ...
            G__8748 coll
            vec__8749 G__8748
            seq__8750 (seq vec__8749)
            first__8751 (first seq__8750)
            seq__8750 (next seq__8750)
            item first__8751
            more seq__8750]
        (loop [G__8748 G__8748]
          (let [vec__8752 G__8748
                seq__8753 (seq vec__8752)
                first__8754 (first seq__8753)
                seq__8753 (next seq__8753)
                item first__8754
                more seq__8753]
            (if item
              (if (=
    ...
    ([coll]
      (do
        (loop [seq_8741 (seq coll) chunk_8742 nil count_8743 0 i_8744 0]
          (if (< i_8744 count_8743)
            (let [c (.nth ^clojure.lang.Indexed chunk_8742 (unchecked-int i_8744))]
              (deref c)
              (recur seq_8741 chunk_8742 count_8743 (inc i_8744)))
            (let [temp__5804__auto__ (seq seq_8741)]
              (when temp__5804__auto__
                (let [seq_8741 temp__5804__auto__]
                  (if (chunked-seq? seq_8741)
                    (let [c__6065__auto__ (chunk-first seq_8741)]
                      (recur (chunk-rest seq_8741) c__6065__auto__ (count c__6065__auto__) 0))
                    (let [c (first seq_8741)] (deref c) (recur (next seq_8741) nil 0 0))))))))
        true)))
  (reset-meta!
    #'await-derefs
    (assoc
  ...
  (defn array-cat
    ([& p__8759]
      (let [vec__8760 p__8759 a (nth vec__8760 (unchecked-int 0) nil) as vec__8760]
        (when a
          (let [length (apply + (map count as))
            ...
            (let [i 0
                  G__8766 as
                  vec__8767 G__8766
                  seq__8768 (seq vec__8767)
                  first__8769 (first seq__8768)
                  seq__8768 (next seq__8768)
                  a first__8769
                  more seq__8768]
              (loop [i i G__8766 G__8766]
                (let [i i
                      vec__8770 G__8766
                      seq__8771 (seq vec__8770)
                      first__8772 (first seq__8771)
                      seq__8771 (next seq__8771)
                      a first__8772
                      more seq__8771]
                  (when a
                 ...
                 (clojure.core/list
                   (seq
                     (concat
                       ...
                       (clojure.core/list 't__8798__auto__)
                       (clojure.core/list
                         (seq
                           (concat
  ...
  (.setMacro #'fire)
  (defn schedule
    ([taskname f msec & p__8800]
      (let [map__8801 p__8800
            map__8801 (if (seq? map__8801)
                        (if (next map__8801)
                          (clojure.lang.PersistentArrayMap/createAsIfByAssoc (to-array map__8801))
                          (if (seq map__8801) (first map__8801) {}))
                        map__8801)
            once (get map__8801 :once)
            msec (long msec)
  ...
  (reset-meta!
    ...
    (assoc
      ...
      :ns
      *ns*))
  (defn mapk ([f coll] (reduce (fn fn__8808 ([m k] (assoc m k (^clojure.lang.IFn f k)))) {} coll)))
  (reset-meta!
    #'mapk
         ...
         (concat
           ...
           (clojure.core/list
             (apply
               ...
               (seq
                 (concat
                   (clojure.core/list 'start__8814__auto__)
                   (clojure.core/list
                     (seq (concat (clojure.core/list 'java.lang.System/nanoTime))))
                   (clojure.core/list 'result__8815__auto__)
                   (clojure.core/list
                     (seq
  ...
  (defn retry-fn
    ([f & p__8817]
      (let [map__8818 p__8817
            map__8818 (if (seq? map__8818)
                        (if (next map__8818)
                          (clojure.lang.PersistentArrayMap/createAsIfByAssoc (to-array map__8818))
                          (if (seq map__8818) (first map__8818) {}))
                        map__8818)
            pred (get map__8818 :pred)
            backoff (get map__8818 :backoff)
            max_retries (get map__8818 :max-retries)
            log_retry (get map__8818 :log-retry)
  ...
  (defn delete-file-recursively
    ([f & p__8826]
      (let [vec__8827 p__8826 silently (nth vec__8827 (unchecked-int 0) nil) f (io/file f)]
        (when (.isDirectory ^java.io.File f)
          (loop [seq_8830 (seq (.listFiles ^java.io.File f)) chunk_8831 nil count_8832 0 i_8833 0]
            (if (< i_8833 count_8832)
              (let [child (.nth ^clojure.lang.Indexed chunk_8831 (unchecked-int i_8833))]
                (delete-file-recursively child silently)
                (recur seq_8830 chunk_8831 count_8832 (inc i_8833)))
              (let [temp__5804__auto__ (seq seq_8830)]
                (when temp__5804__auto__
                  (let [seq_8830 temp__5804__auto__]
                    (if (chunked-seq? seq_8830)
                      (let [c__6065__auto__ (chunk-first seq_8830)]
                        (recur (chunk-rest seq_8830) c__6065__auto__ (count c__6065__auto__) 0))
                      (let [child (first seq_8830)]
                        (delete-file-recursively child silently)
                        (recur (next seq_8830) nil 0 0)))))))))
  ...
  (defn into-bean
    ([bean props]
      (let [setters (bean-setters (class bean))]
        (loop [seq_8843 (seq props) chunk_8844 nil count_8845 0 i_8846 0]
          (if (< i_8846 count_8845)
            (let [vec__8847 (.nth ^clojure.lang.Indexed chunk_8844 (unchecked-int i_8846))
                  k (nth vec__8847 (unchecked-int 0) nil)
                  v (nth vec__8847 (unchecked-int 1) nil)]
              ...
              (recur seq_8843 chunk_8844 count_8845 (inc i_8846)))
            (let [temp__5804__auto__ (seq seq_8843)]
              (when temp__5804__auto__
                (let [seq_8843 temp__5804__auto__]
                  (if (chunked-seq? seq_8843)
                    (let [c__6065__auto__ (chunk-first seq_8843)]
                      (recur (chunk-rest seq_8843) c__6065__auto__ (count c__6065__auto__) 0))
                    (let [vec__8850 (first seq_8843)
                          k (nth vec__8850 (unchecked-int 0) nil)
                          v (nth vec__8850 (unchecked-int 1) nil)]
                      (let [temp__5802__auto__ (^clojure.lang.IFn setters k)]
                        (if temp__5802__auto__
                          (let [setter temp__5802__auto__] (^clojure.lang.IFn setter bean v))
                          (throw
                            (java.lang.IllegalArgumentException. (str "No property named " k)))))
                      (recur (next seq_8843) nil 0 0))))))))
        bean)))
  (reset-meta!
    #'into-bean
    (assoc
    ...
    ([m]
      (if (every? keyword? (keys m))
        ...
        (reduce
          (fn fn__8863
            ([m p__8862]
              (let [vec__8864 p__8862
                    k (nth vec__8864 (unchecked-int 0) nil)
                    v (nth vec__8864 (unchecked-int 1) nil)]
  ...
  (defn load-properties
    ([filename]
      (let [G__8869 (java.util.Properties.)]
        (.load ^java.util.Properties G__8869 (io/input-stream (io/file filename)))
        G__8869)))
  (reset-meta!
    #'load-properties
    (assoc
  ...
  (defn map->props
    ([m]
      (let [props (java.util.Properties.)]
        (loop [seq_8872 (seq (keys m)) chunk_8873 nil count_8874 0 i_8875 0]
          (if (< i_8875 count_8874)
            (let [k (.nth ^clojure.lang.Indexed chunk_8873 (unchecked-int i_8875))]
              (.setProperty ^java.util.Properties props (str k) (str (get m k)))
              (recur seq_8872 chunk_8873 count_8874 (inc i_8875)))
            (let [temp__5804__auto__ (seq seq_8872)]
              (when temp__5804__auto__
                (let [seq_8872 temp__5804__auto__]
                  (if (chunked-seq? seq_8872)
                    (let [c__6065__auto__ (chunk-first seq_8872)]
                      (recur (chunk-rest seq_8872) c__6065__auto__ (count c__6065__auto__) 0))
                    (let [k (first seq_8872)]
                      (.setProperty ^java.util.Properties props (str k) (str (get m k)))
                      (recur (next seq_8872) nil 0 0))))))))
        props)))
  (reset-meta!
    #'map->props
        ...
        (mapv
          (fn fn__8889
            ([p1__8888#]
              (.submit
                ^java.util.concurrent.ExecutorService exec
                (bound-fn [] (^clojure.lang.IFn f p1__8888#)))))
          coll))))
  (reset-meta!
    #'pooled-mapv
    (assoc
      ...
      (let [step (fn step
                   ([xs seen]
                     (lazy-seq
                       ((fn fn__8901
                          ([p__8900 seen]
                            (let [vec__8902 p__8900
                                  fst (nth vec__8902 (unchecked-int 0) nil)
                                  xs vec__8902
  ...
  (defn result-count
    ([offset limit coll]
      (let [G__8915 (count coll)]
        (cond->
          (if offset (- G__8915 offset) (java.lang.Integer/valueOf (int G__8915)))
