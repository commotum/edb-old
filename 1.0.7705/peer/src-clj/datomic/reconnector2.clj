(do
  ...
  (defn reconnector-ref
    ([& p__19820]
      (let [map__19821 p__19820
            map__19821 (if (seq? map__19821)
                         (if (next map__19821)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__19821))
                           (if (seq map__19821) (first map__19821) {}))
                         map__19821)
            state (get map__19821 :state)
            reconnect (get map__19821 :reconnect)
            cleanup (get map__19821 :cleanup)
            shutdown_state (get map__19821 :shutdown-state)]
