(do
  ...
  (reset-meta!
    ...
    (assoc
      ...
      :ns
      *ns*))
  (let [protocol_metadata__7422 {:column (int 1)}]
    (defprotocol
      ITreeIter
      (seg+item-seq
        [iter]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7422 :doc nil) :name 'ITreeIter :ns *ns*))
  ...
  (let [protocol_metadata__7429 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7429 :doc nil) :name 'IIndex :ns *ns*))
  ...
  (def conjable-on-channel
   (fn conjable_on_channel
     ([ch error_ch]
       (reify
  ...
  (reset-meta!
    ...
    (assoc
      ...
      :ns
      *ns*))
  (def partition-at-existing-keydata
   (fn partition_at_existing_keydata
       ...
       (try
         (let [pario (config/property "datomic.indexIOParallelism")
               ...
               excise? (fn excise_QMARK_
                         ([d]
                           (some (fn fn__14316 ([p1__14299#] (x/remove? p1__14299# d))) xpreds)))
