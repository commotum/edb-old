(do
  ...
  (defn update-stmt*
    ([session table id_key col_names]
      (let [update_cql (str
                         ...
                         (str/join
                           ", "
                           (map (fn fn__22603 ([p1__22602#] (str p1__22602# " = ?"))) col_names))
                         " where "
                         (name id_key)
                         " = ? if rev = ?")
  ...
  (reset-meta!
    ...
    (assoc
      ...
      *ns*))
  (defn cql-update
    ([session table ensure_rev p__22608 v_map]
      (let [vec__22609 p__22608
            seq__22610 (seq vec__22609)
            first__22611 (first seq__22610)
            seq__22610 (next seq__22610)
            id_key first__22611
            ks seq__22610
            id (get v_map id_key)
  ...
  (defn select-string
    ([table p__22616]
      (let [vec__22617 p__22616 id_key (nth vec__22617 (int 0) nil) ks vec__22617]
        (str
          "select "
  ...
  (defn cql-delete
    ([session table id p__22629]
      (let [vec__22630 p__22629
            seq__22631 (seq vec__22630)
            first__22632 (first seq__22631)
            seq__22631 (next seq__22631)
            id_key first__22632
            ks seq__22631
  ...
  (defn cluster-from-callback
    ([p__22634]
      (let [map__22635 p__22634
            map__22635 (if (seq? map__22635)
                         (if (next map__22635)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__22635))
                           (if (seq map__22635) (first map__22635) {}))
                         map__22635)
            endpoint map__22635
            cluster_callback (get map__22635 :cluster-callback)]
