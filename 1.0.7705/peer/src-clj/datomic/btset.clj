  ...
  (defn bench
    ([x]
      (let [_ (println "sorted-set")
            ss (let [start__6203__auto__ (java.lang.System/nanoTime)
                     ret__6204__auto__ (let [r (java.util.Random. 4242)]
            ...
            ts (let [start__6203__auto__ (java.lang.System/nanoTime)
                     ret__6204__auto__ (let [r (java.util.Random. 4242) ts (java.util.TreeSet.)]
                                         (loop [i 0]
                                           (if (< i x)
                                             (let [n (.nextLong ^java.util.Random r)]
                 ...
                 ret__6204__auto__)
            _ (println "bt-set")
            bt (let [start__6203__auto__ (java.lang.System/nanoTime)
                     ret__6204__auto__ (let [r (java.util.Random. 4242)]
                                         (loop [bt (btset) i 0]
                                           (if (< i x)
                                             (let [n (.nextLong ^java.util.Random r)]
        ...
        (when-not (every?
                    (fn fn__10737
                      ([p1__10728#]
                        (let [x (seek bt p1__10728#)]
                          (and x (= (.get ^datomic.iter.Iter x) p1__10728#)))))
                    ss)
          (throw
            (java.lang.AssertionError.
              (str
                ...
                (pr-str
                  (clojure.core/list
                    ...
                    (clojure.core/list
                      ...
                      (clojure.core/list
                        'let
                        ['x (clojure.core/list 'seek 'bt 'p1__10728#)]
                        (clojure.core/list
                          'and
                          'x
                          (clojure.core/list '= (clojure.core/list '.get 'x) 'p1__10728#))))
                    'ss))))))
        (when-not (every?
                    (fn fn__10740
                      ([p1__10729#]
                        (let [x (rseek bt p1__10729#)]
                          (and x (= (.get ^datomic.iter.Iter x) p1__10729#)))))
                    ss)
          (throw
            (java.lang.AssertionError.
              (str
                ...
                (pr-str
                  (clojure.core/list
                    ...
                    (clojure.core/list
                      ...
                      (clojure.core/list
                        'let
                        ['x (clojure.core/list 'rseek 'bt 'p1__10729#)]
                        (clojure.core/list
                          'and
                          'x
                          (clojure.core/list '= (clojure.core/list '.get 'x) 'p1__10729#))))
                    'ss))))))
        (when-not (every? (fn fn__10743 ([p1__10730#] (contains? bt p1__10730#))) ss)
          (throw
            (java.lang.AssertionError.
              (str
                "Assert failed: "
                (pr-str
                  (clojure.core/list
                    ...
                    (clojure.core/list
                      'fn*
                      ['p1__10730#]
                      (clojure.core/list 'contains? 'bt 'p1__10730#))
                    'ss))))))
        ...
        (dotimes [_ 20]
          (let [start__6203__auto__ (java.lang.System/nanoTime)
                ret__6204__auto__ (loop [s (seq ss) ret 0] (if s (recur (next s) (first s)) ret))]
            (prn
              (str
                "Elapsed time: "
                (java.lang.Double/valueOf
        ...
        (dotimes [_ 5]
          (let [start__6203__auto__ (java.lang.System/nanoTime)
                ret__6204__auto__ (loop [s (seq ss) ret 0]
        ...
        (dotimes [_ 20]
          (let [start__6203__auto__ (java.lang.System/nanoTime)
                ret__6204__auto__ (loop [s (seek bt) ret 0]
        ...
        (dotimes [_ 20]
          (let [start__6203__auto__ (java.lang.System/nanoTime)
                ret__6204__auto__ (loop [s (.iterator ^java.util.TreeSet ts) ret 0]
