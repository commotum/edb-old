(do
  ...
  (defmethod print-dup datomic.db.DbId fn__11302 ([o w] (print-method o w)))
  ...
  (reset-meta!
    ...
    (assoc
      ...
      :ns
      *ns*))
  (extend nil datomic.db/Symbolish {:sym-name (fn fn__11365 ([_] nil))})
  (extend java.lang.Object datomic.db/Symbolish {:sym-name (fn fn__11367 ([_] nil))})
  (extend
    clojure.lang.Named
    datomic.db/Symbolish
    {:sym-name (fn fn__11369 ([k] (name k))), :sym-namespace (fn fn__11371 ([k] (namespace k)))})
  ...
  (deftype
    ...
    (next
      [this]
      (let [temp__5804__auto__ (^clojure.lang.IFn skip iter)]
        (when temp__5804__auto__ (let [nn temp__5804__auto__] (set! iter nn) this))))
    ...
    (valAt
      ...
      (let [G__11590 k]
        (case
          G__11590
          :unique
          (let [pred__11591 = expr__11592 (:unique attr)]
            (if (^clojure.lang.IFn pred__11591 38 expr__11592)
              :db.unique/identity
              (if (^clojure.lang.IFn pred__11591 37 expr__11592)
                :db.unique/value
                (when-not (^clojure.lang.IFn pred__11591 nil expr__11592)
                  (throw
                    (java.lang.IllegalArgumentException. (str "No matching clause: " expr__11592)))
                  (bit-and (bit-shift-right (clojure.lang.Util/hash G__11590) 8) 15)))))
          :is-component
          ...
          :cardinality
          (let [pred__11593 = expr__11594 (:cardinality attr)]
            (if (^clojure.lang.IFn pred__11593 35 expr__11594)
              :db.cardinality/one
              (if (^clojure.lang.IFn pred__11593 36 expr__11594)
                :db.cardinality/many
                (do
                  (throw
                    (java.lang.IllegalArgumentException. (str "No matching clause: " expr__11594)))
                  (bit-and (bit-shift-right (clojure.lang.Util/hash G__11590) 8) 15)))))
          :id
          (:id attr)
          :ident
    ...
    (valAt
      ...
      (let [G__11585 k]
        (case
          ...
          (get attr :index false)
          :unique
          (let [pred__11588 = expr__11589 (:unique attr)]
            (if (^clojure.lang.IFn pred__11588 38 expr__11589)
              :db.unique/identity
              (if (^clojure.lang.IFn pred__11588 37 expr__11589)
                :db.unique/value
                (when-not (^clojure.lang.IFn pred__11588 nil expr__11589)
                  (throw
                    (java.lang.IllegalArgumentException. (str "No matching clause: " expr__11589)))
                  (bit-and (bit-shift-right (clojure.lang.Util/hash G__11585) 8) 31)))))
          :has-avet
          (.hasAVET ^datomic.db.Attribute attr)
          :tuple-discontinued
          (get attr :tupleDiscontinued false)
          ...
          (get attr :noHistory false)
          :cardinality
          (let [pred__11586 = expr__11587 (:cardinality attr)]
            (if (^clojure.lang.IFn pred__11586 35 expr__11587)
              :db.cardinality/one
              (if (^clojure.lang.IFn pred__11586 36 expr__11587)
                :db.cardinality/many
                (do
                  (throw
                    (java.lang.IllegalArgumentException. (str "No matching clause: " expr__11587)))
                  (bit-and (bit-shift-right (clojure.lang.Util/hash G__11585) 8) 31)))))
          :id
          (:id attr)
          :ident
  ...
  (defn seek-datoms
    ([db index components]
      (let [vec__11685 (let [G__11688 index]
                         (case
                           G__11688
                           :aevt
                           (let [vec__11689 components
                                 a (nth vec__11689 (unchecked-int 0) nil)
                                 e (nth vec__11689 (unchecked-int 1) nil)
                                 v (nth vec__11689 (unchecked-int 2) nil)
                                 t (nth vec__11689 (unchecked-int 3) nil)]
                             [e a v t])
                           :avet
                           (let [vec__11692 components
                                 a (nth vec__11692 (unchecked-int 0) nil)
                                 v (nth vec__11692 (unchecked-int 1) nil)
                                 e (nth vec__11692 (unchecked-int 2) nil)
                                 t (nth vec__11692 (unchecked-int 3) nil)]
                             [e a v t])
                           :eavt
                           components
                           :vaet
                           (let [vec__11695 components
                                 v (nth vec__11695 (unchecked-int 0) nil)
                                 a (nth vec__11695 (unchecked-int 1) nil)
                                 e (nth vec__11695 (unchecked-int 2) nil)
                                 t (nth vec__11695 (unchecked-int 3) nil)]
                             [e a v t])))
            e (nth vec__11685 (unchecked-int 0) nil)
            a (nth vec__11685 (unchecked-int 1) nil)
            v (nth vec__11685 (unchecked-int 2) nil)
            t (nth vec__11685 (unchecked-int 3) nil)
            v (datomic.db/maybe-require-ids db a v (= index :vaet))
            t (when t (long (datomic.db/eid->eidx (unchecked-long ^java.lang.Number t))))
            op (let [G__11698 index]
                 (case
                   G__11698
                   :aevt
                   (fn fn__11699
                     ([p1__11679# p2__11680#]
                       (.seekAEVT ^datomic.db.IDb p1__11679# ^datomic.impl.db.IDatum p2__11680#)))
                   :avet
                   (fn fn__11701
                     ([p1__11681# p2__11682#]
                       (.seekAVET ^datomic.db.IDb p1__11681# ^datomic.impl.db.IDatum p2__11682#)))
                   :eavt
                   (fn fn__11703
                     ([p1__11677# p2__11678#]
                       (.seekEAVT ^datomic.db.IDb p1__11677# ^datomic.impl.db.IDatum p2__11678#)))
                   :vaet
                   (fn fn__11705
                     ([p1__11683# p2__11684#]
                       (.seekRAET
                         ^datomic.db.IDb p1__11683#
                         ^datomic.impl.db.IDatum p2__11684#)))))
      ...
      (letfn
        [(step
           ...
           (let [temp__5802__auto__ (seq coll)]
             (if temp__5802__auto__
               (let [vec__11734 temp__5802__auto__
                     seq__11735 (seq vec__11734)
                     first__11736 (first seq__11735)
                     seq__11735 (next seq__11735)
                     cur first__11736
                     more seq__11735]
  ...
  (defn datoms
    ([db index components]
      (let [vec__11786 (let [G__11789 index]
                         (case
                           G__11789
                           :aevt
                           (let [vec__11790 components
                                 a (nth vec__11790 (unchecked-int 0) nil)
                                 e (nth vec__11790 (unchecked-int 1) nil)
                                 v (nth vec__11790 (unchecked-int 2) nil)
                                 t (nth vec__11790 (unchecked-int 3) nil)]
                             [e a v t])
                           :avet
                           (let [vec__11793 components
                                 a (nth vec__11793 (unchecked-int 0) nil)
                                 v (nth vec__11793 (unchecked-int 1) nil)
                                 e (nth vec__11793 (unchecked-int 2) nil)
                                 t (nth vec__11793 (unchecked-int 3) nil)]
                             [e a v t])
                           :eavt
                           components
                           :vaet
                           (let [vec__11796 components
                                 v (nth vec__11796 (unchecked-int 0) nil)
                                 a (nth vec__11796 (unchecked-int 1) nil)
                                 e (nth vec__11796 (unchecked-int 2) nil)
                                 t (nth vec__11796 (unchecked-int 3) nil)]
                             [e a v t])))
            e (nth vec__11786 (unchecked-int 0) nil)
            a (nth vec__11786 (unchecked-int 1) nil)
            v (nth vec__11786 (unchecked-int 2) nil)
            t (nth vec__11786 (unchecked-int 3) nil)
            v (datomic.db/maybe-require-ids db a v (= index :vaet))
            t (when t (long (datomic.db/eid->eidx (unchecked-long ^java.lang.Number t))))
            op (let [G__11799 index]
                 (case
                   G__11799
                   :aevt
                   (fn fn__11800
                     ([p1__11779# p2__11780#]
                       (.seekAEVT ^datomic.db.IDb p1__11779# ^datomic.impl.db.IDatum p2__11780#)))
                   :avet
                   (fn fn__11802
                     ([p1__11781# p2__11782#]
                       (.seekAVET ^datomic.db.IDb p1__11781# ^datomic.impl.db.IDatum p2__11782#)))
                   :eavt
                   (fn fn__11804
                     ([p1__11777# p2__11778#]
                       (.seekEAVT ^datomic.db.IDb p1__11777# ^datomic.impl.db.IDatum p2__11778#)))
                   :vaet
                   (fn fn__11806
                     ([p1__11783# p2__11784#]
                       (.seekRAET
                         ^datomic.db.IDb p1__11783#
                         ^datomic.impl.db.IDatum p2__11784#)))))
            eid (if e (datomic.db/resolve-id db e) 0)
            attrid (if a (datomic.db/resolve-id db a) 0)]
        (when (and (= :avet index) a attrid)
          (let [temp__5804__auto__ (datomic.db/attribute db attrid)]
            ...
            ([]
              (datomic.db/windowed
                ...
                (fn fn__11809
                  ([p1__11785#]
                    (and
                      (or (nil? e) (= eid (long (.getE ^datomic.impl.db.IDatum p1__11785#))))
                      (or (nil? a) (= attrid (long (.getA ^datomic.impl.db.IDatum p1__11785#))))
                      (or
                        (nil? v)
                        (zero? (common/compare v (.getV ^datomic.impl.db.IDatum p1__11785#))))
                      (or (nil? t) (= t (long (.getT ^datomic.impl.db.IDatum p1__11785#)))))))
                (^clojure.lang.IFn op db (datomic.db/datum db :e eid :a attrid :v v :t t)))))))))
  (reset-meta!
    #'datoms
    (assoc
  ...
  (defn set-element-fields
    ([db aid & kvs]
      (update-in db [:elements aid] (fn fn__12020 ([p1__12019#] (apply assoc p1__12019# kvs))))))
  (reset-meta!
    #'set-element-fields
    (assoc
        ...
        (let [avet (into
                     ...
                     (iter/iter-seq
                       (iter/take-while
                         (fn fn__12074
                           ([p1__12073#]
                             (= aid (long (.getA ^datomic.impl.db.IDatum p1__12073#)))))
  ...
  (defn find-alter-fn
    ([db eid fid from to]
      (cond
        (= from to) (fn fn__12082 ([db _ _ _] [db nil]))
        (= fid (datomic.db/system-eid db :db.attr/preds)) (fn fn__12084
                                                            ([db aid _ preds]
                                                              (if
                                                                (= :disabled preds)
                                                                [(update-in
    ...
    (fn scan_aevt
      ([aevt attrid]
        (let [d (datomic.db/asserting-datum
          ...
          (iter/take-while
            (fn fn__12135
              ([p1__12134#] (= attrid (long (.getA ^datomic.impl.db.IDatum p1__12134#)))))
  ...
  (reset-meta!
    ...
    (assoc
      ...
      *ns*))
  (defn create-deduper
    ([] (let [dset (java.util.HashSet.)] (fn fn__12147 ([d] (.add ^java.util.HashSet dset d))))))
  (reset-meta!
    #'create-deduper
    (assoc
      {:private true, :arglists (clojure.core/list []), :column (int 1)}
  ...
  (defn attrs-missing-hooks
    ([db datoms]
      (let [attr_hook_attr? (datomic.db/attr-hook-attr-ids db)
            ...
            G__12195 datoms
            vec__12196 G__12195
            seq__12197 (seq vec__12196)
            first__12198 (first seq__12197)
            seq__12197 (next seq__12197)
            map__12199 first__12198
            map__12199 (if (seq? map__12199)
                         (if (next map__12199)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__12199))
                           (if (seq map__12199) (first map__12199) {}))
                         map__12199)
            d map__12199
            a (get map__12199 :a)
            more seq__12197]
        (loop [eids eids G__12195 G__12195]
          (let [eids eids
                vec__12200 G__12195
                seq__12201 (seq vec__12200)
                first__12202 (first seq__12201)
                seq__12201 (next seq__12201)
                map__12203 first__12202
                map__12203 (if (seq? map__12203)
                             (if (next map__12203)
                               (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                                 (to-array map__12203))
                               (if (seq map__12203) (first map__12203) {}))
                             map__12203)
                d map__12203
                a (get map__12203 :a)
                more seq__12201]
  ...
  (defn new-ents-not-installed
    ([db datoms]
      (let [p (count (:elements db))
            ...
            G__12212 datoms
            vec__12213 G__12212
            seq__12214 (seq vec__12213)
            first__12215 (first seq__12214)
            seq__12214 (next seq__12214)
            d first__12215
            more seq__12214]
        (loop [eids eids G__12212 G__12212]
          (let [eids eids
                vec__12216 G__12212
                seq__12217 (seq vec__12216)
                first__12218 (first seq__12217)
                seq__12217 (next seq__12217)
                d first__12218
                more seq__12217]
            (if d
        ...
        (fn fn__12267
          ([p1__12266#]
            (let [idx (java.util.Collections/binarySearch
                        ^java.util.List p1__12266#
                        {:t t}
                        (common/key-comparator :t))]
              (into
                []
                (subvec p1__12266# (if (< idx 0) (long (- (inc idx))) (long (inc idx)))))))))))
  (reset-meta!
    #'trim-log
  ...
  (defn empty-tx-stat-registers
    ([]
      (persistent!
        (reduce
          (fn fn__12283 ([m n] (assoc! m n (java.util.concurrent.atomic.LongAdder.))))
          (transient {})
         ...
         (concat
           ...
           (clojure.core/list
             (apply
               ...
               (seq
                 (concat
                   (clojure.core/list 'start__12291__auto__)
                   (clojure.core/list
                     (seq (concat (clojure.core/list 'java.lang.System/nanoTime))))
                   (clojure.core/list 'ret__12292__auto__)
  ...
  (defrecord
    ...
    (addData
      ...
      (let [basis nextT
            map__12351 tx_stat_registers
            map__12351 (if (seq? map__12351)
                         (if (next map__12351)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__12351))
                           (if (seq map__12351) (first map__12351) {}))
                         map__12351)
            dedup_tx_ms (get map__12351 :dedup-tx-ms)
            dedup_ct (get map__12351 :dedup-ct)
            dup_datoms (get map__12351 :dup-datoms)
            ucheck_ct (get map__12351 :ucheck-ct)
            ucheck_tx_ms (get map__12351 :ucheck-tx-ms)]
        (loop [db this
               next_t (inc basis)
               eavt (.-eavt ^datomic.db.IndexSet memidx)
               avet (.-avet ^datomic.db.IndexSet memidx)
          ...
          (if data
            (let [d (first data)
              ...
              (when (and
                ...
                (let [temp__5804__auto__ (let [start__12291__auto__ (java.lang.System/nanoTime)
                                               ret__12292__auto__ (datomic.db/dget
                    ...
                    (let [it temp__5804__auto__]
                      (when-not (some
                                  (fn fn__12352
                                    ([p1__12296#]
                                      (or
                                        (datomic.db/retracts? p1__12296# it)
                                        (and card_one? (datomic.db/updates-v? p1__12296# it)))))
                                  indata)
                        (error/state
        ...
        (assoc
          ...
          (if filt
            (fn fn__12347
              ([p1__12294# p2__12295#]
                (and
                  (^clojure.lang.IFn filt p1__12294# p2__12295#)
                  (^clojure.lang.IFn pred p1__12294# p2__12295#))))
            pred))))
    (^datomic.Database history [this] (assoc this :raw true))
    (^java.lang.Iterable indexRange
      [this attrid start end]
      (iter/iterable (fn fn__12343 ([] (datomic.db/attr-index-range this attrid start end)))))
  ...
  (reset-meta!
    ...
    (assoc
      ...
      :ns
      *ns*))
  (defmethod print-method datomic.db.Db fn__12483 ([db w] (.write ^java.io.Writer w (str db)) nil))
  (defmethod print-dup datomic.db.Db fn__12485 ([o w] (print-method o w)))
  ...
  (defn force-map-keywords
    ([db m]
      (if (every? (fn fn__12555 ([k] (or (number? k) (keyword? k)))) (keys m))
        m
        (reduce
          (fn fn__12559
            ([m p__12558]
              (let [vec__12560 p__12558
                    k (nth vec__12560 (unchecked-int 0) nil)
                    v (nth vec__12560 (unchecked-int 1) nil)
                    kw (cond
                         (integer? k) k
  ...
  (defn has-unique-id?
    ([db emap]
      (let [unique_id? (fn unique_id_QMARK_
                         ([p1__12570#] (= 38 (.-unique (datomic.db/require-attr db p1__12570#)))))]
        (some
          (fn fn__12574 ([p1__12571#] (^clojure.lang.IFn unique_id? p1__12571#)))
          (keys emap)))))
  (reset-meta!
    #'has-unique-id?
    (assoc
  ...
  (extend
    ...
    {:tuple-elem? (fn fn__12647 ([v] (<= (.bitLength ^java.math.BigInteger v) 256)))})
  (extend java.lang.Double datomic.db/TupleElem {:tuple-elem? (fn fn__12649 ([_] true))})
  (extend java.util.Date datomic.db/TupleElem {:tuple-elem? (fn fn__12651 ([_] true))})
  (extend
    java.lang.String
    datomic.db/TupleElem
    {:tuple-elem? (fn fn__12653 ([s] (<= (.length ^java.lang.String s) 256)))})
  (extend java.util.UUID datomic.db/TupleElem {:tuple-elem? (fn fn__12655 ([_] true))})
  (extend java.lang.Boolean datomic.db/TupleElem {:tuple-elem? (fn fn__12657 ([_] true))})
  (extend java.net.URI datomic.db/TupleElem {:tuple-elem? (fn fn__12659 ([_] true))})
  (extend
    java.math.BigDecimal
    datomic.db/TupleElem
    {:tuple-elem? (fn fn__12661 ([v] (<= (.precision ^java.math.BigDecimal v) 256)))})
  ...
  (extend
    java.lang.Short
    datomic.db/CoerceV
    {:coerce-v (fn fn__12689 ([v] (long (.longValue ^java.lang.Short v))))})
  (extend
    java.lang.Integer
    datomic.db/CoerceV
    {:coerce-v (fn fn__12691 ([v] (long (.longValue ^java.lang.Integer v))))})
  (extend clojure.lang.BigInt datomic.db/CoerceV {:coerce-v (fn fn__12693 ([v] (biginteger v)))})
  (defn coerce-tuple
    ([tuple]
      (cond
        (some datomic.db/coerce-v tuple) (mapv
                                           (fn fn__12696
                                             ([p1__12695#]
                                               (or (datomic.db/coerce-v p1__12695#) p1__12695#)))
                                           tuple)
        (vector? tuple) tuple
  ...
  (deftype
    ...
    (^datomic.db.IProcess inject
      ...
      (do
        (cond
          (instance? java.util.Map procargs) (loop [seq_12732 (seq
                                                    ...
                                                    count_12734 0
                                                    i_12735 0]
                                               (if (< i_12735 count_12734)
                                                 (let [x (.nth
                                                           ^clojure.lang.Indexed chunk_12733
                                                           (unchecked-int i_12735))]
                                                   ...
                                                   (recur
                                                     ...
                                                     count_12734
                                                     (inc i_12735)))
                                                 (let [temp__5804__auto__ (seq seq_12732)]
                                                   (when temp__5804__auto__
                                                     (let [seq_12732 temp__5804__auto__]
                                                       (if (chunked-seq? seq_12732)
                                                         (let [c__6065__auto__
                                                               (chunk-first seq_12732)]
                                                           (recur
                                                             (chunk-rest seq_12732)
                                                             c__6065__auto__
                                                             (count c__6065__auto__)
                                                             0))
                                                         (let [x (first seq_12732)]
                                                           (.inject
                                                             this
                                                             x
                                                             ^java.util.Map local_tempids)
                                                           (recur (next seq_12732) nil 0 0))))))))
          ...
          ([attr]
            (datomic.db/prefetch!
              ...
              (fn fn__12815
                ([]
                  (let [start__12291__auto__ (java.lang.System/nanoTime)
                        ret__12292__auto__ (datomic.db/ea->v db e attr)]
                    (datomic.db/long-add!
                      adder
                      (- (java.lang.System/nanoTime) start__12291__auto__))
                    ret__12292__auto__))))))
  ...
  (reset-meta!
    ...
    (assoc
      ...
      :ns
      *ns*))
  (defn for-side-effects ([proc] (map (fn fn__12821 ([x] (^clojure.lang.IFn proc x) x)))))
  (reset-meta!
    #'for-side-effects
    (assoc
  ...
  (deftype
    ...
    (getData
      [this local_tempids]
      (let [vec__12881 (let [start__12291__auto__ (java.lang.System/nanoTime)
                             ret__12292__auto__ (datomic.db/get-ids db arraylist part_reqs)]
                         (datomic.db/long-add!
                           (:res-tx-ms tx_stat_registers)
                           (- (java.lang.System/nanoTime) start__12291__auto__))
                         ret__12292__auto__)
            ids (nth vec__12881 (unchecked-int 0) nil)
            check_installs? (nth vec__12881 (unchecked-int 1) nil)
            ...
            datoms (into
                     ...
                     (comp
                       ...
                       (remove
                         (fn fn__12903
                           ([p1__12877#] (datomic.db/datom-tuple-attrs db p1__12877#))))
            ...
            datoms (datomic.db/add-tempids-to-errors
                     ...
                     (fn fn__12907 ([] (datomic.db/calc-tempids local_tempids ids))))]
        ...
        (let [procid (datomic.db/resolve-procid db (nth procargs (unchecked-int 0)))]
          (if (or (= 1 procid) (= 2 procid))
            ...
            (let [pfn (.getFn ^datomic.db.Db db procid)
                  ...
                  data (let [start__12291__auto__ (java.lang.System/nanoTime)
                             ret__12292__auto__ (apply pfn db (rest procargs))]
                         (datomic.db/long-add!
        ...
        (delay
          (when (config/property "datomic.prefetchProbes")
            (let [name "probes"
                  ...
                  G__12920 (java.util.concurrent.ThreadPoolExecutor.
              ...
              (.allowCoreThreadTimeOut
                ^java.util.concurrent.ThreadPoolExecutor G__12920
  ...
  (defn add-fulltext
    ([db data]
      (let [m_12934 {:event :db/add-fulltext}
            ___8552__auto__ (let [logger (org.slf4j.LoggerFactory/getLogger "datomic.db")]
                              (when (.isDebugEnabled ^org.slf4j.Logger logger)
                                (.debug
                                  ^org.slf4j.Logger logger
                                  (logger/process (assoc m_12934 :phase :begin))))
                              nil)
            start__8553__auto__ (java.lang.System/nanoTime)
            result__8554__auto__ (try
                                   {:returned
                                                ...
                                                ([p1__12933#]
                                                  (datomic.db/fulltext?
                                                    ...
                                                    (java.lang.Integer/valueOf
                                                      (int
                                                        (.getA
                                                          ^datomic.impl.db.IDatum p1__12933#))))))
                                              data)))))}
                                   (catch
                                     java.lang.Throwable
                                     t__8555__auto__
                                     {:threw t__8555__auto__}))
            elapsed_12935 (- (java.lang.System/nanoTime) start__8553__auto__)
            msec_12936 (logger/format-as-msec (long elapsed_12935))]
        (monitor/add-stat :DbAddFulltextMsec msec_12936)
        (let [endmsg__8556__auto__ (merge
                                     (assoc m_12934 :msec msec_12936 :phase :end)
                                     (when (:threw result__8554__auto__)
                                       {:threw (class (:threw result__8554__auto__))}))
              logger (org.slf4j.LoggerFactory/getLogger "datomic.db")]
          (when (.isDebugEnabled ^org.slf4j.Logger logger)
  ...
  (reset-meta!
    ...
    (assoc
      ...
      *ns*))
  (defn missing-attrs
    ([entity required] (remove (fn fn__12950 ([p1__12949#] (find entity p1__12949#))) required)))
  (reset-meta!
    #'missing-attrs
    (assoc
  ...
  (defn with-tx
    ([db dispatcher txdata]
      (let [added (java.util.ArrayList.)
        ...
        (let [vec__12981 (.getData ^datomic.db.IProcessExpander pe local_tempids)
              data (nth vec__12981 (unchecked-int 0) nil)
              idmap (nth vec__12981 (unchecked-int 1) nil)
      ...
      (concat
        ...
        (clojure.core/list
          (apply
            ...
            (seq
              (concat
                (clojure.core/list 'db__12998__auto__)
                (clojure.core/list 'm__12999__auto__)))))
        (clojure.core/list
          (seq
            (concat
              (clojure.core/list 'clojure.core/let)
                    ...
                    (concat
                      (clojure.core/list
                        (apply
                          ...
                          (seq
                            (concat
                              (clojure.core/list 'key__13000__auto__)
                              (clojure.core/list :db/ident)
                              (clojure.core/list 'lang__13001__auto__)
                              (clojure.core/list :db/lang)
                              (clojure.core/list 'code__13002__auto__)
                              (clojure.core/list :db/code)))))
                      (clojure.core/list 'm__12999__auto__)
                      (clojure.core/list 'id__13003__auto__)
                      (clojure.core/list
                        (seq
                          (concat
  ...
  (.bindRoot
    ...
    [datomic.db/system-data-fns
     ...
     (map
       (fn fn__13005
         ([p__13004]
           (let [vec__13006 p__13004
                 k (nth vec__13006 (unchecked-int 0) nil)
                 v (nth vec__13006 (unchecked-int 1) nil)]
             [:db/add k :db/doc v])))
       datomic.db/db-docs)
  ...
  (defn tx-data-for-latest-schema-level
    ([db]
      (map
        (fn fn__13011 ([p1__13010#] (conj p1__13010# #:db{:id "datomic.tx", :system-tx :schema})))
  ...
  (defn init-db
    ([id]
      ...
      (let [assert_kw (fn assert_kw
                        ([p__13017]
                          (let [vec__13019 p__13017
                                k (nth vec__13019 (unchecked-int 0) nil)
                                id (nth vec__13019 (unchecked-int 1) nil)]
                            (datomic.db/asserting-datum
