(do
  ...
  (defn metric-expr
    ([event msec]
      (let [temp__5804__auto__ (event->timing event)]
        (when temp__5804__auto__
          (let [kw temp__5804__auto__]
            (seq
              (concat
                   ...
                   (concat
                     ...
                     (if log_begin?
                       (apply
                         ...
                         (seq
                           (concat
                             (clojure.core/list '___8552__auto__)
                             (clojure.core/list
                               (seq
                                 (concat
                                   (clojure.core/list level)
                       ...
                       [])
                     (clojure.core/list 'start__8553__auto__)
                     (clojure.core/list
                       (seq (concat (clojure.core/list 'java.lang.System/nanoTime))))
                     (clojure.core/list 'result__8554__auto__)
                     (clojure.core/list
                       (seq
                         (concat
                           ...
                           (clojure.core/list
                             (seq
                               (concat
                                 ...
                                 (clojure.core/list 't__8555__auto__)
                                 (clojure.core/list
                                   (apply
                                     hash-map
                                     (seq
                 ...
                 (concat
                   ...
                   (clojure.core/list
                     (apply
                       ...
                       (seq
                         (concat
                           (clojure.core/list 'endmsg__8556__auto__)
                           (clojure.core/list
                             (seq
                               (concat
    ...
    (when-not (and
      ...
      (.bindRoot
        ...
        (clojure.lang.MultiFn.
          "redact"
          (fn fn__8567 ([data redact?] (class data)))
          :default
  ...
  (defmethod
    ...
    ([data redact?]
      (reduce-kv
        (fn fn__8573 ([m k v] (assoc m k (if (^clojure.lang.IFn redact? k) "<redacted>" v))))
        {}
        data)))
  (defmethod
    redact
    ...
    fn__8577
    ([data redact?] (mapv (fn fn__8578 ([p1__8576#] (redact p1__8576# redact?))) data)))
  (defmethod redact :default fn__8581 ([data redact?] data)))