    ...
    ([sym]
      (let [temp__5802__auto__ (re-matches #"(.*)\.(.*)" (str sym))]
        (if temp__5802__auto__
          (let [vec__14881 temp__5802__auto__
                _ (nth vec__14881 (int 0) nil)
                cname (nth vec__14881 (int 1) nil)
                mname (nth vec__14881 (int 2) nil)
                temp__5802__auto__ (try
                                     (java.lang.Class/forName ^java.lang.String cname)
                                     (catch java.lang.Throwable _ nil))]
            (if temp__5802__auto__
              (let [cls temp__5802__auto__]
                  ...
                  (eval
                    (seq
                      (concat
                        ...
                        (clojure.core/list
                          (apply vector (seq (concat (clojure.core/list 'x__14880__auto__)))))
                        (-> (symbol cname mname)
                         (clojure.core/list)
                         (concat (clojure.core/list 'x__14880__auto__))
                         (seq)
                         (clojure.core/list)))))
    ...
    ([sym]
      (if (namespace sym)
        (do
          ...
          (let [temp__5802__auto__ (resolve sym)]
            (if temp__5802__auto__
              (let [cb temp__5802__auto__] cb)
              (let [logger (org.slf4j.LoggerFactory/getLogger "datomic.callback")]
                (when (.isWarnEnabled ^org.slf4j.Logger logger)
                  (.warn
                    ^org.slf4j.Logger logger
