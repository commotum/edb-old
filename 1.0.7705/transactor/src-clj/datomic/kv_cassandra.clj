(do
  ...
  (deftype
    ...
    (put
      [this p__27903]
      (let [map__27905 p__27903
            map__27905 (if (seq? map__27905)
                         (if (next map__27905)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__27905))
                           (if (seq map__27905) (first map__27905) {}))
                         map__27905)
            v_map map__27905
            id (clojure.core/get map__27905 :id)
            rev (clojure.core/get map__27905 :rev)
            v (clojure.core/get map__27905 :v)
            ensure (clojure.core/get map__27905 :ensure)]
  ...
  (defn kv-cassandra
    ([endpoint]
      (let [map__27913 endpoint
            map__27913 (if (seq? map__27913)
                         (if (next map__27913)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__27913))
                           (if (seq map__27913) (first map__27913) {}))
                         map__27913)
            host (clojure.core/get map__27913 :host)
            provided_cluster (clojure.core/get map__27913 :cluster)
            table (clojure.core/get map__27913 :table)
            cluster_callback (clojure.core/get map__27913 :cluster-callback)
            port (or (:port endpoint) 9042)
            user (or (:user endpoint) "")
            password (or (:password endpoint) "")
            ssl (or (:ssl endpoint) false)
            map__27914 (locking cluster-sessions
                        (or
                          ...
                          (let [c (or
                            ...
                            m)))
            map__27914 (if (seq? map__27914)
                         (if (next map__27914)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__27914))
                           (if (seq map__27914) (first map__27914) {}))
                         map__27914)
            cluster (clojure.core/get map__27914 :cluster)
            session (clojure.core/get map__27914 :session)]
