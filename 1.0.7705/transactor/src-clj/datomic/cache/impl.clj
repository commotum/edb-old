(do
  ...
  (extend
    java.lang.Object
    FastCount
    {:fast-count (fn fn__9644 ([coll] (java.lang.Integer/valueOf (int (count coll)))))})
  (extend
    java.util.concurrent.ConcurrentMap
    CachePut
    {:put (fn fn__9646 ([c k v] (.put ^java.util.Map c k v)))})
  (extend
    java.util.concurrent.ConcurrentMap
    CacheRemove
    {:remove (fn fn__9648 ([c k] (.remove ^java.util.Map c k))),
     :clear (fn fn__9650 ([c] (.clear ^java.util.Map c) nil))}))