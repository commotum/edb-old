                                 ...
                                 (let [oldv (.get ^java.util.Map m k)]
                                   (when (= emap (select-keys oldv (keys emap)))
                                     (or
                                       ...
                                       (recur k val emap))))))
                    map__28260 val_map
                    map__28260 (if (seq? map__28260)
                                 (if (next map__28260)
                                   (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                                     (to-array map__28260))
                                   (if (seq map__28260) (first map__28260) {}))
                                 map__28260)
                    id (clojure.core/get map__28260 :id)
                    ensure (clojure.core/get map__28260 :ensure)
                    v (clojure.core/get map__28260 :v)
