(do
    ...
    (s/nilable-impl
      ...
      (s/map-spec-impl
        {:req-un [:datomic.tools.log-tools/desc :datomic.tools.log-tools/newdesc],
         ...
         :gfn nil,
         :pred-exprs
         [(fn fn__27528 ([G__27527] (map? G__27527)))
          (fn fn__27530 ([G__27527] (contains? G__27527 :desc)))
          (fn fn__27532 ([G__27527] (contains? G__27527 :newdesc)))],
         :keys-pred
         (fn fn__27534
           ([G__27527]
             (and (map? G__27527) (contains? G__27527 :desc) (contains? G__27527 :newdesc)))),
         :opt-keys [],
  ...
  (defn transform-root
    ([cs f]
      (let [vec__27552 (log/read-tail-descriptor cs)
            desc (nth vec__27552 (int 0) nil)
      ...
      (s/spec-impl
        ...
        (s/map-spec-impl
          {:req-un
           ...
           :gfn nil,
           :pred-exprs
           [(fn fn__27557 ([G__27556] (map? G__27556)))
            (fn fn__27559 ([G__27556] (contains? G__27556 :retries)))
            (fn fn__27561 ([G__27556] (contains? G__27556 :transform-root-result)))],
           :keys-pred
           (fn fn__27563
             ([G__27556]
               (and
                 (map? G__27556)
                 (contains? G__27556 :retries)
                 (contains? G__27556 :transform-root-result)))),
           :opt-keys [],
           :req-specs
           [:datomic.tools.log-tools/retries :datomic.tools.log-tools/transform-root-result],
           :req nil,
