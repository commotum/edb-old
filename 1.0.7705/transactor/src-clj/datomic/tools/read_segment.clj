(do
    ...
    ([o w]
      ...
      ((deref #'clojure.core/print-sequential)
        ...
        [(.getTag ^org.fressian.TaggedObject o)
         (map
           (fn fn__28200
             ([p1__28198#] (try (seq p1__28198#) (catch java.lang.Throwable t p1__28198#))))
  ...
  (defn -main
    ([& args]
      (try
        (cond
          (= (count args) 2) (let [vec__28205 args
                                   uri (nth vec__28205 (int 0) nil)
                                   val_key (nth vec__28205 (int 1) nil)]
                               (prn (read-segment uri val_key nil))
                               (java.lang.System/exit (int 0))
                               nil)
          (= (count args) 3) (let [vec__28208 args
                                   uri (nth vec__28208 (int 0) nil)
                                   val_key (nth vec__28208 (int 1) nil)
                                   fname (nth vec__28208 (int 2) nil)]
