(do
  ...
  (let [protocol_metadata__7431 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7431 :doc nil) :name 'DatabaseImpl :ns *ns*))
  ...
  (let [protocol_metadata__7434 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7434 :doc nil) :name 'IMaster :ns *ns*))
  ...
  (let [protocol_metadata__7445 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7445 :doc nil) :name 'CatalogService :ns *ns*))
