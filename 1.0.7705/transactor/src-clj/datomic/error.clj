(do
  ...
  (defmethod anomalize :default fn__8525 ([m _ _] m))
  (def create
   (fn create
       ...
       (seq
         (concat
           ...
           (clojure.core/list
             (apply
               vector
               (seq (concat (clojure.core/list 'msg__8528__auto__) (clojure.core/list msg)))))
           (clojure.core/list
             (seq
               (concat
                 ...
                 (clojure.core/list
                   (seq
                     (concat
                       ...
                       (clojure.core/list " ")
                       (clojure.core/list 'msg__8528__auto__))))
                 (clojure.core/list
                   (seq
                     (concat
       ...
       (seq
         (concat
           ...
           (clojure.core/list
             (apply
               vector
               (seq (concat (clojure.core/list 'msg__8527__auto__) (clojure.core/list msg)))))
           (clojure.core/list
             (seq
               (concat
                 (clojure.core/list 'new)
                 ...
                 (clojure.core/list
                   (seq
                     (concat
                       ...
                       (clojure.core/list code)
                       (clojure.core/list " ")
                       (clojure.core/list 'msg__8527__auto__))))
                 (clojure.core/list
                   (seq
                     (concat
                       (clojure.core/list 'datomic.error/anomalize)
          ...
          (str
            ...
            (try
              (let [s__6444__auto__ (java.io.StringWriter.)]
                (binding [*out* s__6444__auto__] (do (pp/pprint details) (str s__6444__auto__))))
  ...
  (.bindRoot
    ...
    (atom (fn fn__8549 ([t] (.printStackTrace ^java.lang.Throwable t) nil))))
  (defn has-string-constructor?
    ([cls]
      (not
        (empty?
          (filter
            (fn fn__8553 ([p1__8552#] (= ['java.lang.String] (:parameter-types p1__8552#))))
            (filter
              (fn fn__8555 ([p1__8551#] (instance? clojure.reflect.Constructor p1__8551#)))
            ...
            (eval
              (seq
                (concat
                  ...
                  (clojure.core/list
                    (apply vector (seq (concat (clojure.core/list 'msg__8558__auto__)))))
                  (clojure.core/list
                    (seq
                      (concat
                        (clojure.core/list 'new)
                                ...
                                (clojure.core/list
                                  (seq
                                    (concat
                                      ...
                                      (clojure.core/list 't__8574__auto__)
                                      (clojure.core/list
                                        (seq
                                          (concat
                       ...
                       (clojure.core/list
                         (seq
                           (concat
                             (clojure.core/list 'catch)
                             (clojure.core/list 'java.lang.Throwable)
                             (clojure.core/list 't__8575__auto__)
                             (clojure.core/list unwind_one)
                             (clojure.core/list
                               (seq
                                 (concat
