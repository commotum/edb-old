(do
      ...
      ([factory & transport_opts]
        (let [opts_map (into
                         ...
                         (map
                           (fn fn__18625
                             ([p__18624]
                               (let [vec__18626 p__18624
                                     k (nth vec__18626 (int 0) nil)
                                     v (nth vec__18626 (int 1) nil)]
                                 [(name k)
  ...
  (deftype
    ...
    (start-session*
      [this creds p__18656]
      (let [map__18658 p__18656
            map__18658 (if (seq? map__18658)
                         (if (next map__18658)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__18658))
                           (if (seq map__18658) (first map__18658) {}))
                         map__18658)
            xa (get map__18658 :xa false)
            auto_commit_sends (get map__18658 :auto-commit-sends true)
            auto_commit_acks (get map__18658 :auto-commit-acks true)
            pre_acknowledge (get map__18658 :pre-acknowledge false)
            ack_batch_size (get map__18658 :ack-batch-size 1)
            on_failure (get map__18658 :on-failure)
            map__18659 (common/require-keys creds [:username :password])
            map__18659 (if (seq? map__18659)
                         (if (next map__18659)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__18659))
                           (if (seq map__18659) (first map__18659) {}))
                         map__18659)
            username (get map__18659 :username)
            password (get map__18659 :password)
  ...
  (.bindRoot
    ...
    (fn create_server_locator
      ([connector p__18666]
        (let [map__18667 p__18666
              map__18667 (if (seq? map__18667)
                           (if (next map__18667)
                             (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                               (to-array map__18667))
                             (if (seq map__18667) (first map__18667) {}))
                           map__18667)
              ttl (get map__18667 :ttl)]
  ...
  (extend
    ...
    {:async-shutdown (fn fn__18683 ([this] (.close this) (promise/delivered true)))})
  (extend
    org.apache.activemq.artemis.api.core.client.ClientSessionFactory
    common/AsyncShutdown
    {:async-shutdown (fn fn__18685 ([this] (.close this) (promise/delivered true)))})
  (extend
    org.apache.activemq.artemis.api.core.client.ClientConsumer
    common/AsyncShutdown
    {:async-shutdown (fn fn__18687 ([this] (.close this) (promise/delivered true)))})
  (extend
    org.apache.activemq.artemis.api.core.client.ClientSession
    common/AsyncShutdown
    {:async-shutdown (fn fn__18689 ([this] (.close this) (promise/delivered true)))})
  (extend
  ...
  (.bindRoot
    (clojure.lang.RT/var "datomic.artemis-client" "create-consumer")
    (fn create_consumer
      ([session queue_name & p__18696]
        (let [map__18697 p__18696
              map__18697 (if (seq? map__18697)
                           (if (next map__18697)
                             (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                               (to-array map__18697))
                             (if (seq map__18697) (first map__18697) {}))
                           map__18697)
              window_size (get map__18697 :window-size (long (* 1024 1024)))
              max_rate (get map__18697 :max-rate -1)
              browse (get map__18697 :browse false)]
          (.createConsumer
            ^org.apache.activemq.artemis.api.core.client.ClientSession session
            ^java.lang.String queue_name
            nil
  ...
  (extend
    ...
    {:take
     (fn fn__18699
       ([this]
         (let [temp__5823__auto__ (.receive this)]
