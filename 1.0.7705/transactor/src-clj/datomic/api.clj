(do
  ...
  (def transact
   (fn transact
     ([connection tx_data & p__16935]
       (let [map__16936 p__16935
             map__16936 (if (seq? map__16936)
                          (if (next map__16936)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__16936))
                            (if (seq map__16936) (first map__16936) {}))
                          map__16936)
             options map__16936]
  ...
  (def transact-async
   (fn transact_async
     ([connection tx_data & p__16938]
       (let [map__16939 p__16938
             map__16939 (if (seq? map__16939)
                          (if (next map__16939)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__16939))
                            (if (seq map__16939) (first map__16939) {}))
                          map__16939)
             options map__16939]
  ...
  (def pull
   (fn pull
     ([db pattern eid & p__16956]
       (let [map__16957 p__16956
             map__16957 (if (seq? map__16957)
                          (if (next map__16957)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__16957))
                            (if (seq map__16957) (first map__16957) {}))
                          map__16957)
             options map__16957]
  ...
  (def pull-many
   (fn pull_many
     ([db pattern eids & p__16960]
       (let [map__16961 p__16960
             map__16961 (if (seq? map__16961)
                          (if (next map__16961)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__16961))
                            (if (seq map__16961) (first map__16961) {}))
                          map__16961)
             options map__16961]
  ...
  (def cancel
   (fn cancel
     ([p__16978]
       (let [map__16979 p__16978
             map__16979 (if (seq? map__16979)
                          (if (next map__16979)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__16979))
                            (if (seq map__16979) (first map__16979) {}))
                          map__16979)
             anomaly_map map__16979
             category (get map__16979 :cognitect.anomalies/category)
  ...
  (loop [seq_16990 (seq
         ...
         count_16992 0
         i_16993 0]
    (if (< i_16993 count_16992)
      (let [vec__16995 (.nth ^clojure.lang.Indexed chunk_16991 (int i_16993))
            v (nth vec__16995 (int 0) nil)
            doc (nth vec__16995 (int 1) nil)]
        (alter-meta! v assoc :doc doc)
        (recur seq_16990 chunk_16991 count_16992 (inc i_16993)))
      (let [temp__5825__auto__ (seq seq_16990)]
        (when temp__5825__auto__
          (let [seq_16990 temp__5825__auto__]
            (if (chunked-seq? seq_16990)
              (let [c__6090__auto__ (chunk-first seq_16990)]
                (recur
                  (chunk-rest seq_16990)
                  c__6090__auto__
                  (int (count c__6090__auto__))
                  (int 0)))
              (let [vec__16998 (first seq_16990)
                    v (nth vec__16998 (int 0) nil)
                    doc (nth vec__16998 (int 1) nil)]
                (alter-meta! v assoc :doc doc)
                (recur (next seq_16990) nil 0 0)))))))))