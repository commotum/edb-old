(do
    ...
    ([cls]
      ...
      (filter
        (fn fn__27306
          ([p1__27305#]
            (and
              (= "set" (subs (.getName ^java.lang.reflect.Method p1__27305#) 0 3))
              (= 1 (long (count (.getParameterTypes ^java.lang.reflect.Method p1__27305#)))))))
  ...
  (defn filter-overlapped-setters
    ([coll]
      (reduce
        (fn fn__27313
          ([result p__27312]
            (let [vec__27314 p__27312
                  k (nth vec__27314 (int 0) nil)
                  setters (nth vec__27314 (int 1) nil)
                  G__27317 (count setters)]
              (case
                G__27317
                1
        ...
        []
        (group-by
          (fn fn__27319 ([p1__27311#] (.getName ^java.lang.reflect.Method p1__27311#)))
          coll))))
  (reset-meta!
  ...
  (let [v__5813__auto__ #'type-descriptor]
    (when-not (and
  ...
  (let [v__5813__auto__ #'property-descriptor]
    (when-not (and
                (.hasRoot ^clojure.lang.Var v__5813__auto__)
                (instance? clojure.lang.MultiFn (deref v__5813__auto__)))
      (.setMeta (clojure.lang.RT/var "datomic.datafy" "property-descriptor") {:column (int 1)})
      (.bindRoot
        ...
        (clojure.lang.MultiFn.
          "property-descriptor"
          (fn fn__27334 ([container prop type] (type-descriptor-category type)))
          :default
          #'clojure.core/global-hierarchy))
      #'property-descriptor))
  ...
  (defmethod
    ...
    fn__27339
    ([container prop type]
      (let [temp__5823__auto__ (map-property-types [container prop])]
        (if temp__5823__auto__
          (let [vec__27340 temp__5823__auto__
                k (nth vec__27340 (int 0) nil)
                v (nth vec__27340 (int 1) nil)]
            {k (type-descriptor v)})
  ...
  (defmethod
    ...
    fn__27345
    ([container prop type]
      (let [temp__5823__auto__ (list-property-types [container prop])]
        (if temp__5823__auto__
          (let [v temp__5823__auto__] [(type-descriptor v)])
          (type-descriptor type)))))
  (defmethod property-descriptor :default fn__27348 ([_ _ type] (type-descriptor type)))
  (defmethod
    type-descriptor
    :enum
    fn__27351
        ...
        (map
          ...
          (filter
            (fn fn__27352
              ([p1__27350#]
                (and
                  (contains? (:flags p1__27350#) :static)
                  (contains? (:flags p1__27350#) :public)
                  (:type p1__27350#)
                  (= (resolve (:type p1__27350#)) c))))
  ...
  (defmethod
    ...
    fn__27358
    ([c]
      (let [temp__5823__auto__ (seq (filter-overlapped-setters (setters c)))]
        (if temp__5823__auto__
  ...
  (defmethod type-descriptor :default fn__27363 ([c] (symbol (.getName ^java.lang.Class c))))
  (let [protocol_metadata__7463 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7463 :doc nil) :name 'ObjectToData :ns *ns*))
  ...
  (reset-meta!
    ...
    (assoc
      ...
      :ns
      *ns*))
  (extend java.lang.Object ObjectToData {:object-to-data (fn fn__27382 ([o] o))})
  (extend
    java.util.ArrayList
    ObjectToData
    {:object-to-data (fn fn__27384 ([o] (mapv object-to-data o)))})
  (extend
    java.util.Map
    ObjectToData
    {:object-to-data
     (fn fn__27386
       ([m]
         (reduce
           (fn fn__27388
             ([m p__27387]
               (let [vec__27389 p__27387
                     k (nth vec__27389 (int 0) nil)
                     v (nth vec__27389 (int 1) nil)]
    ...
    ([m]
      (persistent!
        (reduce
          (fn fn__27395
            ([m p__27394]
              (let [vec__27396 p__27394
                    k (nth vec__27396 (int 0) nil)
                    v (nth vec__27396 (int 1) nil)]
  ...
  (let [v__5813__auto__ #'data-to-object]
    (when-not (and
                (.hasRoot ^clojure.lang.Var v__5813__auto__)
                (instance? clojure.lang.MultiFn (deref v__5813__auto__)))
      (.setMeta (clojure.lang.RT/var "datomic.datafy" "data-to-object") {:column (int 1)})
      (.bindRoot
        ...
        (clojure.lang.MultiFn.
          "data-to-object"
          (fn fn__27402 ([obj type] [(data/equality-partition obj) type]))
          :default
          #'clojure.core/global-hierarchy))
      #'data-to-object))
  (defmethod
  ...
  (let [v__5813__auto__ #'property-to-object]
    (when-not (and
                (.hasRoot ^clojure.lang.Var v__5813__auto__)
                (instance? clojure.lang.MultiFn (deref v__5813__auto__)))
      (.setMeta (clojure.lang.RT/var "datomic.datafy" "property-to-object") {:column (int 1)})
      (.bindRoot
        ...
        (clojure.lang.MultiFn.
          "property-to-object"
          (fn fn__27424 ([container prop obj type] [container prop]))
          :default
          #'clojure.core/global-hierarchy))
      #'property-to-object))
  (defmethod
          ...
          (concat
            ...
            (clojure.core/list
              (apply
                ...
                (seq
                  (concat
                    (clojure.core/list 'v__27432__auto__)
                    (clojure.core/list
                      (-> (str "." rm)
                       (symbol)
                       (clojure.core/list)
                ...
                legal_keys (into
                             ...
                             (map
                               (fn fn__27439
                                 ([p1__27438#]
                                   (setter-name->keyword
                                     (.getName ^java.lang.reflect.Method p1__27438#))))
                               s))]
            (seq
              (concat
                (clojure.core/list 'clojure.core/defmethod)
  ...
  (defn type-docstring
    ([p__27445]
      (let [vec__27446 p__27445
            argname (nth vec__27446 (int 0) nil)
            _ (nth vec__27446 (int 1) nil)
            argclass (nth vec__27446 (int 2) nil)
    ...
    ([m fname docstring]
      (let [argspecs (map-indexed
            ...
            args (mapv
                   (fn fn__27454
                     ([p__27453]
                       (let [vec__27455 p__27453
                             aname (nth vec__27455 (int 0) nil)
                             atype (nth vec__27455 (int 1) nil)]
                         (with-meta
    ...
    ([cls mname arity types]
      (let [ms (filter
                 (fn fn__27461
                   ([p1__27460#]
                     (and
                       (= (name mname) (.getName ^java.lang.reflect.Method p1__27460#))
                       (=
                         arity
                         (long (count (.getParameterTypes ^java.lang.reflect.Method p1__27460#))))
                       (if (empty? types)
                         true
                         (=
                           (seq (.getParameterTypes ^java.lang.reflect.Method p1__27460#))
                           types)))))
                 (.getMethods ^java.lang.Class cls))]
     ...
     ([&form &env clsname & specs]
       (let [cls (resolve clsname)
             arglist (mapv
                       (fn fn__27467
                         ([p__27466]
                           (let [vec__27468 p__27466
                                 mname (nth vec__27468 (int 0) nil)
                                 arity (nth vec__27468 (int 1) nil)
                                 fname (nth vec__27468 (int 2) nil)
                                 docstring? (nth vec__27468 (int 3) nil)
                                 types? (nth vec__27468 (int 4) nil)
                                 vec__27471 (cond
                                              (string? docstring?) [docstring? types?]
                                              (vector? docstring?) [[] docstring?]
                                              :else (do nil))
                                 docstring (nth vec__27471 (int 0) nil)
                                 types (nth vec__27471 (int 1) nil)
         ...
         (seq
           (concat
             ...
             (mapv
               (fn fn__27476
                 ([p__27475]
                   (let [vec__27477 p__27475
                         meth (nth vec__27477 (int 0) nil)
                         fname (nth vec__27477 (int 1) nil)
                         docstring (nth vec__27477 (int 2) nil)]
   ...
   (fn define_data_to_object_for
     ([&form &env & classes]
       (seq
         (concat
           (clojure.core/list 'do)
           (mapv (fn fn__27483 ([p1__27482#] (define-data-to-object p1__27482#))) classes))))))
  (reset-meta!
   ...
   (fn define_object_to_data_for
     ([&form &env & classes]
       (seq
         (concat
           (clojure.core/list 'do)
           (mapv (fn fn__27487 ([p1__27486#] (define-object-to-data p1__27486#))) classes))))))
  (reset-meta!
     ...
     ([&form &env & descs]
       (seq
         (concat
           (clojure.core/list 'do)
           (mapv
             (fn fn__27492 ([p1__27491#] (apply define-map-valued-property-to-object p1__27491#)))
             descs))))))
  (reset-meta!
     ...
     ([&form &env & descs]
       (seq
         (concat
           (clojure.core/list 'do)
           (mapv
             (fn fn__27497 ([p1__27496#] (apply define-list-valued-property-to-object p1__27496#)))
             descs))))))
  (reset-meta!
  ...
  (defn vals-to-bean
    ([bean props]
      (let [setters (val-setters (class bean))]
        (loop [seq_27506 (seq props) chunk_27507 nil count_27508 0 i_27509 0]
          (if (< i_27509 count_27508)
            (let [vec__27510 (.nth ^clojure.lang.Indexed chunk_27507 (int i_27509))
                  k (nth vec__27510 (int 0) nil)
                  v (nth vec__27510 (int 1) nil)]
              ...
              (recur seq_27506 chunk_27507 count_27508 (inc i_27509)))
            (let [temp__5825__auto__ (seq seq_27506)]
              (when temp__5825__auto__
                (let [seq_27506 temp__5825__auto__]
                  (if (chunked-seq? seq_27506)
                    (let [c__6090__auto__ (chunk-first seq_27506)]
                      (recur
                        (chunk-rest seq_27506)
                        c__6090__auto__
                        (int (count c__6090__auto__))
                        (int 0)))
                    (let [vec__27513 (first seq_27506)
                          k (nth vec__27513 (int 0) nil)
                          v (nth vec__27513 (int 1) nil)]
                      (let [temp__5823__auto__ (^clojure.lang.IFn setters k)]
                        (if temp__5823__auto__
                          (let [setter temp__5823__auto__] (^clojure.lang.IFn setter bean v))
                          (throw
                            (java.lang.IllegalArgumentException. (str "No property named " k)))))
                      (recur (next seq_27506) nil 0 0))))))))
        bean)))
  (reset-meta!
    #'vals-to-bean
    (assoc
