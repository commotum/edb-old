...
public final class valcache$fn__9711
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.valcache", (String)"IServer");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__9713;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__9713 = var2;
        v__6457__auto__9713 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return valcache$fn__9711.invokeStatic();
    }
}
