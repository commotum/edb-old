...
public final class spi$fn__20950
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.core2.log.spi", (String)"Item");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6812__auto__20952;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6812__auto__20952 = var2;
        v__6812__auto__20952 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return spi$fn__20950.invokeStatic();
    }
}
