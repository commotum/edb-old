...
public final class log$fn__16073
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.log", (String)"TailTxes");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__16075;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__16075 = var2;
        v__6457__auto__16075 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return log$fn__16073.invokeStatic();
    }
}
