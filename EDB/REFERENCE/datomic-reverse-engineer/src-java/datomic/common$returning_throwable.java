...
public final class common$returning_throwable
extends RestFn {
    ...
    public static final AFn const__6 = (AFn)Symbol.intern(null, (String)"e");
    public static final AFn const__7 = (AFn)Symbol.intern(null, (String)"e");

    public static Object invokeStatic(Object _AMPERSAND_form, Object _AMPERSAND_env, ISeq forms) {
        ISeq iSeq = forms;
        forms = null;
        return ((IFn)const__0.getRawRoot()).invoke(((IFn)const__1.getRawRoot()).invoke(((IFn)const__2.getRawRoot()).invoke((Object)const__3), (Object)iSeq, ((IFn)const__2.getRawRoot()).invoke(((IFn)const__0.getRawRoot()).invoke(((IFn)const__1.getRawRoot()).invoke(((IFn)const__2.getRawRoot()).invoke((Object)const__4), ((IFn)const__2.getRawRoot()).invoke((Object)const__5), ((IFn)const__2.getRawRoot()).invoke((Object)const__6), ((IFn)const__2.getRawRoot()).invoke((Object)const__7))))));
    }
    ...
    public Object doInvoke(Object object, Object object2, Object object3) {
        ...
        object3 = null;
        return common$returning_throwable.invokeStatic(object4, object5, iSeq);
    }
