...
public final class ValueBackup$fn__20097
extends AFunction {
    ...
    public ValueBackup$fn__20097(Object object, Object object2) {
    ...
    public Object invoke() {
        ...
        if (Util.classOf((Object)object2) != __cached_class__0) {
            if (object2 instanceof Storage) {
                object = ((Storage)object2).exists_QMARK_(this_.backup_k);
                return object;
            }
            object2 = object2;
            __cached_class__0 = Util.classOf((Object)object2);
        }
        ValueBackup$fn__20097 this_ = null;
        object = const__0.getRawRoot().invoke(object2, this_.backup_k);
        return object;
    }
