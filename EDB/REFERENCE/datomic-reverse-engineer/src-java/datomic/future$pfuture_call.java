...
public final class future$pfuture_call
extends AFunction {
    ...
    public static final AFn const__10 = (AFn)Symbol.intern(null, (String)"f__10270__auto__");
    public static final AFn const__11 = (AFn)Symbol.intern((String)"datomic.future", (String)"-future-with-channel-impl");
    public static final AFn const__12 = (AFn)Symbol.intern(null, (String)"ch__10271__auto__");
    ...
    public static Object invokeStatic(Object _AMPERSAND_form, Object _AMPERSAND_env, Object exec, Object f) {
        ...
        context = null;
        return ((IFn)const__4.getRawRoot()).invoke(((IFn)const__5.getRawRoot()).invoke(((IFn)const__6.getRawRoot()).invoke((Object)const__7), ((IFn)const__6.getRawRoot()).invoke(((IFn)const__8.getRawRoot()).invoke(const__9.getRawRoot(), ((IFn)const__4.getRawRoot()).invoke(((IFn)const__5.getRawRoot()).invoke(((IFn)const__6.getRawRoot()).invoke((Object)const__10), ((IFn)const__6.getRawRoot()).invoke(((IFn)const__4.getRawRoot()).invoke(((IFn)const__5.getRawRoot()).invoke(((IFn)const__6.getRawRoot()).invoke((Object)const__11), ((IFn)const__6.getRawRoot()).invoke(object2), ((IFn)const__6.getRawRoot()).invoke(object3)))), ((IFn)const__6.getRawRoot()).invoke((Object)const__12), ((IFn)const__6.getRawRoot()).invoke(((IFn)const__4.getRawRoot()).invoke(((IFn)const__5.getRawRoot()).invoke(((IFn)const__6.getRawRoot()).invoke((Object)const__13), ((IFn)const__6.getRawRoot()).invoke((Object)const__10)))))))), ((IFn)const__6.getRawRoot()).invoke(((IFn)const__4.getRawRoot()).invoke(((IFn)const__5.getRawRoot()).invoke(((IFn)const__6.getRawRoot()).invoke((Object)const__14), ((IFn)const__6.getRawRoot()).invoke((Object)const__12), ((IFn)const__6.getRawRoot()).invoke(object4), ((IFn)const__6.getRawRoot()).invoke(((IFn)const__4.getRawRoot()).invoke(((IFn)const__5.getRawRoot()).invoke(((IFn)const__6.getRawRoot()).invoke((Object)const__15), ((IFn)const__6.getRawRoot()).invoke((Object)const__16))))))), ((IFn)const__6.getRawRoot()).invoke((Object)const__10)));
    }
    ...
    public Object invoke(Object object, Object object2, Object object3, Object object4) {
        ...
        object4 = null;
        return future$pfuture_call.invokeStatic(object5, object6, object7, object8);
    }
}
