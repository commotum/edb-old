...
public final class memcached$fn__9968
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.memcached", (String)"RecoveringClientImpl");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__9970;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__9970 = var2;
        v__6457__auto__9970 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return memcached$fn__9968.invokeStatic();
    }
}
