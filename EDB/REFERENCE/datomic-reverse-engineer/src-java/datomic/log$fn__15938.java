...
public final class log$fn__15938
extends AFunction {
    ...
    public static final AFn const__4 = (AFn)((IObj)Symbol.intern(null, (String)"datomic.log")).withMeta(RT.map((Object[])new Object[0]));
    ...
    public Object invoke() {
        return log$fn__15938.invokeStatic();
    }
}
