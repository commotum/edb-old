...
public final class treewalk$fn__19681
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.treewalk", (String)"TreeWalker");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__19683;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__19683 = var2;
        v__6457__auto__19683 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return treewalk$fn__19681.invokeStatic();
    }
}
