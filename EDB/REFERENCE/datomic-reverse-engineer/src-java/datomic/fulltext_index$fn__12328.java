...
public final class fulltext_index$fn__12328
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.fulltext-index", (String)"LuceneProvider");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__12330;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__12330 = var2;
        v__6457__auto__12330 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return fulltext_index$fn__12328.invokeStatic();
    }
}
