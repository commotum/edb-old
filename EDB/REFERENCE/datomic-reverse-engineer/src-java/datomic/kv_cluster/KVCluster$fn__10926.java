...
import datomic.kv_cluster.KVCluster$fn__10926$fn__10930;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public final class KVCluster$fn__10926
extends AFunction {
    Object kvs;
    Object key;
    Object retrying_delete;
    public static final Keyword const__0 = RT.keyword(null, (String)"event");
    public static final Keyword const__1 = RT.keyword((String)"kv-cluster", (String)"delete-reference");
    ...
    public KVCluster$fn__10926(Object object, Object object2, Object object3) {
        this.kvs = object;
        this.key = object2;
    ...
    public Object invoke() {
        ...
        IPersistentMap m_10927 = RT.mapUniqueKeys((Object[])new Object[]{const__0, const__1, const__2, this.key});
        Logger logger = LoggerFactory.getLogger((String)"datomic.kv-cluster");
        if (logger.isInfoEnabled()) {
            Logger logger2 = logger;
            logger = null;
            logger2.info((String)((IFn)const__3.getRawRoot()).invoke(((IFn)const__4.getRawRoot()).invoke((Object)m_10927, (Object)const__5, (Object)const__6)));
        }
        long start__8981__auto__10937 = System.nanoTime();
        this.key = null;
        Object result__8982__auto__10938 = ((IFn)new KVCluster$fn__10926$fn__10930(this.kvs, this.key, this.retrying_delete)).invoke();
        long elapsed_10928 = Numbers.minus((long)System.nanoTime(), (long)start__8981__auto__10937);
        Object msec_10929 = ((IFn)const__8.getRawRoot()).invoke((Object)Numbers.num((long)elapsed_10928));
        IFn iFn = (IFn)const__9.getRawRoot();
        IPersistentMap iPersistentMap2 = m_10927;
        m_10927 = null;
        Object object2 = msec_10929;
        msec_10929 = null;
        ...
        Object object4 = result__8982__auto__10938;
        ...
        if (object5 != null && object5 != Boolean.FALSE) {
            ...
            Object object6 = result__8982__auto__10938;
        ...
        Object endmsg__8984__auto__10935 = iFn.invoke(object3, iPersistentMap);
        Logger logger3 = LoggerFactory.getLogger((String)"datomic.kv-cluster");
        if (logger3.isInfoEnabled()) {
            Logger logger4 = logger3;
            logger3 = null;
            Object object8 = endmsg__8984__auto__10935;
            endmsg__8984__auto__10935 = null;
            logger4.info((String)((IFn)const__3.getRawRoot()).invoke(object8));
        }
        Object object9 = ((IFn)const__14.getRawRoot()).invoke(result__8982__auto__10938, (Object)const__15);
        if (object9 != null && object9 != Boolean.FALSE) {
            ILookupThunk iLookupThunk3 = __thunk__2__;
            Object object10 = result__8982__auto__10938;
            result__8982__auto__10938 = null;
            ...
            Object object11 = result__8982__auto__10938;
            result__8982__auto__10938 = null;
