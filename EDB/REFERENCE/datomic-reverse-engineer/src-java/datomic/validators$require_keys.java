...
public final class validators$require_keys
extends RestFn {
    ...
    public static Object invokeStatic(Object m, ISeq ks) {
        ISeq iSeq = ks;
        ks = null;
        Object missing = ((IFn)const__0.getRawRoot()).invoke(((IFn)const__1.getRawRoot()).invoke(const__2.getRawRoot(), (Object)iSeq), ((IFn)const__1.getRawRoot()).invoke(const__2.getRawRoot(), ((IFn)const__3.getRawRoot()).invoke(m)));
        Object object = ((IFn)const__4.getRawRoot()).invoke(missing);
        if (object != null && object != Boolean.FALSE) {
            ((IFn)const__5.getRawRoot()).invoke(((IFn)const__6.getRawRoot()).invoke((Object)const__7, const__8, (Object)const__9, const__10));
            try {
                Object object2 = missing;
                missing = null;
                Object object3 = m;
                m = null;
                throw (Throwable)new IllegalArgumentException((String)((IFn)const__11.getRawRoot()).invoke((Object)"Missing keys ", object2, (Object)" in ", object3));
            }
    ...
    public Object doInvoke(Object object, Object object2) {
        ...
        object2 = null;
        return validators$require_keys.invokeStatic(object3, iSeq);
    }
