...
public final class ConnectionState$reify__21318
...
IObj {
    ...
    public ConnectionState$reify__21318(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public ConnectionState$reify__21318(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new ConnectionState$reify__21318(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical((Object)((IFn)const__1.getRawRoot()).invoke(gtarget), (Object)this.gclass)) {
            ...
            gtarget = null;
            object = ((ConnectionState)object2).updater;
        } else {
            object = this;
        }
        return object;
