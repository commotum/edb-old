...
import datomic.connector$create_hornet_notifier$fn__21191$fn__21192$fn__21196;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public final class connector$create_hornet_notifier$fn__21191$fn__21192
extends AFunction {
    Object cleanup_ref;
    Object done_ref;
    ...
    public static final AFn const__2 = (AFn)RT.map((Object[])new Object[]{RT.keyword(null, (String)"event"), RT.keyword((String)"connector", (String)"notify-loop")});
    ...
    public connector$create_hornet_notifier$fn__21191$fn__21192(Object object, Object object2, Object object3, Object object4, Object object5) {
    ...
    public Object invoke() {
        ...
        try {
            ...
            AFn m_21193 = const__2;
            Logger logger = LoggerFactory.getLogger((String)"datomic.connector");
            if (logger.isDebugEnabled()) {
                Logger logger2 = logger;
                logger = null;
                logger2.debug((String)((IFn)const__3.getRawRoot()).invoke(((IFn)const__4.getRawRoot()).invoke((Object)m_21193, (Object)const__5, (Object)const__6)));
            }
            long start__8981__auto__21211 = System.nanoTime();
            this.cleanup_ref = null;
            this.done_ref = null;
            this.push_handler_ref = null;
            this.hornet_consumer = null;
            this.failure_handler = null;
            Object result__8982__auto__21212 = ((IFn)new connector$create_hornet_notifier$fn__21191$fn__21192$fn__21196(this.cleanup_ref, this.done_ref, this.push_handler_ref, this.hornet_consumer, this.failure_handler)).invoke();
            long elapsed_21194 = Numbers.minus((long)System.nanoTime(), (long)start__8981__auto__21211);
            Object msec_21195 = ((IFn)const__8.getRawRoot()).invoke((Object)Numbers.num((long)elapsed_21194));
            IFn iFn = (IFn)const__9.getRawRoot();
            AFn aFn = m_21193;
            m_21193 = null;
            Object object3 = msec_21195;
            msec_21195 = null;
            ...
            Object object5 = result__8982__auto__21212;
            ...
            if (object6 != null && object6 != Boolean.FALSE) {
                ...
                Object object7 = result__8982__auto__21212;
            ...
            Object endmsg__8984__auto__21209 = iFn.invoke(object4, iPersistentMap);
            Logger logger3 = LoggerFactory.getLogger((String)"datomic.connector");
            if (logger3.isDebugEnabled()) {
                Logger logger4 = logger3;
                logger3 = null;
                Object object9 = endmsg__8984__auto__21209;
                endmsg__8984__auto__21209 = null;
                logger4.debug((String)((IFn)const__3.getRawRoot()).invoke(object9));
            }
            Object object10 = ((IFn)const__14.getRawRoot()).invoke(result__8982__auto__21212, (Object)const__15);
            if (object10 != null && object10 != Boolean.FALSE) {
                ILookupThunk iLookupThunk3 = __thunk__2__;
                Object object11 = result__8982__auto__21212;
                result__8982__auto__21212 = null;
                ...
                Object object12 = result__8982__auto__21212;
                result__8982__auto__21212 = null;
