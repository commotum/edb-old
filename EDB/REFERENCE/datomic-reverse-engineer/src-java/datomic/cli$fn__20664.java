...
public final class cli$fn__20664
extends AFunction {
    ...
    public static final AFn const__4 = (AFn)((IObj)Symbol.intern(null, (String)"datomic.cli")).withMeta(RT.map((Object[])new Object[0]));
    ...
    public Object invoke() {
        return cli$fn__20664.invokeStatic();
    }
}
