  ...
  (defn bench
    ([x]
      (let [_ (println "sorted-set")
            ss (let [start__5856__auto__ (java.lang.System/nanoTime)
                     ret__5857__auto__ (let [r (java.util.Random. 4242)]
            ...
            ts (let [start__5856__auto__ (java.lang.System/nanoTime)
                     ret__5857__auto__ (let [r (java.util.Random. 4242) ts (java.util.TreeSet.)]
                                         (loop [i 0]
                                           (if (< i x)
                                             (let [n (.nextLong ^java.util.Random r)]
                 ...
                 ret__5857__auto__)
            _ (println "bt-set")
            bt (let [start__5856__auto__ (java.lang.System/nanoTime)
                     ret__5857__auto__ (let [r (java.util.Random. 4242)]
                                         (loop [bt (btset) i 0]
                                           (if (< i x)
                                             (let [n (.nextLong ^java.util.Random r)]
        ...
        (when-not (every?
                    (fn fn__11871
                      ([p1__11862#]
                        (let [x (seek bt p1__11862#)]
                          (and x (= (.get ^datomic.iter.Iter x) p1__11862#)))))
                    ss)
          (throw
            (java.lang.AssertionError.
              (str
                ...
                (pr-str
                  (clojure.core/list
                    ...
                    (clojure.core/list
                      ...
                      (clojure.core/list
                        'let
                        ['x (clojure.core/list 'seek 'bt 'p1__11862#)]
                        (clojure.core/list
                          'and
                          'x
                          (clojure.core/list '= (clojure.core/list '.get 'x) 'p1__11862#))))
                    'ss))))))
        (when-not (every?
                    (fn fn__11874
                      ([p1__11863#]
                        (let [x (rseek bt p1__11863#)]
                          (and x (= (.get ^datomic.iter.Iter x) p1__11863#)))))
                    ss)
          (throw
            (java.lang.AssertionError.
              (str
                ...
                (pr-str
                  (clojure.core/list
                    ...
                    (clojure.core/list
                      ...
                      (clojure.core/list
                        'let
                        ['x (clojure.core/list 'rseek 'bt 'p1__11863#)]
                        (clojure.core/list
                          'and
                          'x
                          (clojure.core/list '= (clojure.core/list '.get 'x) 'p1__11863#))))
                    'ss))))))
        (when-not (every? (fn fn__11877 ([p1__11864#] (contains? bt p1__11864#))) ss)
          (throw
            (java.lang.AssertionError.
              (str
                "Assert failed: "
                (pr-str
                  (clojure.core/list
                    ...
                    (clojure.core/list
                      'fn*
                      ['p1__11864#]
                      (clojure.core/list 'contains? 'bt 'p1__11864#))
                    'ss))))))
        ...
        (dotimes [_ 20]
          (let [start__5856__auto__ (java.lang.System/nanoTime)
                ret__5857__auto__ (loop [s (seq ss) ret 0] (if s (recur (next s) (first s)) ret))]
            (prn
              (str
                "Elapsed time: "
                (java.lang.Double/valueOf
        ...
        (dotimes [_ 5]
          (let [start__5856__auto__ (java.lang.System/nanoTime)
                ret__5857__auto__ (loop [s (seq ss) ret 0]
        ...
        (dotimes [_ 20]
          (let [start__5856__auto__ (java.lang.System/nanoTime)
                ret__5857__auto__ (loop [s (seek bt) ret 0]
        ...
        (dotimes [_ 20]
          (let [start__5856__auto__ (java.lang.System/nanoTime)
                ret__5857__auto__ (loop [s (.iterator ^java.util.TreeSet ts) ret 0]
