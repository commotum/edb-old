(do
  ...
  (defn list-metrics
    ([client request]
      (let [result (if request
        ...
        (map
          d/object-to-data
          (let [temp__5455__auto__ (.getNextToken
                                     ^com.amazonaws.services.cloudwatch.model.ListMetricsResult result)]
            (if temp__5455__auto__
              (let [token temp__5455__auto__]
                (lazy-seq
                  (concat
                    metrics
                    (list-metrics
                      client
                      (let [G__22813 (com.amazonaws.services.cloudwatch.model.ListMetricsRequest.)]
                        (.setNextToken
                          ^com.amazonaws.services.cloudwatch.model.ListMetricsRequest G__22813
  ...
  (defmethod
    ...
    [com.amazonaws.services.cloudwatch.model.DescribeAlarmsRequest :alarmNames]
    fn__22833
    ([_ _ val _] (mapv (fn fn__22834 ([item] (d/data-to-object item java.lang.String))) val)))
  (extend
    com.amazonaws.services.cloudwatch.model.Dimension
    d/ObjectToData
    {:object-to-data
     (fn fn__22837
       ([o]
         (apply
           hash-map
           (concat
             (let [temp__5457__auto__ (.getName
             ...
             (let [temp__5457__auto__ (.getValue
                                        ^com.amazonaws.services.cloudwatch.model.Dimension o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:value (d/object-to-data-wrapper v__17285__auto__)])))))))})
  (extend
    com.amazonaws.services.cloudwatch.model.DimensionFilter
    d/ObjectToData
    {:object-to-data
     ...
     (fn fn__22849
       ([o]
         (apply
           hash-map
           (concat
             (let [temp__5457__auto__ (.getNamespace
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:namespace (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getDimensions
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:dimensions (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getMetrics
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:metrics (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getComparisonOperator
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:comparisonOperator (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getStatistic
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:statistic (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getStateValue
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:stateValue (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getAlarmName
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:alarmName (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getAlarmArn
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:alarmArn (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getAlarmDescription
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:alarmDescription (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getAlarmConfigurationUpdatedTimestamp
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:alarmConfigurationUpdatedTimestamp
                    (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getActionsEnabled
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:actionsEnabled (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.isActionsEnabled
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:actionsEnabled (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getOKActions
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:oKActions (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getAlarmActions
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:alarmActions (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getInsufficientDataActions
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:insufficientDataActions (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getStateReason
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:stateReason (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getStateReasonData
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:stateReasonData (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getStateUpdatedTimestamp
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:stateUpdatedTimestamp (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getExtendedStatistic
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:extendedStatistic (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getEvaluationPeriods
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:evaluationPeriods (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getDatapointsToAlarm
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:datapointsToAlarm (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getThreshold
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:threshold (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getTreatMissingData
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:treatMissingData (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getEvaluateLowSampleCountPercentile
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:evaluateLowSampleCountPercentile
                    (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getThresholdMetricId
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:thresholdMetricId (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getEvaluationState
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:evaluationState (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getStateTransitionedTimestamp
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:stateTransitionedTimestamp (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getMetricName
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:metricName (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getPeriod
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:period (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getUnit
                                        ^com.amazonaws.services.cloudwatch.model.MetricAlarm o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:unit (d/object-to-data-wrapper v__17285__auto__)])))))))})
  (extend
     ...
     (fn fn__22911
       ([o]
         (apply
           hash-map
           (concat
             (let [temp__5457__auto__ (.getNextToken
                                        ^com.amazonaws.services.cloudwatch.model.DescribeAlarmsResult o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:nextToken (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getCompositeAlarms
                                        ^com.amazonaws.services.cloudwatch.model.DescribeAlarmsResult o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:compositeAlarms (d/object-to-data-wrapper v__17285__auto__)])))
             (let [temp__5457__auto__ (.getMetricAlarms
                                        ^com.amazonaws.services.cloudwatch.model.DescribeAlarmsResult o)]
               (when temp__5457__auto__
                 (let [v__17285__auto__ temp__5457__auto__]
                   [:metricAlarms (d/object-to-data-wrapper v__17285__auto__)])))
  ...
  (defmethod
    ...
    fn__22923
    ([m _]
      (let [temp__5457__auto__ (seq (remove #{:name :value} (keys m)))]
        (when temp__5457__auto__
      ...
      (let [o (com.amazonaws.services.cloudwatch.model.MetricDatum.)]
        ...
        (when (contains? m :value)
          (let [v (:value m) k (d/property-to-object (class o) :value v java.lang.Double)]
            (.setValue ^com.amazonaws.services.cloudwatch.model.MetricDatum o ^java.lang.Double k)
            nil))
        o)))
  (defmethod
    d/data-to-object
    ...
    fn__22941
    ([m _]
      (let [temp__5457__auto__ (seq (remove #{:maximum :minimum :sum :sampleCount} (keys m)))]
        (when temp__5457__auto__
          (let [bad_ks temp__5457__auto__]
            (throw
              (ex-info
