    ...
    ([error]
      ...
      (try
        (let [stashing_eval (fn stashing_eval
          ...
          (main/repl :prompt prompt :eval stashing_eval :init (fn fn__20656 ([] (set! *e error))))
          (if (instance? java.lang.Throwable *result*) (do (throw *result*) nil) *result*))
                  ...
                  (concat
                    ...
                    (clojure.core/list
                      (apply
                        ...
                        (seq
                          (concat
                            (clojure.core/list 'form__20659__auto__)
                            (clojure.core/list
                              (seq (concat (clojure.core/list 'quote) (clojure.core/list x))))
                            (clojure.core/list 'error__20660__auto__)
                            (clojure.core/list
                              (seq
                                (concat
