(do
  ...
  (deftype
    ...
    (next
      [this]
      (let [temp__5457__auto__ (.next ^datomic.iter.Iter iter)]
        (when temp__5457__auto__ (let [n temp__5457__auto__] (set! iter n) this))))
    ...
    (next
      ...
      (let [temp__5455__auto__ (.next ^datomic.iter.Iter iter)]
        (if temp__5455__auto__
          (let [nxt temp__5455__auto__] (set! iter nxt) this)
          (let [vec__11753 iters
                seq__11754 (seq vec__11753)
                first__11755 (first seq__11754)
                seq__11754 (next seq__11754)
                nxt first__11755
                more seq__11754]
  ...
  (defn concat
    ([iters]
      (let [vec__11761 (clojure.core/filter identity iters)
            seq__11762 (seq vec__11761)
            first__11763 (first seq__11762)
            seq__11762 (next seq__11762)
            iter first__11763
            iters seq__11762]
  ...
  (defn filter
    ([p iter]
      (let [advance (fn advance
            ...
            temp__5457__auto__ (^clojure.lang.IFn advance iter)]
        (when temp__5457__auto__
          (let [iter temp__5457__auto__]
            (reify
              ...
              (next
                [this]
                (let [temp__5457__auto__ (^clojure.lang.IFn advance
                                           (.next ^datomic.iter.Iter iter))]
                  (when temp__5457__auto__
                    (let [inext temp__5457__auto__]
  ...
  (deftype
    ...
    (next
      [this]
      (let [temp__5457__auto__ (.prev ^datomic.iter.Iter iter)]
        (when temp__5457__auto__ (let [it temp__5457__auto__] (set! iter it) this))))
    (get [this] (.get ^datomic.iter.Iter iter)))
