//! Public index prefix and virtual-boundary semantics.
use crate::model::identity::validate_permanent_eid;
use crate::{Datom, IndexOrder, SemanticError, Value, t_to_tx, tx_to_t};
