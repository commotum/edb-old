...
impl AsyncExecutor {
    ...
    pub(super) fn reserve(&self) -> Result<Reservation, SemanticError> {
    ...
    pub(super) fn watch_admission(&self, id: u64, waker: &Waker) {
        self.shared
            .admission
            .lock()
            .unwrap_or_else(|e| e.into_inner())
    ...
    pub(super) fn unwatch_admission(&self, id: u64) {
        self.shared
            .admission
            .lock()
            .unwrap_or_else(|e| e.into_inner())
...
pub(super) fn deadline(timeout: Option<Duration>) -> Result<Option<Instant>, SemanticError> {
    timeout
        .map(|timeout| {
...
pub(super) fn deadline_error() -> SemanticError {
    SemanticError::new(
