...
```text
Implement Atomic's integrated product acceptance and recovery stage using
/home/jake/Developer/atomic/goal-10/0-plan.md and
/home/jake/Developer/atomic/goal-10/0-loop.md.
This is Stage 9 of /home/jake/Developer/atomic/goal-0/0-plan.md, owning all required stages; AO-C02 disposition (mixed-version upgrades out of scope).
