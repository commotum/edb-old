...
public final class integrity$crosscheck_log_cli$fn__22179
extends AFunction {
    Object history;
    Object nohistory;
    Object current;
    ...
    public integrity$crosscheck_log_cli$fn__22179(Object object, Object object2, Object object3) {
        this.history = object;
        this.nohistory = object2;
        this.current = object3;
    }
    ...
    public Object invoke(Object result2) {
        ...
        result2 = null;
        Object G__22180 = object;
        switch (Util.hash((Object)G__22180) >> 2 & 3) {
            case 0: {
                if (G__22180 != const__0) break;
                ...
                integrity$crosscheck_log_cli$fn__22179 this_ = null;
                Object object2 = ((IFn)const__7.getRawRoot()).invoke();
                return object2;
            }
            case 1: {
                if (G__22180 != const__8) break;
