...
public final class s3$fn__23257
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.s3", (String)"Name");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__23259;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__23259 = var2;
        v__6457__auto__23259 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return s3$fn__23257.invokeStatic();
    }
}
