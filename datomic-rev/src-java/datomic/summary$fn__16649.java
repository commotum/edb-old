...
public final class summary$fn__16649
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.summary", (String)"Summary");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__16651;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__16651 = var2;
        v__6457__auto__16651 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return summary$fn__16649.invokeStatic();
    }
}
