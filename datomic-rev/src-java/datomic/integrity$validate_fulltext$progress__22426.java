...
public final class integrity$validate_fulltext$progress__22426
extends RestFn {
    Object count;
    ...
    public static final Object const__4 = 100L;
    ...
    public integrity$validate_fulltext$progress__22426(Object object) {
        this.count = object;
    }
    ...
    public Object doInvoke(Object _) {
        ...
        if (Numbers.isZero((Object)((IFn)const__1.getRawRoot()).invoke(((IFn)const__2.getRawRoot()).invoke(this_.count, const__3.getRawRoot()), const__4))) {
            ...
            integrity$validate_fulltext$progress__22426 this_ = null;
