...
public final class LogTailValue$reify__16460
...
IObj {
    ...
    public LogTailValue$reify__16460(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public LogTailValue$reify__16460(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new LogTailValue$reify__16460(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical((Object)((IFn)const__1.getRawRoot()).invoke(gtarget), (Object)this.gclass)) {
            ...
            gtarget = null;
            object = ((LogTailValue)object2).txes;
        } else {
            object = this;
        }
        return object;
