...
public final class index$fn__14994
extends AFunction {
    ...
    public static final AFn const__4 = (AFn)((IObj)Symbol.intern(null, (String)"datomic.index")).withMeta(RT.map((Object[])new Object[]{RT.keyword(null, (String)"author"), "Rich Hickey"}));
    ...
    public Object invoke() {
        return index$fn__14994.invokeStatic();
    }
}
