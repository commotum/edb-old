...
public final class monitor$loading__6434__auto____475
extends AFunction {
    ...
    public static final AFn const__5 = (AFn)Tuple.create((Object)Symbol.intern(null, (String)"clojure.pprint"), (Object)RT.keyword(null, (String)"only"), (Object)((IObj)PersistentList.create(Arrays.asList(Symbol.intern(null, (String)"pprint")))).withMeta(RT.map((Object[])new Object[]{RT.keyword(null, (String)"column"), 31})));
    ...
    public Object invoke() {
        ...
        try {
            ...
            ((Namespace)RT.CURRENT_NS.deref()).importClass(RT.classForNameNonLoading((String)"java.util.concurrent.atomic.LongAccumulator"));
            clazz = ((Namespace)RT.CURRENT_NS.deref()).importClass(RT.classForNameNonLoading((String)"java.util.concurrent.atomic.LongAdder"));
        }
        finally {
