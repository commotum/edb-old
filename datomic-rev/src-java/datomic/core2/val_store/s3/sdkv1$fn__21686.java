...
public final class sdkv1$fn__21686
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.core2.val-store.s3.sdkv1", (String)"Impl");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6812__auto__21688;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6812__auto__21688 = var2;
        v__6812__auto__21688 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return sdkv1$fn__21686.invokeStatic();
    }
}
