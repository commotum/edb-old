...
public final class fulltext$fn__14520
extends AFunction {
    ...
    public static final AFn const__4 = (AFn)((IObj)Symbol.intern(null, (String)"datomic.fulltext")).withMeta(RT.map((Object[])new Object[]{RT.keyword(null, (String)"author"), "Stuart Halloway"}));
    ...
    public Object invoke() {
        return fulltext$fn__14520.invokeStatic();
    }
}
