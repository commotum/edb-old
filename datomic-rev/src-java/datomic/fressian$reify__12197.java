...
public final class fressian$reify__12197
implements ReadHandler,
IObj {
    final IPersistentMap __meta;
    public static final Var const__0 = RT.var((String)"clojure.core", (String)"keyword");

    public fressian$reify__12197(IPersistentMap iPersistentMap) {
        this.__meta = iPersistentMap;
    }

    public fressian$reify__12197() {
        this(null);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new fressian$reify__12197(iPersistentMap);
    }
    ...
    public Object read(Reader rdr, Object tag, int component_count) throws IOException {
        ...
        Reader reader2 = rdr;
        rdr = null;
        fressian$reify__12197 this_ = null;
