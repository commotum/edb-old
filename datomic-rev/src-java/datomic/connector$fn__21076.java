...
public final class connector$fn__21076
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.connector", (String)"TransactorConnector");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__21078;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__21078 = var2;
        v__6457__auto__21078 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return connector$fn__21076.invokeStatic();
    }
}
