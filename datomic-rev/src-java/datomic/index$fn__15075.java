...
public final class index$fn__15075
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.index", (String)"IIndex");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__15077;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__15077 = var2;
        v__6457__auto__15077 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return index$fn__15075.invokeStatic();
    }
}
