...
public final class kv_sql_ext$loading__6434__auto____11537
extends AFunction {
    ...
    public static final AFn const__6 = (AFn)Tuple.create((Object)Symbol.intern(null, (String)"datomic.sql"), (Object)RT.keyword(null, (String)"as"), (Object)Symbol.intern(null, (String)"sql"));
    ...
    public Object invoke() {
        ...
        try {
            ...
            ((Namespace)RT.CURRENT_NS.deref()).importClass(RT.classForNameNonLoading((String)"java.sql.SQLException"));
            clazz = ((Namespace)RT.CURRENT_NS.deref()).importClass(RT.classForNameNonLoading((String)"org.apache.tomcat.jdbc.pool.DataSource"));
        }
        finally {
