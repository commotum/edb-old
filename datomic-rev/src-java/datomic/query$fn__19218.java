...
public final class query$fn__19218
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.query", (String)"Immutify");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__19220;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__19220 = var2;
        v__6457__auto__19220 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return query$fn__19218.invokeStatic();
    }
}
