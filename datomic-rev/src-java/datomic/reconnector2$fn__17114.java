...
public final class reconnector2$fn__17114
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.reconnector2", (String)"Reconnectable");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__17116;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__17116 = var2;
        v__6457__auto__17116 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return reconnector2$fn__17114.invokeStatic();
    }
}
