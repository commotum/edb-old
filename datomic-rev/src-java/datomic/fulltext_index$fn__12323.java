...
public final class fulltext_index$fn__12323
extends AFunction {
    ...
    public static final AFn const__4 = (AFn)((IObj)Symbol.intern(null, (String)"datomic.fulltext-index")).withMeta(RT.map((Object[])new Object[]{RT.keyword(null, (String)"author"), "Stu Halloway"}));
    ...
    public Object invoke() {
        return fulltext_index$fn__12323.invokeStatic();
    }
}
