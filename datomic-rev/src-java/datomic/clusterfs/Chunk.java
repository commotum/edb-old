...
import datomic.clusterfs.Chunk$reify__14189;
...
Serializable {
    ...
    public static final Keyword const__8 = RT.keyword(null, (String)"chunk");
    public static final AFn const__9 = (AFn)PersistentHashSet.create((Object[])new Object[]{RT.keyword(null, (String)"chunk")});
    ...
    public static final AFn const__16 = (AFn)Tuple.create((Object)RT.keyword(null, (String)"chunk"));
    ...
    public Chunk(Object object, Object object2, Object object3, int n, int n2) {
        this.chunk = object;
        this.__meta = object2;
    ...
    public Chunk(Object object, Object object2, Object object3) {
        this(object, object2, object3, 0, 0);
    }

    public static IPersistentVector getBasis() {
        return Tuple.create((Object)((IObj)Symbol.intern(null, (String)"chunk")).withMeta(RT.map((Object[])new Object[]{RT.keyword(null, (String)"tag"), Symbol.intern(null, (String)"bytes")})));
    }

    public static Chunk create(IPersistentMap iPersistentMap) {
        Object object = iPersistentMap.valAt((Object)Keyword.intern((String)"chunk"), null);
        iPersistentMap = iPersistentMap.without((Object)Keyword.intern((String)"chunk"));
        return new Chunk(object, null, RT.seqOrElse((Object)iPersistentMap), 0, 0);
    }
    ...
    public int hasheq() {
        void v0;
        int hq__7465__auto__14194 = this.__hasheq;
        if ((long)hq__7465__auto__14194 == 0L) {
            void var2_2;
            int h__7466__auto__14193;
            this.__hasheq = h__7466__auto__14193 = RT.intCast((long)(0xFFFFFFFFF92AF38FL ^ (long)APersistentMap.mapHasheq((IPersistentMap)this)));
            v0 = var2_2;
        } else {
            void var1_1;
            v0 = var1_1;
    ...
    public int hashCode() {
        void v0;
        int hash__7468__auto__14196 = this.__hash;
        if ((long)hash__7468__auto__14196 == 0L) {
            void var2_2;
            int h__7469__auto__14195;
            this.__hash = h__7469__auto__14195 = APersistentMap.mapHash((IPersistentMap)this);
            v0 = var2_2;
        } else {
            void var1_1;
            v0 = var1_1;
    ...
    public boolean equals(Object G__14184) {
        Object object = G__14184;
        G__14184 = null;
    ...
    public IObj withMeta(IPersistentMap G__14184) {
        IPersistentMap iPersistentMap = G__14184;
        G__14184 = null;
        return new Chunk(this.chunk, iPersistentMap, this.__extmap, this.__hash, this.__hasheq);
    }
    ...
    public Object valAt(Object k__7476__auto__, Object else__7477__auto__) {
        Object object;
        Object G__14191 = k__7476__auto__;
        switch (Util.hash((Object)G__14191)) {
            case -1421559374: {
                if (G__14191 == const__8) {
                    object = this_.chunk;
                    break;
                }
            }
    ...
    public ILookupThunk getLookupThunk(Keyword k__7479__auto__) {
        Chunk$reify__14189 chunk$reify__14189;
        Object gclass = ((IFn)const__20.getRawRoot()).invoke((Object)this);
        Keyword keyword = k__7479__auto__;
        k__7479__auto__ = null;
        Keyword G__14188 = keyword;
        switch (Util.hash((Object)G__14188)) {
            case -1421559374: {
                if (G__14188 == const__8) {
                    gclass = null;
                    chunk$reify__14189 = new Chunk$reify__14189(null, gclass);
                    break;
                }
            }
            default: {
                chunk$reify__14189 = null;
            }
        }
        return chunk$reify__14189;
    }
    ...
    public IPersistentCollection empty() {
        throw (Throwable)new UnsupportedOperationException((String)((IFn)const__22.getRawRoot()).invoke((Object)"Can't create empty: ", (Object)"datomic.clusterfs.Chunk"));
    }
    ...
    public IPersistentCollection cons(Object e__7483__auto__) {
        ...
        Chunk this_ = null;
        return (IPersistentCollection)((IFn)const__21).invoke((Object)chunk2, object);
    }

    public boolean equiv(Object G__14184) {
        Boolean bl;
        boolean or__5238__auto__14198 = Util.identical((Object)this, (Object)G__14184);
        if (or__5238__auto__14198) {
            bl = or__5238__auto__14198 ? Boolean.TRUE : Boolean.FALSE;
        } else if (Util.identical((Object)((IFn)const__20.getRawRoot()).invoke((Object)this), (Object)((IFn)const__20.getRawRoot()).invoke(G__14184))) {
            Object object = G__14184;
            G__14184 = null;
            Object G__141842 = object;
            boolean and__5236__auto__14197 = Util.equiv((Object)this.chunk, (Object)((Chunk)G__141842).chunk);
            if (and__5236__auto__14197) {
                Object object2 = G__141842;
                G__141842 = null;
                bl = Util.equiv((Object)this.__extmap, (Object)((Chunk)object2).__extmap) ? Boolean.TRUE : Boolean.FALSE;
            } else {
                bl = and__5236__auto__14197 ? Boolean.TRUE : Boolean.FALSE;
            }
        } else {
            bl = null;
        }
    ...
    public IMapEntry entryAt(Object k__7488__auto__) {
        MapEntry mapEntry;
        Object v__7489__auto__14199 = ((ILookup)this_).valAt(k__7488__auto__, (Object)this_);
        if (Util.identical((Object)this_, (Object)v__7489__auto__14199)) {
            mapEntry = null;
        } else {
            Object object = k__7488__auto__;
            k__7488__auto__ = null;
            Object object2 = v__7489__auto__14199;
            v__7489__auto__14199 = null;
            Chunk this_ = null;
    ...
    public ISeq seq() {
        Chunk this_ = null;
        return (ISeq)((IFn)const__17.getRawRoot()).invoke(((IFn)const__18.getRawRoot()).invoke((Object)Tuple.create((Object)MapEntry.create((Object)const__8, (Object)this_.chunk)), this_.__extmap));
    }
    ...
    public IPersistentMap assoc(Object k__7493__auto__, Object G__14184) {
        Chunk chunk2;
        Object pred__14186 = const__14.getRawRoot();
        Object expr__14187 = k__7493__auto__;
        Object object = pred__14186;
        pred__14186 = null;
        Object object2 = expr__14187;
        expr__14187 = null;
        Object object3 = ((IFn)object).invoke((Object)const__8, object2);
        if (object3 != null && object3 != Boolean.FALSE) {
            G__14184 = null;
            chunk2 = new Chunk(G__14184, this.__meta, this.__extmap);
        } else {
            k__7493__auto__ = null;
            G__14184 = null;
            chunk2 = new Chunk(this.chunk, this.__meta, ((IFn)const__15.getRawRoot()).invoke(this.__extmap, k__7493__auto__, G__14184));
        }
        return chunk2;
    }
    ...
    public IPersistentMap without(Object k__7495__auto__) {
        ...
        if (object2 != null && object2 != Boolean.FALSE) {
            ...
            k__7495__auto__ = null;
            object = new Chunk(this_.chunk, this_.__meta, ((IFn)const__13.getRawRoot()).invoke(((IFn)const__10.getRawRoot()).invoke(this_.__extmap, k__7495__auto__)));
        }
    ...
    public Collection values() {
        Chunk chunk2 = this_;
        Chunk this_ = null;
        return (Collection)((IFn)const__1.getRawRoot()).invoke((Object)chunk2);
    }

    public Set entrySet() {
        Chunk chunk2 = this_;
        Chunk this_ = null;
        return (Set)((IFn)const__0.getRawRoot()).invoke((Object)chunk2);
    }
}
