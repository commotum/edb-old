(do
  ...
  (defn gc-storage
    ([connection older_than]
      ...
      nil))
  (defn transact
    ([connection tx_data & p__19587]
      (let [map__19588 p__19587
            map__19588 (if (seq? map__19588)
                         (clojure.lang.PersistentHashMap/create (seq map__19588))
                         map__19588)
            options map__19588]
        (.transact ^datomic.Connection connection ^java.util.List tx_data options))))
  (defn transact-async
    ([connection tx_data & p__19590]
      (let [map__19591 p__19590
            map__19591 (if (seq? map__19591)
                         (clojure.lang.PersistentHashMap/create (seq map__19591))
                         map__19591)
            options map__19591]
  ...
  (defn pull
    ([db pattern eid & p__19608]
      (let [map__19609 p__19608
            map__19609 (if (seq? map__19609)
                         (clojure.lang.PersistentHashMap/create (seq map__19609))
                         map__19609)
            options map__19609]
        (.pull ^datomic.Database db pattern eid options))))
  (defn index-pull ([db arg_map] (datomic.pull/dereffed-index-pull db arg_map)))
  (defn pull-many
    ([db pattern eids & p__19612]
      (let [map__19613 p__19612
            map__19613 (if (seq? map__19613)
                         (clojure.lang.PersistentHashMap/create (seq map__19613))
                         map__19613)
            options map__19613]
  ...
  (defn cancel
    ([p__19629]
      (let [map__19630 p__19629
            map__19630 (if (seq? map__19630)
                         (clojure.lang.PersistentHashMap/create (seq map__19630))
                         map__19630)
            anomaly_map map__19630
            category (get map__19630 :cognitect.anomalies/category)
            ...
            throw_incorrect_anom (fn throw_incorrect_anom
                                   ([p1__19628#]
                                     ...
                                     nil))]
        (cond
          (not category) (^clojure.lang.IFn throw_incorrect_anom
                           "Cancel requires :cognitect.anomalies/category")
          (not (some #{category} allowed_anoms)) (^clojure.lang.IFn throw_incorrect_anom
                                                   (str
                                                     "Invalid :cognitect.anomalies/category provided to cancel: "
                                                     category))
          (not (fressian/fressianable? anomaly_map)) (^clojure.lang.IFn throw_incorrect_anom
  ...
  (loop [seq_19641 (seq
         ...
         count_19643 0
         i_19644 0]
    (if (< i_19644 count_19643)
      (let [vec__19646 (.nth ^clojure.lang.Indexed chunk_19642 (int i_19644))
            v (nth vec__19646 (int 0) nil)
            doc (nth vec__19646 (int 1) nil)]
        (alter-meta! v assoc :doc doc)
        (recur seq_19641 chunk_19642 count_19643 (inc i_19644)))
      (let [temp__5457__auto__ (seq seq_19641)]
        (when temp__5457__auto__
          (let [seq_19641 temp__5457__auto__]
            (if (chunked-seq? seq_19641)
              (let [c__5719__auto__ (chunk-first seq_19641)]
                (recur
                  (chunk-rest seq_19641)
                  c__5719__auto__
                  (int (count c__5719__auto__))
                  (int 0)))
              (let [vec__19649 (first seq_19641)
                    v (nth vec__19649 (int 0) nil)
                    doc (nth vec__19649 (int 1) nil)]
                (alter-meta! v assoc :doc doc)
                (recur (next seq_19641) nil 0 0)))))))))