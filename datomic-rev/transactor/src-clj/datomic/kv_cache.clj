(do
  ...
  (def kv-cache-ref
   (let [G__31050 (atom nil)]
     (add-watch G__31050 :datomic.kv-cache/closer common/closing-watch)
     G__31050))
  (reset-meta! #'kv-cache-ref (assoc {:private true, :column 1} :name 'kv-cache-ref :ns *ns*))
