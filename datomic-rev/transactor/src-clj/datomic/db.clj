(do
  ...
  (defrecord
    ...
    (^java.lang.String toString
      ...
      (str
        "#db/id["
        (:part this)
        (let [temp__5804__auto__ (:idx this)]
          (when temp__5804__auto__ (let [idx temp__5804__auto__] (str " " idx))))
        "]")))
  ...
  (defmethod print-dup datomic.db.DbId fn__10060 ([o w] (print-method o w)))
  ...
  (let [protocol_metadata__7420 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7420 :doc nil) :name 'LocalizeTempid :ns *ns*))
  ...
  (let [protocol_metadata__7423 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7423 :doc nil) :name 'Symbolish :ns *ns*))
  ...
  (reset-meta!
    ...
    (assoc
      ...
      :ns
      *ns*))
  (extend nil datomic.db/Symbolish {:sym-name (fn fn__10123 ([_] nil))})
  (extend java.lang.Object datomic.db/Symbolish {:sym-name (fn fn__10125 ([_] nil))})
  (extend
    clojure.lang.Named
    datomic.db/Symbolish
    {:sym-name (fn fn__10127 ([k] (name k))), :sym-namespace (fn fn__10129 ([k] (namespace k)))})
      ...
      (fn fn__10131
        ([x]
          (if (string? x)
            ...
            (let [temp__5802__auto__ (datomic.db/sym-name x)]
              (if temp__5802__auto__
                (let [name temp__5802__auto__] (keyword (datomic.db/sym-namespace x) name))
                x)))))))
  ...
  (defn normalize-kw
    ([kw]
      (let [temp__5804__auto__ (datomic.db/to-kw kw)]
  ...
  (def resolve-dbid
   (fn resolve_dbid
     ([db x]
       (let [map__10229 x
             map__10229 (if (seq? map__10229)
                          (if (next map__10229)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__10229))
                            (if (seq map__10229) (first map__10229) {}))
                          map__10229)
             part (get map__10229 :part)
             idx (get map__10229 :idx)
       ...
       (if (or (nil? attr) (nil? tup))
         ...
         (let [resolve (fn resolve
           ...
           (cond
             ...
             (and
               (some (fn fn__10243 ([p1__10239#] (= :db.type/ref p1__10239#))) (:tupleTypes attr))
     ...
     (fn fn__10253
       ([this db procargs local_tempids]
         (if (.startsWith this ":")
           ...
           (let [temp__5802__auto__ (get local_tempids this)]
             (if temp__5802__auto__
               (let [id temp__5802__auto__] id)
  ...
  (def datum
   (fn datum
     ([db & p__10259]
       (let [map__10260 p__10259
             map__10260 (if (seq? map__10260)
                          (if (next map__10260)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__10260))
                            (if (seq map__10260) (first map__10260) {}))
                          map__10260)
             asserting (get map__10260 :asserting true)
             e (get map__10260 :e)
             a (get map__10260 :a)
             v (get map__10260 :v)
             t (get map__10260 :t)
     ...
     ([iter]
       (let [eat_past (fn eat_past
             ...
             next_skip (fn next_skip
                         ([p1__10264#] (^clojure.lang.IFn skip (iter/inext p1__10264#))))]
         (when iter
           (reify
             datomic.iter.Iter
    ...
    (valAt
      ...
      (let [G__10344 k]
        (case
          ...
          vtype_kw
          :unique
          (let [pred__10345 = expr__10346 (:unique attr)]
            (if (^clojure.lang.IFn pred__10345 38 expr__10346)
              :db.unique/identity
              (if (^clojure.lang.IFn pred__10345 37 expr__10346)
                :db.unique/value
                (when-not (^clojure.lang.IFn pred__10345 nil expr__10346)
                  (throw
                    (java.lang.IllegalArgumentException. (str "No matching clause: " expr__10346)))
                  (bit-and (bit-shift-right (clojure.lang.Util/hash G__10344) 8) 15)))))
          :no-history
          ...
          (:kw attr)
          :cardinality
          (let [pred__10347 = expr__10348 (:cardinality attr)]
            (if (^clojure.lang.IFn pred__10347 35 expr__10348)
              :db.cardinality/one
              (if (^clojure.lang.IFn pred__10347 36 expr__10348)
                :db.cardinality/many
                (do
                  (throw
                    (java.lang.IllegalArgumentException. (str "No matching clause: " expr__10348)))
                  (bit-and (bit-shift-right (clojure.lang.Util/hash G__10344) 8) 15)))))
          not_found)))
    (valAt
      [this k]
      (let [G__10339 k]
        (case
          ...
          (:id attr)
          :unique
          (let [pred__10342 = expr__10343 (:unique attr)]
            (if (^clojure.lang.IFn pred__10342 38 expr__10343)
              :db.unique/identity
              (if (^clojure.lang.IFn pred__10342 37 expr__10343)
                :db.unique/value
                (when-not (^clojure.lang.IFn pred__10342 nil expr__10343)
                  (throw
                    (java.lang.IllegalArgumentException. (str "No matching clause: " expr__10343)))
                  (bit-and (bit-shift-right (clojure.lang.Util/hash G__10339) 1) 31)))))
          :cardinality
          (let [pred__10340 = expr__10341 (:cardinality attr)]
            (if (^clojure.lang.IFn pred__10340 35 expr__10341)
              :db.cardinality/one
              (if (^clojure.lang.IFn pred__10340 36 expr__10341)
                :db.cardinality/many
                (do
                  (throw
                    (java.lang.IllegalArgumentException. (str "No matching clause: " expr__10341)))
                  (bit-and (bit-shift-right (clojure.lang.Util/hash G__10339) 1) 31)))))
          :ident
          (:kw attr)))))
  ...
  (def attr-info
   (fn attr_info
     ([db attrid]
       (let [temp__5804__auto__ (let [G__10355 (datomic.db/resolve-id db attrid)]
                                  (when-not (nil? G__10355) (datomic.db/attribute db G__10355)))]
         (when temp__5804__auto__
  ...
  (defn seek-datoms
    ([db index components]
      (let [vec__10439 (let [G__10442 index]
                         (case
                           G__10442
                           :aevt
                           (let [vec__10443 components
                                 a (nth vec__10443 (unchecked-int 0) nil)
                                 e (nth vec__10443 (unchecked-int 1) nil)
                                 v (nth vec__10443 (unchecked-int 2) nil)
                                 t (nth vec__10443 (unchecked-int 3) nil)]
                             [e a v t])
                           :avet
                           (let [vec__10446 components
                                 a (nth vec__10446 (unchecked-int 0) nil)
                                 v (nth vec__10446 (unchecked-int 1) nil)
                                 e (nth vec__10446 (unchecked-int 2) nil)
                                 t (nth vec__10446 (unchecked-int 3) nil)]
                             [e a v t])
                           :eavt
                           components
                           :vaet
                           (let [vec__10449 components
                                 v (nth vec__10449 (unchecked-int 0) nil)
                                 a (nth vec__10449 (unchecked-int 1) nil)
                                 e (nth vec__10449 (unchecked-int 2) nil)
                                 t (nth vec__10449 (unchecked-int 3) nil)]
                             [e a v t])))
            e (nth vec__10439 (unchecked-int 0) nil)
            a (nth vec__10439 (unchecked-int 1) nil)
            v (nth vec__10439 (unchecked-int 2) nil)
            t (nth vec__10439 (unchecked-int 3) nil)
            v (datomic.db/maybe-require-ids db a v (= index :vaet))
            t (when t (long (datomic.db/eid->eidx (unchecked-long ^java.lang.Number t))))
            op (let [G__10452 index]
                 (case
                   G__10452
                   :aevt
                   (fn fn__10453
                     ([p1__10433# p2__10434#]
                       (.seekAEVT ^datomic.db.IDb p1__10433# ^datomic.impl.db.IDatum p2__10434#)))
                   :avet
                   (fn fn__10455
                     ([p1__10435# p2__10436#]
                       (.seekAVET ^datomic.db.IDb p1__10435# ^datomic.impl.db.IDatum p2__10436#)))
                   :eavt
                   (fn fn__10457
                     ([p1__10431# p2__10432#]
                       (.seekEAVT ^datomic.db.IDb p1__10431# ^datomic.impl.db.IDatum p2__10432#)))
                   :vaet
                   (fn fn__10459
                     ([p1__10437# p2__10438#]
                       (.seekRAET
                         ^datomic.db.IDb p1__10437#
                         ^datomic.impl.db.IDatum p2__10438#)))))
  ...
  (def rseek-index
   (fn rseek_index
     ([p__10473 index_sort d]
       (let [map__10474 p__10473
             map__10474 (if (seq? map__10474)
                          (if (next map__10474)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__10474))
                            (if (seq map__10474) (first map__10474) {}))
                          map__10474)
             raw (get map__10474 :raw)
             asOfT (get map__10474 :asOfT)
             indexBasisT (get map__10474 :indexBasisT)
             memidx (get map__10474 :memidx)
             indexing (get map__10474 :indexing)
             mid_index (get map__10474 :mid-index)
             index (get map__10474 :index)
             history (get map__10474 :history)
         ...
         (iter/drop-while
           (fn fn__10478 ([p1__10472#] (neg? (.compare ^java.util.Comparator cmp d p1__10472#))))
           (iter/merge-iters
      ...
      (letfn
        [(step
           ...
           (let [temp__5802__auto__ (seq coll)]
             (if temp__5802__auto__
               (let [vec__10488 temp__5802__auto__
                     seq__10489 (seq vec__10488)
                     first__10490 (first seq__10489)
                     seq__10489 (next seq__10489)
                     cur first__10490
                     more seq__10489]
               ...
               (cons prior nil))))]
        (let [temp__5804__auto__ (seq coll)]
          (when temp__5804__auto__
            (let [s temp__5804__auto__] (^clojure.lang.IFn step f (first coll) (next coll))))))))
  (reset-meta!
    #'distinct-last-by
    (assoc
  ...
  (def reverse-datum-spec
   (fn reverse_datum_spec
     ([db index & p__10497]
       (let [map__10498 p__10497
             map__10498 (if (seq? map__10498)
                          (if (next map__10498)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__10498))
                            (if (seq map__10498) (first map__10498) {}))
                          map__10498)
             e (get map__10498 :e)
             a (get map__10498 :a)
             v (get map__10498 :v)
             t (get map__10498 :t)
             asserting (get map__10498 :asserting false)
  ...
  (def rseek-datoms
   (fn rseek_datoms
     ([db index components]
       (let [vec__10510 (let [G__10513 index]
                          (case
                            G__10513
                            :aevt
                            (let [vec__10514 components
                                  a (nth vec__10514 (unchecked-int 0) nil)
                                  e (nth vec__10514 (unchecked-int 1) nil)
                                  v (nth vec__10514 (unchecked-int 2) nil)
                                  t (nth vec__10514 (unchecked-int 3) nil)]
                              [e a v t])
                            :avet
                            (let [vec__10517 components
                                  a (nth vec__10517 (unchecked-int 0) nil)
                                  v (nth vec__10517 (unchecked-int 1) nil)
                                  e (nth vec__10517 (unchecked-int 2) nil)
                                  t (nth vec__10517 (unchecked-int 3) nil)]
                              [e a v t])
                            :eavt
                            components
                            :vaet
                            (let [vec__10520 components
                                  v (nth vec__10520 (unchecked-int 0) nil)
                                  a (nth vec__10520 (unchecked-int 1) nil)
                                  e (nth vec__10520 (unchecked-int 2) nil)
                                  t (nth vec__10520 (unchecked-int 3) nil)]
                              [e a v t])))
             e (nth vec__10510 (unchecked-int 0) nil)
             a (nth vec__10510 (unchecked-int 1) nil)
             v (nth vec__10510 (unchecked-int 2) nil)
             t (nth vec__10510 (unchecked-int 3) nil)
             attrid (if a (datomic.db/resolve-id db a) 0)
         ...
         (if (.isHistory ^datomic.Database db)
           ...
           (filter
             (fn fn__10523 ([p1__10509#] (.isAssertion ^datomic.impl.db.IDatum p1__10509#)))
  ...
  (defn datoms
    ([db index components]
      (let [vec__10540 (let [G__10543 index]
                         (case
                           G__10543
                           :aevt
                           (let [vec__10544 components
                                 a (nth vec__10544 (unchecked-int 0) nil)
                                 e (nth vec__10544 (unchecked-int 1) nil)
                                 v (nth vec__10544 (unchecked-int 2) nil)
                                 t (nth vec__10544 (unchecked-int 3) nil)]
                             [e a v t])
                           :avet
                           (let [vec__10547 components
                                 a (nth vec__10547 (unchecked-int 0) nil)
                                 v (nth vec__10547 (unchecked-int 1) nil)
                                 e (nth vec__10547 (unchecked-int 2) nil)
                                 t (nth vec__10547 (unchecked-int 3) nil)]
                             [e a v t])
                           :eavt
                           components
                           :vaet
                           (let [vec__10550 components
                                 v (nth vec__10550 (unchecked-int 0) nil)
                                 a (nth vec__10550 (unchecked-int 1) nil)
                                 e (nth vec__10550 (unchecked-int 2) nil)
                                 t (nth vec__10550 (unchecked-int 3) nil)]
                             [e a v t])))
            e (nth vec__10540 (unchecked-int 0) nil)
            a (nth vec__10540 (unchecked-int 1) nil)
            v (nth vec__10540 (unchecked-int 2) nil)
            t (nth vec__10540 (unchecked-int 3) nil)
            v (datomic.db/maybe-require-ids db a v (= index :vaet))
            t (when t (long (datomic.db/eid->eidx (unchecked-long ^java.lang.Number t))))
            op (let [G__10553 index]
                 (case
                   G__10553
                   :aevt
                   (fn fn__10554
                     ([p1__10533# p2__10534#]
                       (.seekAEVT ^datomic.db.IDb p1__10533# ^datomic.impl.db.IDatum p2__10534#)))
                   :avet
                   (fn fn__10556
                     ([p1__10535# p2__10536#]
                       (.seekAVET ^datomic.db.IDb p1__10535# ^datomic.impl.db.IDatum p2__10536#)))
                   :eavt
                   (fn fn__10558
                     ([p1__10531# p2__10532#]
                       (.seekEAVT ^datomic.db.IDb p1__10531# ^datomic.impl.db.IDatum p2__10532#)))
                   :vaet
                   (fn fn__10560
                     ([p1__10537# p2__10538#]
                       (.seekRAET
                         ^datomic.db.IDb p1__10537#
                         ^datomic.impl.db.IDatum p2__10538#)))))
            eid (if e (datomic.db/resolve-id db e) 0)
            attrid (if a (datomic.db/resolve-id db a) 0)]
        (when (and (= :avet index) a attrid)
          (let [temp__5804__auto__ (datomic.db/attribute db attrid)]
            ...
            ([]
              (datomic.db/windowed
                ...
                (fn fn__10563
                  ([p1__10539#]
                    (and
                      (or (nil? e) (= eid (long (.getE ^datomic.impl.db.IDatum p1__10539#))))
                      (or (nil? a) (= attrid (long (.getA ^datomic.impl.db.IDatum p1__10539#))))
                      (or
                        (nil? v)
                        (zero? (common/compare v (.getV ^datomic.impl.db.IDatum p1__10539#))))
                      (or (nil? t) (= t (long (.getT ^datomic.impl.db.IDatum p1__10539#)))))))
                (^clojure.lang.IFn op db (datomic.db/datum db :e eid :a attrid :v v :t t)))))))))
  (reset-meta!
    #'datoms
    (assoc
       ...
       (let [attrid (datomic.db/require-id db a)
         ...
         (datomic.db/windowed
           ...
           (fn fn__10578
             ([p1__10577#]
               (and
                 (= (long attrid) (long (.getA ^datomic.impl.db.IDatum p1__10577#)))
                 (or
                   (nil? end)
                   (neg? (common/compare (.getV ^datomic.impl.db.IDatum p1__10577#) end))))))
  ...
  (def get-entity
   (fn get_entity
     ([db ent & p__10638]
       (let [map__10639 p__10638
             map__10639 (if (seq? map__10639)
                          (if (next map__10639)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__10639))
                            (if (seq map__10639) (first map__10639) {}))
                          map__10639)
             raw (get map__10639 :raw)
             eid (datomic.db/resolve-id db ent)]
         (loop [iter (datomic.db/windowed
                       db
                       (fn fn__10640
                         ([p1__10637#] (= eid (long (.getE ^datomic.impl.db.IDatum p1__10637#)))))
  ...
  (def datom-error-desc
   (fn datom_error_desc
     ([db p__10652]
       (let [vec__10653 p__10652
             e (nth vec__10653 (unchecked-int 0) nil)
             a (nth vec__10653 (unchecked-int 1) nil)
             v (nth vec__10653 (unchecked-int 2) nil)
             tx (nth vec__10653 (unchecked-int 3) nil)
             added (nth vec__10653 (unchecked-int 4) nil)
             attr (let [G__10656 (.entid ^datomic.Database db a)]
                    (when-not (nil? G__10656) (datomic.db/attribute db G__10656)))]
         (into
       ...
       (let [db (if (= (.getP ^datomic.impl.db.IDatum d) 0)
                  (update-in
                    ...
                    (fn fn__10664
                      ([p1__10663#]
                        (when p1__10663#
                          (assoc p1__10663# :kw (.getV ^datomic.impl.db.IDatum d))))))
                  db)]
   ...
   (fn install_vtype_hook
     ([_ db d check?]
       ...
       (let [id (.getV ^datomic.impl.db.IDatum d)
             map__10668 (datomic.db/get-entity db id :raw true)
             map__10668 (if (seq? map__10668)
                          (if (next map__10668)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__10668))
                            (if (seq map__10668) (first map__10668) {}))
                          map__10668)
             ent map__10668
             key (get map__10668 :db/ident)
             fressian_tag (get map__10668 :fressian/tag)]
   ...
   (fn attr_hook_attr_ids
     ([db]
       (into
         #{}
         (comp
           (map (fn fn__10674 ([p1__10673#] (.entid ^datomic.Database db p1__10673#))))
           (filter identity))
  ...
  (def tuple-attr-value-type
   (fn tuple_attr_value_type
     ([db attr_id]
       (let [attr (let [G__10679 (datomic.db/resolve-id db attr_id)]
                    (when-not (nil? G__10679) (datomic.db/attribute db G__10679)))
             type (let [G__10680 attr G__10680 (some-> G__10680 (.-vtypeid))]
                    (when-not (nil? G__10680) (.ident ^datomic.Database db G__10680)))]
         (when (and
  ...
  (defn tuple-install-errors
    ([db e]
      (let [type (get e :db/tupleType)
            ...
            temp__5804__auto__ (datomic.db/system-eid db :db.type/tuple)]
        (when temp__5804__auto__
          (let [TYPE_TUPLE temp__5804__auto__]
            (cond
     ...
     ([before after eid]
       (let [eafter (datomic.db/get-entity after eid :raw true)
             errors (reduce
                      ...
                      nil
                      (map
                        (fn fn__10706 ([p1__10702#] (.ident ^datomic.Database after p1__10702#)))
         ...
         (if (and before (datomic.db/installed-attribute? before eid))
           (let [ebefore (datomic.db/get-entity before eid :raw true)]
             (reduce
               ...
               errors
               (map
                 (fn fn__10712 ([p1__10703#] (.ident ^datomic.Database before p1__10703#)))
  ...
  (defn reserved-keyword?
    ([kw]
      (let [temp__5804__auto__ (namespace kw)]
        (when temp__5804__auto__
          (let [ns temp__5804__auto__] (or (= ns "db") (str/starts-with? ns "db.")))))))
  (reset-meta!
    #'reserved-keyword?
    (assoc
  ...
  (def create-attr-pred
   (fn create_attr_pred
     ([kw fn_names]
       (let [fn_map (into
                      {}
                      (map (fn fn__10721 ([name] [name (common/requiring-resolve! name)])))
                      fn_names)]
         (fn fn__10723
           ([e v idmap]
             (loop [seq_10724 (seq fn_map) chunk_10725 nil count_10726 0 i_10727 0]
               (if (< i_10727 count_10726)
                 (let [vec__10728 (.nth ^clojure.lang.Indexed chunk_10725 (unchecked-int i_10727))
                       name (nth vec__10728 (unchecked-int 0) nil)
                       pred (nth vec__10728 (unchecked-int 1) nil)]
                   ...
                   (recur seq_10724 chunk_10725 count_10726 (inc i_10727)))
                 (let [temp__5804__auto__ (seq seq_10724)]
                   (when temp__5804__auto__
                     (let [seq_10724 temp__5804__auto__]
                       (if (chunked-seq? seq_10724)
                         (let [c__6065__auto__ (chunk-first seq_10724)]
                           (recur
                             (chunk-rest seq_10724)
                             c__6065__auto__
                             (count c__6065__auto__)
                             0))
                         (let [vec__10731 (first seq_10724)
                               name (nth vec__10731 (unchecked-int 0) nil)
                               pred (nth vec__10731 (unchecked-int 1) nil)]
                           (let [result (^clojure.lang.IFn pred v)]
                             (when-not (true? result)
                               (throw
                                 (error/arg
  ...
  (def create-attribute
   (fn create_attribute
     ([db p__10738]
       (let [map__10739 p__10738
             map__10739 (if (seq? map__10739)
                          (if (next map__10739)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__10739))
                            (if (seq map__10739) (first map__10739) {}))
                          map__10739)
             cardinality (get map__10739 :cardinality)
             attrPreds (get map__10739 :attrPreds)
             unique (get map__10739 :unique)
             vtypeid (get map__10739 :vtypeid)
             index (get map__10739 :index)
             storageHasAVET (get map__10739 :storageHasAVET)
             tupleType (get map__10739 :tupleType)
             tupleTypes (get map__10739 :tupleTypes)
             fulltext (get map__10739 :fulltext)
             noHistory (get map__10739 :noHistory)
             isComponent (get map__10739 :isComponent)
             kw (get map__10739 :kw)
             needsAVET (get map__10739 :needsAVET)
             id (get map__10739 :id)
             tupleAttrs (get map__10739 :tupleAttrs)
   ...
   (fn add_constituents
     ([db comp_id constituents]
       (let [m (into
                 ...
                 constituents)]
         (update db :constituents (fn fn__10753 ([p1__10750#] (merge-with into p1__10750# m))))))))
  (reset-meta!
    #'add-constituents
    (assoc
  ...
  (def install-attribute-hook
   (fn install_attribute_hook
     ([before after d check?]
       ...
       (let [id (.getV ^datomic.impl.db.IDatum d)
             map__10756 (datomic.db/get-entity after id :raw true)
             map__10756 (if (seq? map__10756)
                          (if (next map__10756)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__10756))
                            (if (seq map__10756) (first map__10756) {}))
                          map__10756)
             ent map__10756
             cardinality (get map__10756 :db/cardinality)
             attrPreds (get map__10756 :db.attr/preds)
             unique (get map__10756 :db/unique)
             vtypeid (get map__10756 :db/valueType)
             index (get map__10756 :db/index)
             tupleType (get map__10756 :db/tupleType)
             tupleTypes (get map__10756 :db/tupleTypes)
             fulltext (get map__10756 :db/fulltext)
             noHistory (get map__10756 :db/noHistory)
             isComponent (get map__10756 :db/isComponent)
             kw (get map__10756 :db/ident)
             tupleAttrs (get map__10756 :db/tupleAttrs)
  ...
  (defn set-element-fields
    ([db aid & kvs]
      (update-in db [:elements aid] (fn fn__10772 ([p1__10771#] (apply assoc p1__10771# kvs))))))
  (reset-meta!
    #'set-element-fields
    (assoc
      ...
      (let [attr (datomic.db/attribute db aid)]
        (if (= 27 (.-vtypeid ^datomic.db.Attribute attr))
          ...
          (if (.hasAVET ^datomic.db.Attribute attr)
            (let [temp__5802__auto__ (datomic.db/unique-violator db aid)]
              (if temp__5802__auto__
                (let [problem temp__5802__auto__]
  ...
  (def data-needs-index?
   (fn data_needs_index_QMARK_
     ([db datoms]
       (reduce
         (fn fn__10801 ([x d] (if (datomic.db/t-needing-index-job db d) (reduced true) x)))
         false
         datoms))))
  (reset-meta!
    #'data-needs-index?
       ...
       (let [mdb (datomic.db/memory-db db)]
         (or
           ...
           (datomic.db/data-needs-index?
             db
             (remove
               (fn fn__10813 ([p1__10812#] (datomic.db/system-datom? db p1__10812#)))
         ...
         (filter
           ...
           (map
             ...
             (.datoms
               ...
               :aevt
               (object-array [(let [G__10818 type] (case G__10818 :excise 15 :schema 44))]))))))))
  (reset-meta!
    #'ts-needing-index
    (assoc
        ...
        (let [avet (into
                     ...
                     (iter/iter-seq
                       (iter/take-while
                         (fn fn__10823
                           ([p1__10822#]
                             (= aid (long (.getA ^datomic.impl.db.IDatum p1__10822#)))))
  ...
  (defn find-alter-fn
    ([db eid fid from to]
      (cond
        (= from to) (fn fn__10831 ([db _ _ _] [db nil]))
        (= fid (datomic.db/system-eid db :db.attr/preds)) (fn fn__10833
                                                            ([db aid _ preds]
                                                              (if
                                                                (= :disabled preds)
                                                                [(update-in
     ...
     ([before after d]
       (let [eid (.getV ^datomic.impl.db.IDatum d)
         ...
         (reduce
           (fn fn__10844
             ([p__10843 fid]
               (let [vec__10845 p__10843
                     db (nth vec__10845 (unchecked-int 0) nil)
                     prev_errors (nth vec__10845 (unchecked-int 1) nil)
                     ...
                     vec__10848 (^clojure.lang.IFn f db eid vbefore vafter)
                     db (nth vec__10848 (unchecked-int 0) nil)
                     errors (nth vec__10848 (unchecked-int 1) nil)]
  ...
  (def alter-attribute-hook
   (fn alter_attribute_hook
     ([before after d check?]
       ...
       (let [vec__10854 (datomic.db/alter-attribute before after d)
             db (nth vec__10854 (unchecked-int 0) nil)
             errors (nth vec__10854 (unchecked-int 1) nil)]
  ...
  (def system-tx-hook
   (fn system_tx_hook
     ([_ after d check?]
       (let [G__10859 (.getV ^datomic.impl.db.IDatum d)]
         (case G__10859 :schema (datomic.db/update-schema-level after) after)))))
  (reset-meta!
    #'system-tx-hook
    (assoc
  ...
  (def install-function-hook
   (fn install_function_hook
     ([_ db d check?]
       ...
       (let [id (.getV ^datomic.impl.db.IDatum d)
             map__10871 (datomic.db/get-entity db id :raw true)
             map__10871 (if (seq? map__10871)
                          (if (next map__10871)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__10871))
                            (if (seq map__10871) (first map__10871) {}))
                          map__10871)
             ent map__10871
             key (get map__10871 :db/ident)
             lang (get map__10871 :db/lang)
             code (get map__10871 :db/code)]
         (when check?
    ...
    (fn scan_aevt
      ([aevt attrid]
        (let [d (datomic.db/asserting-datum
          ...
          (iter/take-while
            (fn fn__10882
              ([p1__10881#] (= attrid (long (.getA ^datomic.impl.db.IDatum p1__10881#)))))
  ...
  (reset-meta!
    ...
    (assoc
      ...
      *ns*))
  (defn create-deduper
    ([] (let [dset (java.util.HashSet.)] (fn fn__10894 ([d] (.add ^java.util.HashSet dset d))))))
  (reset-meta!
    #'create-deduper
    (assoc
      {:private true, :arglists (clojure.core/list []), :column (int 1)}
            ...
            (if (= (.getT ^datomic.impl.db.IDatum d) 0)
              ...
              (let [a (.getA ^datomic.impl.db.IDatum d)]
                (if (or (= (long a) 13) (= (long a) 19))
                  false
                  (let [temp__5802__auto__ (datomic.db/dget
                    ...
                    (if temp__5802__auto__
                      (let [existing temp__5802__auto__]
                        (if (and
                              (zero?
                                (common/compare
                                  (.getV ^datomic.impl.db.IDatum d)
  ...
  (defn attrs-missing-hooks
    ([db datoms]
      (let [attr_hook_attr? (datomic.db/attr-hook-attr-ids db)
            ...
            G__10942 datoms
            vec__10943 G__10942
            seq__10944 (seq vec__10943)
            first__10945 (first seq__10944)
            seq__10944 (next seq__10944)
            map__10946 first__10945
            map__10946 (if (seq? map__10946)
                         (if (next map__10946)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__10946))
                           (if (seq map__10946) (first map__10946) {}))
                         map__10946)
            d map__10946
            a (get map__10946 :a)
            more seq__10944]
        (loop [eids eids G__10942 G__10942]
          (let [eids eids
                vec__10947 G__10942
                seq__10948 (seq vec__10947)
                first__10949 (first seq__10948)
                seq__10948 (next seq__10948)
                map__10950 first__10949
                map__10950 (if (seq? map__10950)
                             (if (next map__10950)
                               (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                                 (to-array map__10950))
                               (if (seq map__10950) (first map__10950) {}))
                             map__10950)
                d map__10950
                a (get map__10950 :a)
                more seq__10948]
  ...
  (defn new-ents-not-installed
    ([db datoms]
      (let [p (count (:elements db))
            ...
            G__10959 datoms
            vec__10960 G__10959
            seq__10961 (seq vec__10960)
            first__10962 (first seq__10961)
            seq__10961 (next seq__10961)
            d first__10962
            more seq__10961]
        (loop [eids eids G__10959 G__10959]
          (let [eids eids
                vec__10963 G__10959
                seq__10964 (seq vec__10963)
                first__10965 (first seq__10964)
                seq__10964 (next seq__10964)
                d first__10965
                more seq__10964]
            (if d
       ...
       (let [p0 (datomic.db/create-schema-validator db)
             ...
             result (filterv
                      (fn fn__10975
                        ([p1__10974#]
                          (and
                            (^clojure.lang.IFn p0 p1__10974#)
                            (^clojure.lang.IFn p1 p1__10974#)
                            (^clojure.lang.IFn p2 p1__10974#)
                            (^clojure.lang.IFn p3 p1__10974#)
                            (^clojure.lang.IFn p4 p1__10974#)
                            (^clojure.lang.IFn p5 p1__10974#))))
                      datoms)
             result (reduce
                      (fn fn__10982
                        ([result aid]
                   ...
                   {:datoms
                    (mapv
                      ...
                      (filterv
                        (fn fn__10985
                          ([p__10984]
                            (let [map__10986 p__10984
                                  map__10986 (if (seq? map__10986)
                                               (if (next map__10986)
                                                 (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                                                   (to-array map__10986))
                                                 (if (seq map__10986) (first map__10986) {}))
                                               map__10986)
                                  e (get map__10986 :e)]
                              (contains? es e))))
                        result))})))))
        ...
        (fn fn__11014
          ([p1__11013#]
            (let [idx (java.util.Collections/binarySearch
                        ^java.util.List p1__11013#
                        {:t t}
                        (common/key-comparator :t))]
              (into
                []
                (subvec p1__11013# (if (< idx 0) (long (- (inc idx))) (long (inc idx)))))))))))
  (reset-meta!
    #'trim-log
  ...
  (defn empty-tx-stat-registers
    ([]
      (persistent!
        (reduce
          (fn fn__11030 ([m n] (assoc! m n (java.util.concurrent.atomic.LongAdder.))))
          (transient {})
           ...
           (fn fn__11033
             ([m k adder]
               (assoc!
                 m
                 k
                 (let [G__11034 (.sum ^java.util.concurrent.atomic.LongAdder adder)]
                   (if (datomic.db/timing-key? k)
                     (java.lang.Double/valueOf (double (monitor/ns->ms G__11034)))
                     (long G__11034))))))
           (transient {})
           tx_stat_registers)))))
  (reset-meta!
         ...
         (concat
           ...
           (clojure.core/list
             (apply
               ...
               (seq
                 (concat
                   (clojure.core/list 'start__11038__auto__)
                   (clojure.core/list
                     (seq (concat (clojure.core/list 'java.lang.System/nanoTime))))
                   (clojure.core/list 'ret__11039__auto__)
  ...
  (defrecord
          ...
          (if data
            (let [d (first data)
                  ...
                  raet (if (and attr (= 20 (.-vtypeid ^datomic.db.Attribute attr)))
                         (conj raet d)
                         raet)
                  temp__5802__auto__ (and
                                       (.isAssertion ^datomic.impl.db.IDatum d)
                                       (datomic.db/get-hook
                                         (java.lang.Integer/valueOf (int attrid))))]
              (if temp__5802__auto__
                (let [hook temp__5802__auto__
                      dbval (assoc
                              db
                              :memidx
    ...
    (addData
      ...
      (let [basis nextT
            map__11098 tx_stat_registers
            map__11098 (if (seq? map__11098)
                         (if (next map__11098)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__11098))
                           (if (seq map__11098) (first map__11098) {}))
                         map__11098)
            dedup_tx_ms (get map__11098 :dedup-tx-ms)
            dedup_ct (get map__11098 :dedup-ct)
            dup_datoms (get map__11098 :dup-datoms)
            ucheck_ct (get map__11098 :ucheck-ct)
            ucheck_tx_ms (get map__11098 :ucheck-tx-ms)]
        (loop [db this
               next_t (inc basis)
               eavt (.-eavt ^datomic.db.IndexSet memidx)
               avet (.-avet ^datomic.db.IndexSet memidx)
            ...
            (let [d (first data)
                  ...
                  ed (and
                       ...
                       (do
                         ...
                         (let [start__11038__auto__ (java.lang.System/nanoTime)
                               ret__11039__auto__ (datomic.db/dget
                           ...
                           (datomic.db/long-add!
                             dedup_tx_ms
                             (- (java.lang.System/nanoTime) start__11038__auto__))
                           ret__11039__auto__)))
                  there? (and
                           ed
              ...
              (when (and
                ...
                (let [temp__5804__auto__ (let [start__11038__auto__ (java.lang.System/nanoTime)
                                               ret__11039__auto__ (datomic.db/dget
                                           ...
                                           ret__11039__auto__)]
                  (when temp__5804__auto__
                    (let [it temp__5804__auto__]
                      (when-not (some
                                  (fn fn__11099
                                    ([p1__11043#]
                                      (or
                                        (datomic.db/retracts? p1__11043# it)
                                        (and card_one? (datomic.db/updates-v? p1__11043# it)))))
                                  indata)
                        (error/state
    ...
    (addElement
      ...
      (let [id (.id ^datomic.db.IElementImpl e)
            _ (let [temp__5804__auto__ (get elements id)]
                (when temp__5804__auto__
                  (let [current temp__5804__auto__]
    ...
    (^clojure.lang.IFn getFn
      ...
      (if (datomic.db/user-proc? x)
        ...
        (let [fnid (datomic.db/require-id this x)
              temp__5802__auto__ (let [elem (.elementAt this (long fnid))]
                                   (when (instance? datomic.db.Function elem) elem))]
          (if temp__5802__auto__
            (let [func temp__5802__auto__] (.-f ^datomic.db.Function func))
            (let [temp__5802__auto__ (get (.entity this (long fnid)) :db/query)]
              (if temp__5802__auto__
                (let [q temp__5802__auto__] (Circular/constructFn q))
        ...
        (assoc
          ...
          (if filt
            (fn fn__11094
              ([p1__11041# p2__11042#]
                (and
                  (^clojure.lang.IFn filt p1__11041# p2__11042#)
                  (^clojure.lang.IFn pred p1__11041# p2__11042#))))
            pred))))
    (^datomic.Database history [this] (assoc this :raw true))
    (^java.lang.Iterable indexRange
      [this attrid start end]
      (iter/iterable (fn fn__11090 ([] (datomic.db/attr-index-range this attrid start end)))))
  ...
  (def ident-setting-datoms
   (fn ident_setting_datoms
     ([db index]
       (sort-by
         (fn fn__11198 ([p1__11197#] (long (.getTx ^datomic.impl.db.IDatum p1__11197#))))
         (iter/iter-seq
           (iter/take-while
             (fn fn__11200 ([p1__11196#] (= 10 (long (.getA ^datomic.impl.db.IDatum p1__11196#)))))
             (iter/filter
   ...
   (fn run_hooks
     ([db index]
       (let [fhooks (assoc (assoc datomic.db/hooks 19 datomic.db/install-attribute-hook) 10 nil)
             ret (reduce
                   (fn fn__11207 ([db datom] (datomic.db/key-hook nil db datom false)))
                   db
             ...
             ret (reduce
                   (fn fn__11210
                     ([db p__11209]
                       (let [vec__11211 p__11209
                             attrid (nth vec__11211 (unchecked-int 0) nil)
                             f (nth vec__11211 (unchecked-int 1) nil)]
                         (loop [db db
                                iter (iter/filter
                                       datomic.db/assertion?
                                       (iter/merge-iters
                   ...
                   (keep-indexed
                     (fn fn__11217
                       ([p1__11206# p2__11205#] (when p2__11205# [p1__11206# p2__11205#])))
                     fhooks))]
         ret))))
  (reset-meta!
    #'run-hooks
                               ...
                               (fn fn__11223
                                 ([p1__11220#]
                                   (and
                                     (=
                                       (long eid)
                                       (long (.getE ^datomic.impl.db.IDatum p1__11220#)))
                                     (= 50 (long (.getA ^datomic.impl.db.IDatum p1__11220#)))
                                     (=
                                       (long eid)
                                       (long (.getTx ^datomic.impl.db.IDatum p1__11220#))))))
                               G__11222))
                           (.get)))))
  ...
  (reset-meta!
    ...
    (assoc
      ...
      :ns
      *ns*))
  (defmethod print-method datomic.db.Db fn__11230 ([db w] (.write ^java.io.Writer w (str db)) nil))
  (defmethod print-dup datomic.db.Db fn__11232 ([o w] (print-method o w)))
  ...
  (def add-upgrade-data
   (fn add_upgrade_data
     ([db system_data]
       (let [map__11239 db
             map__11239 (if (seq? map__11239)
                          (if (next map__11239)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__11239))
                            (if (seq map__11239) (first map__11239) {}))
                          map__11239)
             basisT (get map__11239 :basisT)
             nextT (get map__11239 :nextT)
             epoch (java.util.Date. 0)]
         (assoc
           (reduce
             (fn fn__11241
               ([db p__11240]
                 (let [vec__11242 p__11240
                       k (nth vec__11242 (unchecked-int 0) nil)
                       data (nth vec__11242 (unchecked-int 1) nil)]
                   (if (let [G__11245 (datomic.db/resolve-id db k)]
                         (when-not (nil? G__11245) (.elementAt ^datomic.db.IDbImpl db G__11245)))
                     db
                     (:db-after
                       (.with
  ...
  (def db
   (fn db
     ([id p__11249]
       (let [map__11250 p__11249
             map__11250 (if (seq? map__11250)
                          (if (next map__11250)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__11250))
                            (if (seq map__11250) (first map__11250) {}))
                          map__11250)
             root_id (get map__11250 :root-id)
             birth_level (get map__11250 :birth-level)
             nextT (get map__11250 :nextT)
             mid_index (get map__11250 :mid-index)
             schema_level (get map__11250 :schema-level)
             index (get map__11250 :index)
             basisT (get map__11250 :basisT)
             history (get map__11250 :history)
             rev (get map__11250 :rev)]
  ...
  (def complete-indexing
   (fn complete_indexing
     ([db p__11258]
       (let [map__11259 p__11258
             map__11259 (if (seq? map__11259)
                          (if (next map__11259)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__11259))
                            (if (seq map__11259) (first map__11259) {}))
                          map__11259)
             new_index map__11259
             root_id (get map__11259 :root-id)
             index (get map__11259 :index)
             mid_index (get map__11259 :mid-index)
             history (get map__11259 :history)
             basisT (get map__11259 :basisT)
             nextT (get map__11259 :nextT)
             rev (get map__11259 :rev)]
  ...
  (def accept-index
   (fn accept_index
     ([db p__11263]
       (let [map__11264 p__11263
             map__11264 (if (seq? map__11264)
                          (if (next map__11264)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__11264))
                            (if (seq map__11264) (first map__11264) {}))
                          map__11264)
             root_id (get map__11264 :root-id)
             mid_index (get map__11264 :mid-index)
             index (get map__11264 :index)
             history (get map__11264 :history)
             basisT (get map__11264 :basisT)
             nextT (get map__11264 :nextT)
             rev (get map__11264 :rev)]
         ...
         (if (> rev (.-index-rev ^datomic.db.Db db))
           (let [m_11265 {:event :db/accept-index, :basis-t :basisT}
                 ___8583__auto__ (let [logger (org.slf4j.LoggerFactory/getLogger "datomic.db")]
                                   (when (.isInfoEnabled ^org.slf4j.Logger logger)
                                     (.info
                                       ^org.slf4j.Logger logger
                                       (logger/process (assoc m_11265 :phase :begin))))
                                   nil)
                                                          ...
                                                          ([p1__11262#]
                                                            (datomic.db/fulltext?
                                                              ...
                                                              (java.lang.Integer/valueOf
                                                                (int
                                                                  (.getA
                                                                    ^datomic.impl.db.IDatum p1__11262#))))))
                 ...
                 elapsed_11266 (- (java.lang.System/nanoTime) start__8584__auto__)
                 msec_11267 (logger/format-as-msec (long elapsed_11266))]
             (monitor/add-stat :AcceptIndexMsec msec_11267)
             (let [endmsg__8587__auto__ (merge
                                          (assoc m_11265 :msec msec_11267 :phase :end)
  ...
  (defn force-map-keywords
    ([db m]
      (if (every? (fn fn__11301 ([k] (or (number? k) (keyword? k)))) (keys m))
        m
        (reduce
          (fn fn__11305
            ([m p__11304]
              (let [vec__11306 p__11304
                    k (nth vec__11306 (unchecked-int 0) nil)
                    v (nth vec__11306 (unchecked-int 1) nil)
                    kw (cond
                         (integer? k) k
  ...
  (defn has-unique-id?
    ([db emap]
      (let [unique_id? (fn unique_id_QMARK_
                         ([p1__11316#] (= 38 (.-unique (datomic.db/require-attr db p1__11316#)))))]
        (some
          (fn fn__11320 ([p1__11317#] (^clojure.lang.IFn unique_id? p1__11317#)))
          (keys emap)))))
  (reset-meta!
    #'has-unique-id?
    (assoc
  ...
  (deftype
    ...
    (getPart
      ...
      (or
        (get id_>part id)
        (let [temp__5804__auto__ (get id_>match id)]
          (when temp__5804__auto__
            (let [nxt temp__5804__auto__]
              (loop [visited #{id} nxt nxt]
                (if (contains? visited nxt)
                  (error/arg :db.error/cycle-in-affinity {:e id})
                  (or
                    (get id_>part nxt)
                    (let [temp__5802__auto__ (get id_>match nxt)]
                      (if temp__5802__auto__
                        (let [nnxt temp__5802__auto__] (recur (conj visited nxt) nnxt))
                        (long
    ...
    (forcePart
      ...
      (when-not (datomic.db/reserved-partition?
                  (datomic.db/eid->part (unchecked-long ^java.lang.Number id)))
        (let [temp__5802__auto__ (get id_>part id)]
          (if temp__5802__auto__
            (let [existing temp__5802__auto__]
                             ...
                             (contains?
                               ...
                               (namespace
                                 (datomic.db/resolve-kw
                                   db
                                   (.getKey ^java.util.Map$Entry p1__11354#))))))]
         (reduce
           (fn fn__11358
             ([result p__11357]
               (let [vec__11359 p__11357
                     k (nth vec__11359 (unchecked-int 0) nil)
                     v (nth vec__11359 (unchecked-int 1) nil)
                     G__11362 k]
                 (case
                   G__11362
                   :db/match-partition
  ...
  (extend nil datomic.db/TupleElem {:tuple-elem? (fn fn__11389 ([_] true))})
  (extend java.lang.Object datomic.db/TupleElem {:tuple-elem? (fn fn__11391 ([_] false))})
  (extend
    java.math.BigInteger
    datomic.db/TupleElem
    {:tuple-elem? (fn fn__11393 ([v] (<= (.bitLength ^java.math.BigInteger v) 256)))})
  (extend java.lang.Double datomic.db/TupleElem {:tuple-elem? (fn fn__11395 ([_] true))})
  (extend java.util.Date datomic.db/TupleElem {:tuple-elem? (fn fn__11397 ([_] true))})
  (extend
    java.lang.String
    datomic.db/TupleElem
    {:tuple-elem? (fn fn__11399 ([s] (<= (.length ^java.lang.String s) 256)))})
  (extend java.util.UUID datomic.db/TupleElem {:tuple-elem? (fn fn__11401 ([_] true))})
  (extend java.lang.Boolean datomic.db/TupleElem {:tuple-elem? (fn fn__11403 ([_] true))})
  (extend java.net.URI datomic.db/TupleElem {:tuple-elem? (fn fn__11405 ([_] true))})
  (extend
    java.math.BigDecimal
    datomic.db/TupleElem
    {:tuple-elem? (fn fn__11407 ([v] (<= (.precision ^java.math.BigDecimal v) 256)))})
  (extend clojure.lang.Keyword datomic.db/TupleElem {:tuple-elem? (fn fn__11409 ([_] true))})
  (extend java.lang.Long datomic.db/TupleElem {:tuple-elem? (fn fn__11411 ([_] true))})
  (extend clojure.lang.Symbol datomic.db/TupleElem {:tuple-elem? (fn fn__11413 ([_] true))})
  (let [protocol_metadata__7431 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7431 :doc nil) :name 'CoerceV :ns *ns*))
  ...
  (extend nil datomic.db/CoerceV {:coerce-v (fn fn__11431 ([_] nil))})
  (extend java.lang.Object datomic.db/CoerceV {:coerce-v (fn fn__11433 ([_] nil))})
  (extend
    java.lang.Short
    datomic.db/CoerceV
    {:coerce-v (fn fn__11435 ([v] (long (.longValue ^java.lang.Short v))))})
  (extend
    java.lang.Integer
    datomic.db/CoerceV
    {:coerce-v (fn fn__11437 ([v] (long (.longValue ^java.lang.Integer v))))})
  (extend clojure.lang.BigInt datomic.db/CoerceV {:coerce-v (fn fn__11439 ([v] (biginteger v)))})
  (defn coerce-tuple
    ([tuple]
      (cond
        (some datomic.db/coerce-v tuple) (mapv
                                           (fn fn__11442
                                             ([p1__11441#]
                                               (or (datomic.db/coerce-v p1__11441#) p1__11441#)))
                                           tuple)
        (vector? tuple) tuple
         ...
         (cond
           ...
           (:tupleType attr) (let [kw (:tupleType attr)]
                               (and
                                 ...
                                 (every?
                                   (fn fn__11455
                                     ([p1__11446#] (^clojure.lang.IFn valid? kw p1__11446#)))
                                   tup)
                                  ...
                                  (and
                                    ...
                                    (every?
                                      ...
                                      (map
                                        (fn fn__11457
                                          ([p1__11447# p2__11448#]
                                            (^clojure.lang.IFn valid? p1__11447# p2__11448#)))
                                        kws
                                        tup))))))))))
  (reset-meta!
    #'valid-tuple-assert?
  ...
  (deftype
    ...
    (^datomic.db.IProcess inject
      ...
      (do
        (cond
          (instance? java.util.Map procargs) (loop [seq_11478 (seq
                                                    ...
                                                    count_11480 0
                                                    i_11481 0]
                                               (if (< i_11481 count_11480)
                                                 (let [x (.nth
                                                           ^clojure.lang.Indexed chunk_11479
                                                           (unchecked-int i_11481))]
                                                   ...
                                                   (recur
                                                     ...
                                                     count_11480
                                                     (inc i_11481)))
                                                 (let [temp__5804__auto__ (seq seq_11478)]
                                                   (when temp__5804__auto__
                                                     (let [seq_11478 temp__5804__auto__]
                                                       (if (chunked-seq? seq_11478)
                                                         (let [c__6065__auto__
                                                               (chunk-first seq_11478)]
                                                           (recur
                                                             (chunk-rest seq_11478)
                                                             c__6065__auto__
                                                             (count c__6065__auto__)
                                                             0))
                                                         (let [x (first seq_11478)]
                                                           (.inject
                                                             this
                                                             x
                                                             ^java.util.Map local_tempids)
                                                           (recur (next seq_11478) nil 0 0))))))))
  ...
  (defn default-partition
    ([db]
      (or
        (let [temp__5804__auto__ (.entid
                                   ^datomic.db.Db db
                                   (config/property "datomic.defaultPartition"))]
          (when temp__5804__auto__
            (let [p temp__5804__auto__] (when (datomic.db/explicit-partition db p) p))))
        4)))
  (reset-meta!
    #'default-partition
    (assoc
   ...
   (fn get_ids
     ([db data part_reqs]
       (let [default_part_ref (delay (datomic.db/default-partition db))
             genid (fn genid
                     ([e p__11498]
                       (let [vec__11500 p__11498
                             m (nth vec__11500 (unchecked-int 0) nil)
                             p (nth vec__11500 (unchecked-int 1) nil)
                             t (nth vec__11500 (unchecked-int 2) nil)
                             u (nth vec__11500 (unchecked-int 3) nil)
                             z (nth vec__11500 (unchecked-int 4) nil)
                             mpt vec__11500]
                         (if (contains? m e)
                           mpt
             ...
             vec__11493 (reduce
                          (fn fn__11505
                            ([p__11504 d]
                              (let [vec__11506 p__11504
                                    m (nth vec__11506 (unchecked-int 0) nil)
                                    p (nth vec__11506 (unchecked-int 1) nil)
                                    t (nth vec__11506 (unchecked-int 2) nil)
                                    u (nth vec__11506 (unchecked-int 3) nil)
                                    z (nth vec__11506 (unchecked-int 4) nil)
                                    mpt vec__11506
                          ...
                          [{}
                           ...
                           false]
                          data)
             m (nth vec__11493 (unchecked-int 0) nil)
             p (nth vec__11493 (unchecked-int 1) nil)
             t (nth vec__11493 (unchecked-int 2) nil)
             u (nth vec__11493 (unchecked-int 3) nil)
             z (nth vec__11493 (unchecked-int 4) nil)]
         [m z]))))
  (reset-meta!
    #'get-ids
    (assoc
  ...
  (let [protocol_metadata__7434 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7434 :doc nil) :name 'LocalDb :ns *ns*))
  ...
  (def create-composite
   (fn create_composite
     ([db eaop_map p__11545]
       (let [vec__11546 p__11545
             e (nth vec__11546 (unchecked-int 0) nil)
             a (nth vec__11546 (unchecked-int 1) nil)
          ...
          ([attr]
            (datomic.db/prefetch!
              ...
              (fn fn__11561
                ([]
                  (let [start__11038__auto__ (java.lang.System/nanoTime)
                        ret__11039__auto__ (datomic.db/ea->v db e attr)]
                    (datomic.db/long-add!
                      adder
                      (- (java.lang.System/nanoTime) start__11038__auto__))
                    ret__11039__auto__))))))
  ...
  (reset-meta!
    ...
    (assoc
      ...
      :ns
      *ns*))
  (defn for-side-effects ([proc] (map (fn fn__11567 ([x] (^clojure.lang.IFn proc x) x)))))
  (reset-meta!
    #'for-side-effects
    (assoc
               ...
               (when temp__5804__auto__
                 (let [composites temp__5804__auto__]
                   (run!
                     (fn fn__11572
                       ([p1__11570#]
                         (when (.add ^java.util.HashSet needed_eas [(long e) p1__11570#])
         ...
         (dotimes [i (count datoms)]
           (let [d (nth datoms (unchecked-int i))]
             ...
             (let [temp__5804__auto__ (get
               ...
               (when temp__5804__auto__
                 (let [composites temp__5804__auto__]
                   (loop [seq_11578 (seq composites) chunk_11579 nil count_11580 0 i_11581 0]
                     (if (< i_11581 count_11580)
                       (let [c (.nth ^clojure.lang.Indexed chunk_11579 (unchecked-int i_11581))]
                         (.add
                           ^java.util.HashSet needed_eas
                           [(long (.getE ^datomic.impl.db.IDatum d)) c])
                         (recur seq_11578 chunk_11579 count_11580 (inc i_11581)))
                       (let [temp__5804__auto__ (seq seq_11578)]
                         (when temp__5804__auto__
                           (let [seq_11578 temp__5804__auto__]
                             (if (chunked-seq? seq_11578)
                               (let [c__6065__auto__ (chunk-first seq_11578)]
                                 (recur
                                   (chunk-rest seq_11578)
                                   c__6065__auto__
                                   (count c__6065__auto__)
                                   0))
                               (let [c (first seq_11578)]
                                 (.add
                                   ^java.util.HashSet needed_eas
                                   [(long (.getE ^datomic.impl.db.IDatum d)) c])
                                 (recur (next seq_11578) nil 0 0)))))))))))))
         (datomic.db/long-add! (:comp-ct tx_stat_registers) (count needed_eas))
         (let [start__11038__auto__ (java.lang.System/nanoTime)
               ret__11039__auto__ (into
                                    []
                                    (keep
                                      (fn fn__11582
                                        ([p1__11577#]
                                          (datomic.db/create-composite db eaop_map p1__11577#))))
                                    needed_eas)]
           (datomic.db/long-add!
       ...
       (let [lid_>gid (set/map-invert gid_>lid)]
         (persistent!
           (reduce
             (fn fn__11592
               ([m p__11591]
                 (let [vec__11593 p__11591
                       lid (nth vec__11593 (unchecked-int 0) nil)
                       eid (nth vec__11593 (unchecked-int 1) nil)]
  ...
  (def prefetch-redundancy+uniqueness
   (fn prefetch_redundancy_PLUS_uniqueness
     ([dispatcher tx_stat_registers db datoms]
       (let [basis (:nextT db)
             map__11601 tx_stat_registers
             map__11601 (if (seq? map__11601)
                          (if (next map__11601)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__11601))
                            (if (seq map__11601) (first map__11601) {}))
                          map__11601)
             redundancy (get map__11601 :dedup-pf-ms)
             uniqueness (get map__11601 :ucheck-pf-ms)]
         (run!
           (fn fn__11602
             ([d]
               (datomic.db/prefetch!
         ...
         (fn fn__11616
           ([]
             (when (datomic.db/tempid? (unchecked-long ^java.lang.Number e))
               (let [start__11038__auto__ (java.lang.System/nanoTime)
                     ret__11039__auto__ (datomic.db/dget (datomic.db/find-avet db a v))]
                 (datomic.db/long-add!
  ...
  (deftype
    ...
    (getData
      [this local_tempids]
      (let [vec__11627 (let [start__11038__auto__ (java.lang.System/nanoTime)
                             ret__11039__auto__ (datomic.db/get-ids db arraylist part_reqs)]
                         (datomic.db/long-add!
                           (:res-tx-ms tx_stat_registers)
                           (- (java.lang.System/nanoTime) start__11038__auto__))
                         ret__11039__auto__)
            ids (nth vec__11627 (unchecked-int 0) nil)
            check_installs? (nth vec__11627 (unchecked-int 1) nil)
            ...
            datoms (into
                     ...
                     (comp
                       ...
                       (remove
                         (fn fn__11649
                           ([p1__11623#] (datomic.db/datom-tuple-attrs db p1__11623#))))
            ...
            datoms (datomic.db/add-tempids-to-errors
                     ...
                     (fn fn__11653 ([] (datomic.db/calc-tempids local_tempids ids))))]
        ...
        (let [procid (datomic.db/resolve-procid db (nth procargs (unchecked-int 0)))]
          (if (or (= 1 procid) (= 2 procid))
            ...
            (let [pfn (.getFn ^datomic.db.Db db procid)
                  ...
                  data (let [start__11038__auto__ (java.lang.System/nanoTime)
                             ret__11039__auto__ (apply pfn db (rest procargs))]
                         (datomic.db/long-add!
  ...
  (let [v__6812__auto__ #'datomic.db/default-prefetch-executor]
        ...
        (delay
          (when (config/property "datomic.prefetchProbes")
            (let [name "probes"
                  ...
                  G__11666 (java.util.concurrent.ThreadPoolExecutor.
              ...
              (.allowCoreThreadTimeOut
                ^java.util.concurrent.ThreadPoolExecutor G__11666
                (boolean (.booleanValue true)))
              G__11666))))
      #'datomic.db/default-prefetch-executor))
  (defn get-prefetch-dispatcher
    ([]
      (let [temp__5802__auto__ (deref datomic.db/default-prefetch-executor)]
        (if temp__5802__auto__
          (let [exec temp__5802__auto__
  ...
  (defn add-fulltext
    ([db data]
      (let [m_11680 {:event :db/add-fulltext}
            ___8583__auto__ (let [logger (org.slf4j.LoggerFactory/getLogger "datomic.db")]
                              (when (.isDebugEnabled ^org.slf4j.Logger logger)
                                (.debug
                                  ^org.slf4j.Logger logger
                                  (logger/process (assoc m_11680 :phase :begin))))
                              nil)
            start__8584__auto__ (java.lang.System/nanoTime)
            result__8585__auto__ (try
                                   {:returned
                                                ...
                                                ([p1__11679#]
                                                  (datomic.db/fulltext?
                                                    ...
                                                    (java.lang.Integer/valueOf
                                                      (int
                                                        (.getA
                                                          ^datomic.impl.db.IDatum p1__11679#))))))
                                              data)))))}
                                   (catch
                                     java.lang.Throwable
                                     t__8586__auto__
                                     {:threw t__8586__auto__}))
            elapsed_11681 (- (java.lang.System/nanoTime) start__8584__auto__)
            msec_11682 (logger/format-as-msec (long elapsed_11681))]
        (monitor/add-stat :DbAddFulltextMsec msec_11682)
        (let [endmsg__8587__auto__ (merge
                                     (assoc m_11680 :msec msec_11682 :phase :end)
                                     (when (:threw result__8585__auto__)
                                       {:threw (class (:threw result__8585__auto__))}))
              logger (org.slf4j.LoggerFactory/getLogger "datomic.db")]
          (when (.isDebugEnabled ^org.slf4j.Logger logger)
  ...
  (reset-meta!
    ...
    (assoc
      ...
      *ns*))
  (defn missing-attrs
    ([entity required] (remove (fn fn__11696 ([p1__11695#] (find entity p1__11695#))) required)))
  (reset-meta!
    #'missing-attrs
    (assoc
   ...
   (fn ensure_entity_BANG_
     ([db_before db_after e spec idmap]
       (let [spec_ent (.entity ^datomic.Database db_before spec)
         ...
         (when (seq preds)
           (loop [seq_11699 (seq preds) chunk_11700 nil count_11701 0 i_11702 0]
             (if (< i_11702 count_11701)
               (let [pred (.nth ^clojure.lang.Indexed chunk_11700 (unchecked-int i_11702))]
                 (datomic.db/ensure-pred pred db_after e spec idmap)
                 (recur seq_11699 chunk_11700 count_11701 (inc i_11702)))
               (let [temp__5804__auto__ (seq seq_11699)]
                 (when temp__5804__auto__
                   (let [seq_11699 temp__5804__auto__]
                     (if (chunked-seq? seq_11699)
                       (let [c__6065__auto__ (chunk-first seq_11699)]
                         (recur (chunk-rest seq_11699) c__6065__auto__ (count c__6065__auto__) 0))
                       (let [pred (first seq_11699)]
                         (datomic.db/ensure-pred pred db_after e spec idmap)
                         (recur (next seq_11699) nil 0 0)))))))))))))
  (reset-meta!
    #'ensure-entity!
    (assoc
      {:arglists
  ...
  (def ensure-tx
   (fn ensure_tx
     ([db_before db_after data idmap]
       (loop [seq_11706 (seq data) chunk_11707 nil count_11708 0 i_11709 0]
         (if (< i_11709 count_11708)
           (let [d (.nth ^clojure.lang.Indexed chunk_11707 (unchecked-int i_11709))]
             (cond
                                                            ...
                                                            (when
                                                              ...
                                                              (let 
                                                                ...
                                                                (^clojure.lang.IFn pred
                                                                  ...
                                                                  (.getV ^datomic.impl.db.IDatum d)
                                                                  idmap))))))
             (recur seq_11706 chunk_11707 count_11708 (inc i_11709)))
           (let [temp__5804__auto__ (seq seq_11706)]
             (when temp__5804__auto__
               (let [seq_11706 temp__5804__auto__]
                 (if (chunked-seq? seq_11706)
                   (let [c__6065__auto__ (chunk-first seq_11706)]
                     (recur (chunk-rest seq_11706) c__6065__auto__ (count c__6065__auto__) 0))
                   (let [d (first seq_11706)]
                     (cond
                       (datomic.db/ensure-datom? db_before d) (datomic.db/ensure-entity!
                                                                db_before
                                                                db_after
   ...
   (fn add_ensured_data
     ([db_before data added idmap tx_stat_registers]
       (let [db_after (.addData
                        ...
                        (remove
                          (fn fn__11718
                            ([p1__11717#] (datomic.db/ensure-datom? db_before p1__11717#)))
                          data)
  ...
  (defn with-tx
    ([db dispatcher txdata]
      (let [added (java.util.ArrayList.)
        ...
        (let [vec__11727 (.getData ^datomic.db.IProcessExpander pe local_tempids)
              data (nth vec__11727 (unchecked-int 0) nil)
              idmap (nth vec__11727 (unchecked-int 1) nil)
  ...
  (def with-tx+opts
   (fn with_tx_PLUS_opts
     ([db txdata p__11731]
       (let [map__11732 p__11731
             map__11732 (if (seq? map__11732)
                          (if (next map__11732)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__11732))
                            (if (seq map__11732) (first map__11732) {}))
                          map__11732)
             return_hints (get map__11732 :return-hints)
             io_context (get map__11732 :io-context)
             f (fn f ([] (datomic.db/with-tx db (datomic.db/get-prefetch-dispatcher) txdata)))
             f (if return_hints
                 (fn fn__11735
                   ([]
                     (let [vec__11736 (io-trace/tracing-keys f)
                           ret (nth vec__11736 (unchecked-int 0) nil)
                           segments (nth vec__11736 (unchecked-int 1) nil)]
             ...
             ret (if (or return_hints io_context)
                   (let [ctx {:io-context (or io_context :datomic.db/trace), :api :with}
                         map__11740 (io-stats/throw-if-ex! (io-stats/with-io-stats f ctx))
                         map__11740 (if (seq? map__11740)
                                      (if (next map__11740)
                                        (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                                          (to-array map__11740))
                                        (if (seq map__11740) (first map__11740) {}))
                                      map__11740)
                         ret (get map__11740 :ret)
                         io_stats (get map__11740 :io-stats)]
      ...
      (concat
        ...
        (clojure.core/list
          (apply
            ...
            (seq
              (concat
                (clojure.core/list 'db__11744__auto__)
                (clojure.core/list 'm__11745__auto__)))))
        (clojure.core/list
          (seq
            (concat
              (clojure.core/list 'clojure.core/let)
                    ...
                    (concat
                      (clojure.core/list
                        (apply
                          ...
                          (seq
                            (concat
                              (clojure.core/list 'key__11746__auto__)
                              (clojure.core/list :db/ident)
                              (clojure.core/list 'lang__11747__auto__)
                              (clojure.core/list :db/lang)
                              (clojure.core/list 'code__11748__auto__)
                              (clojure.core/list :db/code)))))
                      (clojure.core/list 'm__11745__auto__)
                      (clojure.core/list 'id__11749__auto__)
                      (clojure.core/list
                        (seq
                          (concat
  ...
  (.bindRoot
    ...
    [datomic.db/system-data-fns
     ...
     (map
       (fn fn__11751
         ([p__11750]
           (let [vec__11752 p__11750
                 k (nth vec__11752 (unchecked-int 0) nil)
                 v (nth vec__11752 (unchecked-int 1) nil)]
             [:db/add k :db/doc v])))
       datomic.db/db-docs)
  ...
  (defn tx-data-for-latest-schema-level
    ([db]
      (map
        (fn fn__11757 ([p1__11756#] (conj p1__11756# #:db{:id "datomic.tx", :system-tx :schema})))
  ...
  (defn on-schema-level
    ([db level]
      (let [temp__5802__auto__ (get datomic.db/schema-level-fns level)]
        (if temp__5802__auto__ (let [f temp__5802__auto__] (^clojure.lang.IFn f db)) db))))
  (reset-meta!
    #'on-schema-level
    (assoc
  ...
  (defn init-db
    ([id]
      ...
      (let [assert_kw (fn assert_kw
                        ([p__11763]
                          (let [vec__11765 p__11763
                                k (nth vec__11765 (unchecked-int 0) nil)
                                id (nth vec__11765 (unchecked-int 1) nil)]
                            (datomic.db/asserting-datum
   ...
   (fn bootstrap_db_STAR_
     ([id]
       (let [db (datomic.db/init-db id)
             ad (fn ad
                  ([p__11772]
                    (let [vec__11774 p__11772
                          e (nth vec__11774 (unchecked-int 0) nil)
                          a (nth vec__11774 (unchecked-int 1) nil)
                          v (nth vec__11774 (unchecked-int 2) nil)]
                      (datomic.db/asserting-datum
