(do
  ...
  (def lookup-transformer
   (fn lookup_transformer
     ([m & p__11877]
       (let [map__11878 p__11877
             map__11878 (if (seq? map__11878)
                          (if (next map__11878)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__11878))
                            (if (seq map__11878) (first map__11878) {}))
                          map__11878)
             key_fn (get map__11878 :key-fn identity)
             val_fn (get map__11878 :val-fn identity)
     ...
     ([m & p__11884]
       (let [map__11885 p__11884
             map__11885 (if (seq? map__11885)
                          ...
                          map__11885)
             key_fn (get map__11885 :key-fn identity)
             val_fn (get map__11885 :val-fn identity)
             try_val_fn (fn try_val_fn
                          ([raw k not_found]
                            (try
  ...
  (def repairing-cache-stack
   (fn repairing_cache_stack
     ([p__11906]
       (let [map__11907 p__11906
             map__11907 (if (seq? map__11907)
                          (if (next map__11907)
                            (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                              (to-array map__11907))
                            (if (seq map__11907) (first map__11907) {}))
                          map__11907)
             cache_1 (get map__11907 :cache-1)
             cache_2 (get map__11907 :cache-2)
             close_cache_1? (get map__11907 :close-cache-1? true)
             close_cache_2? (get map__11907 :close-cache-2? true)
             on_repair (get map__11907 :on-repair)]
         (reify
           datomic.cache.impl.CachePut
           clojure.lang.ILookup
