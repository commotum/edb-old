(do
  ...
  (deftype
    ...
    (put
      [this v_map]
      (when (let [map__16666 v_map
                  map__16666 (if (seq? map__16666)
                               (if (next map__16666)
                                 (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                                   (to-array map__16666))
                                 (if (seq map__16666) (first map__16666) {}))
                               map__16666)
                  id (clojure.core/get map__16666 :id)
                  rev (clojure.core/get map__16666 :rev)
                  v (clojure.core/get map__16666 :v)
                  ensure (clojure.core/get map__16666 :ensure)
