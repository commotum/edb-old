(do
                                                  ...
                                                  (if data
                                                    (let [d (first data)
                                                          ...
                                                          last_d (nth
                                                                   ...
                                                                   (unchecked-int 3)
                                                                   nil)
                                                          td (nth vec__13410 (unchecked-int 4) nil)
  ...
  (def index-parallelism (atom 1 :validator (fn fn__13488 ([p1__13487#] (<= 1 p1__13487#)))))
  (defn serialize-dir
    ([des]
      [(:key (first des))
       (datomic.index/fress
      ...
      (try
        (let [pario (config/property "datomic.indexIOParallelism")
              ...
              excise? (fn excise_QMARK_
                        ([d] (some (fn fn__13532 ([p1__13515#] (x/remove? p1__13515# d))) xpreds)))
                    ...
                    (let [vec__13695 p__13693
                      ...
                      (if root_id
                        (let [m_13698 {:event :index/drop-avets,
                              ...
                              result__8585__auto__ (try
                                                     {:returned
                                                      (let [vec__13702
                                                            ...
                                                            garbage
                                                            (nth vec__13702 (unchecked-int 1) nil)]
                          ...
                          (let [endmsg__8587__auto__ (merge
                                                       (assoc m_13698 :msec msec_13700 :phase :end)
                                       ...
                                       (let [TI (*
                                         ...
                                         (if (neg? S)
                                           ...
                                           (let [size (long (/ S datomic.index/BYTES_PER_SEG))
                                                 ...
                                                 main_offset (nth vec__13875 (unchecked-int 2) nil)
                                                 slice_segids (take
                                                                (long n_segs)
                                                                (map
                                                                  :seg
                           ...
                           (let [pario (config/property "datomic.indexIOParallelism")
                                 cstore (if pario
                                          (cluster/queueing-writer
                                            ...
                                            (fn fn__13929
                                              ([p1__13812#]
                                                (monitor/add-stat :IndexIOQueueCount p1__13812#))))
                                          cstore)
                                 ret (atom
