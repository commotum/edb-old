(do
  ...
  (deftype
    ...
    (put
      [this p__33010]
      (let [map__33012 p__33010
            map__33012 (if (seq? map__33012)
                         (if (next map__33012)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__33012))
                           (if (seq map__33012) (first map__33012) {}))
                         map__33012)
            v_map map__33012
            id (clojure.core/get map__33012 :id)
            rev (clojure.core/get map__33012 :rev)
            v (clojure.core/get map__33012 :v)
            ensure (clojure.core/get map__33012 :ensure)]
  ...
  (defn kv-cassandra
    ([endpoint]
      (let [map__33022 endpoint
            map__33022 (if (seq? map__33022)
                         (if (next map__33022)
                           (clojure.lang.PersistentArrayMap/createAsIfByAssoc
                             (to-array map__33022))
                           (if (seq map__33022) (first map__33022) {}))
                         map__33022)
            host (clojure.core/get map__33022 :host)
            table (clojure.core/get map__33022 :table)
            provided_session (clojure.core/get map__33022 :session)
