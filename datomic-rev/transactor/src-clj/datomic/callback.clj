    ...
    ([sym]
      (let [temp__5802__auto__ (re-matches #"(.*)\.(.*)" (str sym))]
        (if temp__5802__auto__
          (let [vec__25766 temp__5802__auto__
                _ (nth vec__25766 (int 0) nil)
                cname (nth vec__25766 (int 1) nil)
                mname (nth vec__25766 (int 2) nil)
                  ...
                  (eval
                    (seq
                      (concat
                        ...
                        (clojure.core/list
                          (apply vector (seq (concat (clojure.core/list 'x__25765__auto__)))))
                        (-> (symbol cname mname)
                         (clojure.core/list)
                         (concat (clojure.core/list 'x__25765__auto__))
                         (seq)
                         (clojure.core/list)))))
