    ...
    ([x]
      (let [_ (println "sorted-set")
        ...
        (when-not (every?
                    (fn fn__9771
                      ([p1__9762#]
                        (let [x (seek bt p1__9762#)]
                          (and x (= (.get ^datomic.iter.Iter x) p1__9762#)))))
                    ss)
          (throw
            (java.lang.AssertionError.
              (str
                ...
                (pr-str
                  (clojure.core/list
                    ...
                    (clojure.core/list
                      ...
                      (clojure.core/list
                        'let
                        ['x (clojure.core/list 'seek 'bt 'p1__9762#)]
                        (clojure.core/list
                          'and
                          'x
                          (clojure.core/list '= (clojure.core/list '.get 'x) 'p1__9762#))))
                    'ss))))))
        (when-not (every?
                    (fn fn__9774
                      ([p1__9763#]
                        (let [x (rseek bt p1__9763#)]
                          (and x (= (.get ^datomic.iter.Iter x) p1__9763#)))))
                    ss)
          (throw
            (java.lang.AssertionError.
              (str
                ...
                (pr-str
                  (clojure.core/list
                    ...
                    (clojure.core/list
                      ...
                      (clojure.core/list
                        'let
                        ['x (clojure.core/list 'rseek 'bt 'p1__9763#)]
                        (clojure.core/list
                          'and
                          'x
                          (clojure.core/list '= (clojure.core/list '.get 'x) 'p1__9763#))))
                    'ss))))))
        (when-not (every? (fn fn__9777 ([p1__9764#] (contains? bt p1__9764#))) ss)
          (throw
            (java.lang.AssertionError.
              (str
                "Assert failed: "
                (pr-str
                  (clojure.core/list
                    ...
                    (clojure.core/list
                      'fn*
                      ['p1__9764#]
                      (clojure.core/list 'contains? 'bt 'p1__9764#))
                    'ss))))))
