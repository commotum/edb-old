(do
  ...
  (let [protocol_metadata__7420 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7420 :doc nil) :name 'IJoin :ns *ns*))
  ...
  (let [protocol_metadata__7425 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7425 :doc nil) :name 'ExtRel :ns *ns*))
     ...
     ([db srcs prog oprog clause predctor inrel inbinds next_binds sched_fn src ans ins top_bounds]
       ...
       (if (not-join-clause? clause)
         ...
         (let [exf (and (map? clause) (:binds clause))
               ...
               starts (mapv
                        (fn fn__14927
                          ([p1__14919#] (some-> top_bounds (:starts) (get p1__14919#))))
                        args)
               whiles (mapv
                        (fn fn__14930
                          ([p1__14920#] (some-> top_bounds (:whiles) (get p1__14920#))))
                        args)
