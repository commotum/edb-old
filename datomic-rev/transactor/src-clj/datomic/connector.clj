(do
  ...
  (let [protocol_metadata__7420 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7420 :doc nil) :name 'Startable :ns *ns*))
  ...
  (let [protocol_metadata__7423 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7423 :doc nil) :name 'NotificationHandler :ns *ns*))
  ...
  (let [protocol_metadata__7434 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7434 :doc nil) :name 'TransactorConnector :ns *ns*))
    ...
    (when-not (and
      ...
      (.bindRoot
        ...
        (clojure.lang.MultiFn.
          "notify"
          (fn fn__18722 ([m conn] (tx/peer-message-type m)))
          :default
