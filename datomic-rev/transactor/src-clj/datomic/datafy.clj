    ...
    ([m]
      (persistent!
        (reduce
          ...
          (transient {})
          m))))
  (defmulti data-to-object (fn fn__19379 ([obj type] [(data/equality-partition obj) type])))
  (defmethod
    data-to-object
      ...
      (try
        ...
        (catch
          ...
          (do
            ...
            nil)))))
  (defmulti property-to-object (fn fn__19401 ([container prop obj type] [container prop])))
  (defmethod
    property-to-object
    :default
    fn__19406
