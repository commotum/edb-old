(do
  ...
  (let [protocol_metadata__7420 {:column (int 1)}]
    ...
    (reset-meta!
      ...
      (assoc (assoc protocol_metadata__7420 :doc nil) :name 'Summary :ns *ns*))
  ...
  (extend nil Summary {:summary (fn fn__17809 ([_] nil))})
  (extend java.util.Map Summary {:summary (fn fn__17811 ([m] m))})
