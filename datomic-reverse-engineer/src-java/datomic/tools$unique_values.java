...
import datomic.tools$unique_values$fn__21826;
import datomic.tools$unique_values$fn__21828;

public final class tools$unique_values
extends AFunction {
    ...
    public static Object invokeStatic(Object db2) {
        tools$unique_values$fn__21828 tools$unique_values$fn__21828 = new tools$unique_values$fn__21828(db2);
        Object object = db2;
        db2 = null;
        return ((IFn)const__0.getRawRoot()).invoke((Object)const__1, ((IFn)const__2.getRawRoot()).invoke((Object)new tools$unique_values$fn__21826(), ((IFn)const__3.getRawRoot()).invoke((Object)tools$unique_values$fn__21828, ((IFn)const__4.getRawRoot()).invoke(object, (Object)const__5, (Object)const__6))));
    }

    public Object invoke(Object object) {
        Object object2 = object;
        object = null;
        return tools$unique_values.invokeStatic(object2);
    }
}
