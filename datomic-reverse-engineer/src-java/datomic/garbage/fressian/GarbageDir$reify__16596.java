...
public final class GarbageDir$reify__16596
...
IObj {
    ...
    public GarbageDir$reify__16596(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public GarbageDir$reify__16596(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new GarbageDir$reify__16596(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical((Object)((IFn)const__1.getRawRoot()).invoke(gtarget), (Object)this.gclass)) {
            ...
            gtarget = null;
            object = ((GarbageDir)object2).children;
        } else {
            object = this;
        }
        return object;
