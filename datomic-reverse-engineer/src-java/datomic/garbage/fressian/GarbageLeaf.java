...
import datomic.garbage.fressian.GarbageLeaf$reify__16617;
...
public final class GarbageLeaf
implements IRecord,
IHashEq,
IObj,
ILookup,
...
Serializable {
    ...
    public GarbageLeaf(Object object, Object object2, Object object3, int n, int n2) {
    ...
    public GarbageLeaf(Object object) {
        this(object, null, null, 0, 0);
    }

    public GarbageLeaf(Object object, Object object2, Object object3) {
    ...
    public static GarbageLeaf create(IPersistentMap iPersistentMap) {
        ...
        return new GarbageLeaf(object, null, RT.seqOrElse((Object)iPersistentMap), 0, 0);
    }
    ...
    public int hasheq() {
        void v0;
        int hq__7465__auto__16622 = this.__hasheq;
        if ((long)hq__7465__auto__16622 == 0L) {
            void var2_2;
            int h__7466__auto__16621;
            this.__hasheq = h__7466__auto__16621 = RT.intCast((long)(0x21757316L ^ (long)APersistentMap.mapHasheq((IPersistentMap)this)));
            v0 = var2_2;
        } else {
            void var1_1;
            v0 = var1_1;
    ...
    public int hashCode() {
        void v0;
        int hash__7468__auto__16624 = this.__hash;
        if ((long)hash__7468__auto__16624 == 0L) {
            void var2_2;
            int h__7469__auto__16623;
            this.__hash = h__7469__auto__16623 = APersistentMap.mapHash((IPersistentMap)this);
            v0 = var2_2;
        } else {
            void var1_1;
            v0 = var1_1;
    ...
    public boolean equals(Object G__16612) {
        Object object = G__16612;
        G__16612 = null;
    ...
    public IObj withMeta(IPersistentMap G__16612) {
        IPersistentMap iPersistentMap = G__16612;
        G__16612 = null;
        return new GarbageLeaf(this.children, iPersistentMap, this.__extmap, this.__hash, this.__hasheq);
    }
    ...
    public Object valAt(Object k__7476__auto__, Object else__7477__auto__) {
        Object object;
        Object G__16619 = k__7476__auto__;
        switch (Util.hash((Object)G__16619)) {
            case -1315223872: {
                if (G__16619 == const__8) {
    ...
    public ILookupThunk getLookupThunk(Keyword k__7479__auto__) {
        GarbageLeaf$reify__16617 garbageLeaf$reify__16617;
        Object gclass = ((IFn)const__20.getRawRoot()).invoke((Object)this);
        Keyword keyword = k__7479__auto__;
        k__7479__auto__ = null;
        Keyword G__16616 = keyword;
        switch (Util.hash((Object)G__16616)) {
            case -1315223872: {
                if (G__16616 == const__8) {
                    gclass = null;
                    garbageLeaf$reify__16617 = new GarbageLeaf$reify__16617(null, gclass);
                    break;
                }
            }
            default: {
                garbageLeaf$reify__16617 = null;
            }
        }
        return garbageLeaf$reify__16617;
    }
    ...
    public IPersistentCollection empty() {
        throw (Throwable)new UnsupportedOperationException((String)((IFn)const__22.getRawRoot()).invoke((Object)"Can't create empty: ", (Object)"datomic.garbage.fressian.GarbageLeaf"));
    }

    public IPersistentCollection cons(Object e__7483__auto__) {
        GarbageLeaf garbageLeaf = this_;
        Object object = e__7483__auto__;
        e__7483__auto__ = null;
        GarbageLeaf this_ = null;
        return (IPersistentCollection)((IFn)const__21).invoke((Object)garbageLeaf, object);
    }

    public boolean equiv(Object G__16612) {
        Boolean bl;
        boolean or__5238__auto__16626 = Util.identical((Object)this, (Object)G__16612);
        if (or__5238__auto__16626) {
            bl = or__5238__auto__16626 ? Boolean.TRUE : Boolean.FALSE;
        } else if (Util.identical((Object)((IFn)const__20.getRawRoot()).invoke((Object)this), (Object)((IFn)const__20.getRawRoot()).invoke(G__16612))) {
            Object object = G__16612;
            G__16612 = null;
            Object G__166122 = object;
            boolean and__5236__auto__16625 = Util.equiv((Object)this.children, (Object)((GarbageLeaf)G__166122).children);
            if (and__5236__auto__16625) {
                Object object2 = G__166122;
                G__166122 = null;
                bl = Util.equiv((Object)this.__extmap, (Object)((GarbageLeaf)object2).__extmap) ? Boolean.TRUE : Boolean.FALSE;
            } else {
                bl = and__5236__auto__16625 ? Boolean.TRUE : Boolean.FALSE;
            }
        } else {
            bl = null;
        }
    ...
    public IMapEntry entryAt(Object k__7488__auto__) {
        MapEntry mapEntry;
        Object v__7489__auto__16627 = ((ILookup)this_).valAt(k__7488__auto__, (Object)this_);
        if (Util.identical((Object)this_, (Object)v__7489__auto__16627)) {
            mapEntry = null;
        } else {
            Object object = k__7488__auto__;
            k__7488__auto__ = null;
            Object object2 = v__7489__auto__16627;
            v__7489__auto__16627 = null;
            GarbageLeaf this_ = null;
    ...
    public IPersistentMap assoc(Object k__7493__auto__, Object G__16612) {
        GarbageLeaf garbageLeaf;
        Object pred__16614 = const__14.getRawRoot();
        Object expr__16615 = k__7493__auto__;
        Object object = pred__16614;
        pred__16614 = null;
        Object object2 = expr__16615;
        expr__16615 = null;
        Object object3 = ((IFn)object).invoke((Object)const__8, object2);
        if (object3 != null && object3 != Boolean.FALSE) {
            G__16612 = null;
            garbageLeaf = new GarbageLeaf(G__16612, this.__meta, this.__extmap);
        } else {
            k__7493__auto__ = null;
            G__16612 = null;
            garbageLeaf = new GarbageLeaf(this.children, this.__meta, ((IFn)const__15.getRawRoot()).invoke(this.__extmap, k__7493__auto__, G__16612));
        }
        return garbageLeaf;
    }
    ...
    public IPersistentMap without(Object k__7495__auto__) {
        ...
        if (object2 != null && object2 != Boolean.FALSE) {
            ...
            k__7495__auto__ = null;
            object = new GarbageLeaf(this_.children, this_.__meta, ((IFn)const__13.getRawRoot()).invoke(((IFn)const__10.getRawRoot()).invoke(this_.__extmap, k__7495__auto__)));
        }
    ...
    public Collection values() {
        GarbageLeaf garbageLeaf = this_;
        GarbageLeaf this_ = null;
        return (Collection)((IFn)const__1.getRawRoot()).invoke((Object)garbageLeaf);
    }

    public Set entrySet() {
        GarbageLeaf garbageLeaf = this_;
        GarbageLeaf this_ = null;
        return (Set)((IFn)const__0.getRawRoot()).invoke((Object)garbageLeaf);
    }
}
