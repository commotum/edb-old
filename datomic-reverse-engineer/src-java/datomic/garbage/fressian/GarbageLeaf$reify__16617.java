...
public final class GarbageLeaf$reify__16617
...
IObj {
    ...
    public GarbageLeaf$reify__16617(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public GarbageLeaf$reify__16617(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new GarbageLeaf$reify__16617(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical((Object)((IFn)const__1.getRawRoot()).invoke(gtarget), (Object)this.gclass)) {
            ...
            gtarget = null;
            object = ((GarbageLeaf)object2).children;
        } else {
            object = this;
        }
        return object;
