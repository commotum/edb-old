...
public final class peer$fn__21401
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.peer", (String)"TWatcher");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__21403;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__21403 = var2;
        v__6457__auto__21403 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return peer$fn__21401.invokeStatic();
    }
}
