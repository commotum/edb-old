...
public final class artemis_client$create_rpc_client$fn__20886$fn__20887
extends AFunction {
    Object dq;
    Object response_queue;
    public static final Var const__0 = RT.var((String)"datomic.error", (String)"report");

    public artemis_client$create_rpc_client$fn__20886$fn__20887(Object object, Object object2) {
        this.dq = object;
