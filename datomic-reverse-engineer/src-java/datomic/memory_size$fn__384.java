...
public final class memory_size$fn__384
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.memory-size", (String)"MemorySize");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__386;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__386 = var2;
        v__6457__auto__386 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return memory_size$fn__384.invokeStatic();
    }
}
