...
public final class SegSetStorage$reify__20273
...
IObj {
    ...
    public SegSetStorage$reify__20273(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public SegSetStorage$reify__20273(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new SegSetStorage$reify__20273(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical((Object)((IFn)const__1.getRawRoot()).invoke(gtarget), (Object)this.gclass)) {
            ...
            gtarget = null;
            object = ((SegSetStorage)object2).seg_id_set;
        } else {
            object = this;
        }
        return object;
