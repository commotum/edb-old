...
public final class val_cluster$fn__11188
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.val-cluster", (String)"Impl");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__11190;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__11190 = var2;
        v__6457__auto__11190 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return val_cluster$fn__11188.invokeStatic();
    }
}
