...
public final class kv_store$fn__10758
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.kv-store", (String)"KVStore");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__10760;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__10760 = var2;
        v__6457__auto__10760 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return kv_store$fn__10758.invokeStatic();
    }
}
