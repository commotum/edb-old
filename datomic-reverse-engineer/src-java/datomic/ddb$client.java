...
extends AFunction {
    ...
    public static final Keyword const__11 = RT.keyword(null, (String)"dynamodb");
    public static final Var const__12 = RT.var((String)"datomic.ddb", (String)"client");
        ...
        if (object2 != null && object2 != Boolean.FALSE) {
            ...
            if (object4 != null && object4 != Boolean.FALSE) {
                if (((IFn)const__2.getRawRoot()).invoke(creds) instanceof AWSCredentialsProvider) {
                    creds = null;
                    conf = null;
                    amazonDynamoDBClient = new AmazonDynamoDBClient((AWSCredentialsProvider)((IFn)const__2.getRawRoot()).invoke(creds), (ClientConfiguration)conf);
                } else {
                    creds = null;
                    conf = null;
                    amazonDynamoDBClient = new AmazonDynamoDBClient((AWSCredentials)((IFn)const__2.getRawRoot()).invoke(creds), (ClientConfiguration)conf);
                }
            } else if (new DefaultAWSCredentialsProviderChain() instanceof AWSCredentialsProvider) {
                conf = null;
                amazonDynamoDBClient = new AmazonDynamoDBClient((AWSCredentialsProvider)new DefaultAWSCredentialsProviderChain(), (ClientConfiguration)conf);
            } else {
                conf = null;
                amazonDynamoDBClient = new AmazonDynamoDBClient((AWSCredentialsProvider)new DefaultAWSCredentialsProviderChain(), (ClientConfiguration)conf);
            }
            AmazonDynamoDBClient conn = amazonDynamoDBClient;
    ...
    public Object invoke(Object object, Object object2) {
        ...
        object2 = null;
        return ddb$client.invokeStatic(object3, object4);
    }
    ...
    public static Object invokeStatic(Object creds) {
        ...
        if (object != null && object != Boolean.FALSE) {
            if (((IFn)const__2.getRawRoot()).invoke(creds) instanceof AWSCredentialsProvider) {
                creds = null;
                amazonDynamoDBClient = new AmazonDynamoDBClient((AWSCredentialsProvider)((IFn)const__2.getRawRoot()).invoke(creds));
            } else {
                creds = null;
                amazonDynamoDBClient = new AmazonDynamoDBClient((AWSCredentials)((IFn)const__2.getRawRoot()).invoke(creds));
            }
        } else {
            amazonDynamoDBClient = new DefaultAWSCredentialsProviderChain() instanceof AWSCredentialsProvider ? new AmazonDynamoDBClient((AWSCredentialsProvider)new DefaultAWSCredentialsProviderChain()) : new AmazonDynamoDBClient((AWSCredentialsProvider)new DefaultAWSCredentialsProviderChain());
        }
    ...
    public Object invoke(Object object) {
        ...
        object = null;
        return ddb$client.invokeStatic(object2);
    }

    public static Object invokeStatic() {
        return new DefaultAWSCredentialsProviderChain() instanceof AWSCredentialsProvider ? new AmazonDynamoDBClient((AWSCredentialsProvider)new DefaultAWSCredentialsProviderChain()) : new AmazonDynamoDBClient((AWSCredentialsProvider)new DefaultAWSCredentialsProviderChain());
    }

    public Object invoke() {
        return ddb$client.invokeStatic();
    }
}
