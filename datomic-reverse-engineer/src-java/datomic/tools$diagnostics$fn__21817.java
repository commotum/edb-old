...
public final class tools$diagnostics$fn__21817
extends AFunction {
    Object uri;
    public static final Var const__0 = RT.var((String)"datomic.tools", (String)"catalog");
    public static final Var const__1 = RT.var((String)"datomic.tools", (String)"tools-fault");

    public tools$diagnostics$fn__21817(Object object) {
        this.uri = object;
    }
