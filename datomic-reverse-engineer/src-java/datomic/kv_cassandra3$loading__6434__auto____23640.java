...
public final class kv_cassandra3$loading__6434__auto____23640
extends AFunction {
    ...
    public static final AFn const__5 = (AFn)Tuple.create((Object)Symbol.intern(null, (String)"datomic.cassandra-v4"), (Object)RT.keyword(null, (String)"as"), (Object)Symbol.intern(null, (String)"cass"));
    public static final AFn const__6 = (AFn)Tuple.create((Object)Symbol.intern(null, (String)"datomic.cassandra-values-v4"), (Object)RT.keyword(null, (String)"as"), (Object)Symbol.intern(null, (String)"cassv"));
    ...
    public Object invoke() {
        ...
        try {
            ...
            ((Namespace)RT.CURRENT_NS.deref()).importClass(RT.classForNameNonLoading((String)"com.datastax.oss.driver.api.core.CqlSessionBuilder"));
            ((Namespace)RT.CURRENT_NS.deref()).importClass(RT.classForNameNonLoading((String)"java.net.InetSocketAddress"));
            clazz = ((Namespace)RT.CURRENT_NS.deref()).importClass(RT.classForNameNonLoading((String)"javax.net.ssl.SSLContext"));
        }
        finally {
