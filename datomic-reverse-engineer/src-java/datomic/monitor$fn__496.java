...
public final class monitor$fn__496
extends AFunction {
    ...
    public static final AFn const__4 = (AFn)((IObj)Symbol.intern(null, (String)"datomic.monitor")).withMeta(RT.map((Object[])new Object[0]));
    ...
    public Object invoke() {
        return monitor$fn__496.invokeStatic();
    }
}
