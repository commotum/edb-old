...
public final class kv_store$fn__10817
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.kv-store", (String)"Retryable");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__10819;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__10819 = var2;
        v__6457__auto__10819 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return kv_store$fn__10817.invokeStatic();
    }
}
