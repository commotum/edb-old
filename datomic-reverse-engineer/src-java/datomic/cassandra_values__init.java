...
import datomic.cassandra_values$chunk_key;
import datomic.cassandra_values$delete_value;
import datomic.cassandra_values$fn__20517;
import datomic.cassandra_values$fn__20520;
import datomic.cassandra_values$get_value;
import datomic.cassandra_values$loading__6434__auto____20515;
import datomic.cassandra_values$put_value;
import java.util.Arrays;
import java.util.concurrent.Callable;

public class cassandra_values__init {
    ...
    public static void load() {
        ...
        Object object2 = ((IFn)new cassandra_values$loading__6434__auto____20515()).invoke();
        if (((Symbol)const__1).equals((Object)const__2)) {
            v2 = null;
        } else {
            LockingTransaction.runInTransaction((Callable)((Callable)((Object)new cassandra_values$fn__20517())));
            v2 = null;
        }
        ...
        Var var6 = var5;
        var5.bindRoot((Object)new cassandra_values$chunk_key());
        Object object4 = ((IFn)new cassandra_values$fn__20520()).invoke();
        Var var7 = const__19;
        ...
        Var var10 = var9;
        var9.bindRoot((Object)new cassandra_values$put_value());
        Var var11 = const__30;
        var11.setMeta((IPersistentMap)const__32);
        Var var12 = var11;
        var11.bindRoot((Object)new cassandra_values$get_value());
        Var var13 = const__33;
        var13.setMeta((IPersistentMap)const__35);
        Var var14 = var13;
        var13.bindRoot((Object)new cassandra_values$delete_value());
    }

    public static void __init0() {
        const__0 = RT.var((String)"clojure.core", (String)"in-ns");
        const__1 = (AFn)Symbol.intern(null, (String)"datomic.cassandra-values");
        const__2 = (AFn)Symbol.intern(null, (String)"clojure.core");
        const__3 = RT.var((String)"clojure.core", (String)"*warn-on-reflection*");
        const__4 = RT.var((String)"datomic.cassandra-values", (String)"CHUNK_SIZE");
        const__8 = (AFn)RT.map((Object[])new Object[]{RT.keyword(null, (String)"const"), Boolean.TRUE, RT.keyword(null, (String)"column"), 1});
        const__12 = RT.var((String)"datomic.cassandra-values", (String)"*retry*");
        const__14 = (AFn)RT.map((Object[])new Object[]{RT.keyword(null, (String)"dynamic"), Boolean.TRUE, RT.keyword(null, (String)"column"), 1});
        const__15 = RT.var((String)"datomic.cassandra-values", (String)"chunk-key");
        ...
        const__19 = RT.var((String)"datomic.cassandra-values", (String)"cql-keys");
        ...
        const__27 = RT.var((String)"datomic.cassandra-values", (String)"put-value");
        ...
        const__30 = RT.var((String)"datomic.cassandra-values", (String)"get-value");
        ...
        const__33 = RT.var((String)"datomic.cassandra-values", (String)"delete-value");
        const__35 = (AFn)RT.map((Object[])new Object[]{RT.keyword(null, (String)"arglists"), PersistentList.create(Arrays.asList(Tuple.create((Object)((IObj)Symbol.intern(null, (String)"session")).withMeta(RT.map((Object[])new Object[]{RT.keyword(null, (String)"tag"), Symbol.intern(null, (String)"Session")})), (Object)Symbol.intern(null, (String)"table"), (Object)Symbol.intern(null, (String)"id")))), RT.keyword(null, (String)"column"), 1});
    }

    static {
        cassandra_values__init.__init0();
        Compiler.pushNSandLoader((ClassLoader)RT.classForName((String)"datomic.cassandra_values__init").getClassLoader());
        try {
            cassandra_values__init.load();
        }
