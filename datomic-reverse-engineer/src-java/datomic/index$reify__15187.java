...
public final class index$reify__15187
...
IObj {
    ...
    public static final Var const__15 = RT.var((String)"datomic.common", (String)"compare");
    public static final Var const__16 = RT.var((String)"clojure.core", (String)"not");

    public index$reify__15187(IPersistentMap iPersistentMap) {
        this.__meta = iPersistentMap;
    }

    public index$reify__15187() {
        this(null);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new index$reify__15187(iPersistentMap);
    }
    ...
    public long compare(Datum x, TransposedData ys, long i) {
        ...
        if ((long)x.getA() < a) {
            ...
            if (keyword != null && keyword != Boolean.FALSE) {
                long c = ((IFn.OOL)const__15.getRawRoot()).invokePrim(x.getV(), ys.getV(RT.uncheckedIntCast((long)i)));
                ...
                if (object2 != null && object2 != Boolean.FALSE) {
                    ...
                    if (x.isAssertion() == transposedData.isAssertion(RT.uncheckedIntCast((long)i))) {
                        ...
                        if (datum2.isAssertion()) {
                            ...
                            object = keyword2 != null && keyword2 != Boolean.FALSE ? const__5 : null;
                        }
                    }
                }
            } else {
