...
public final class ClusterFS$reify__14212
...
IObj {
    ...
    public ClusterFS$reify__14212(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public ClusterFS$reify__14212(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new ClusterFS$reify__14212(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical((Object)((IFn)const__1.getRawRoot()).invoke(gtarget), (Object)this.gclass)) {
            ...
            gtarget = null;
            object = ((ClusterFS)object2).chunk_size;
        } else {
            object = this;
        }
        return object;
