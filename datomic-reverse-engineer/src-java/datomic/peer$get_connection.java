...
import datomic.peer$get_connection$fn__21645;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public final class peer$get_connection
extends AFunction {
    public static final Keyword const__0 = RT.keyword(null, (String)"event");
    public static final Keyword const__1 = RT.keyword((String)"peer", (String)"get-connection");
    public static final Keyword const__2 = RT.keyword(null, (String)"cluster-conf");
    ...
    public static Object invokeStatic(Object cluster_conf) {
        ...
        IPersistentMap m_21642 = RT.mapUniqueKeys((Object[])new Object[]{const__0, const__1, const__2, ((IFn)const__3.getRawRoot()).invoke(cluster_conf)});
        Logger logger = LoggerFactory.getLogger((String)"datomic.peer");
        if (logger.isDebugEnabled()) {
            Logger logger2 = logger;
            logger = null;
            logger2.debug((String)((IFn)const__4.getRawRoot()).invoke(((IFn)const__5.getRawRoot()).invoke((Object)m_21642, (Object)const__6, (Object)const__7)));
        }
        long start__8981__auto__21656 = System.nanoTime();
        Object object2 = cluster_conf;
        cluster_conf = null;
        Object result__8982__auto__21657 = ((IFn)new peer$get_connection$fn__21645(object2)).invoke();
        long elapsed_21643 = Numbers.minus((long)System.nanoTime(), (long)start__8981__auto__21656);
        Object msec_21644 = ((IFn)const__9.getRawRoot()).invoke((Object)Numbers.num((long)elapsed_21643));
        IFn iFn = (IFn)const__10.getRawRoot();
        IPersistentMap iPersistentMap2 = m_21642;
        m_21642 = null;
        Object object3 = msec_21644;
        msec_21644 = null;
        ...
        Object object5 = result__8982__auto__21657;
        ...
        if (object6 != null && object6 != Boolean.FALSE) {
            ...
            Object object7 = result__8982__auto__21657;
        ...
        Object endmsg__8984__auto__21654 = iFn.invoke(object4, iPersistentMap);
        Logger logger3 = LoggerFactory.getLogger((String)"datomic.peer");
        if (logger3.isDebugEnabled()) {
            Logger logger4 = logger3;
            logger3 = null;
            Object object9 = endmsg__8984__auto__21654;
            endmsg__8984__auto__21654 = null;
            logger4.debug((String)((IFn)const__4.getRawRoot()).invoke(object9));
        }
        Object object10 = ((IFn)const__15.getRawRoot()).invoke(result__8982__auto__21657, (Object)const__16);
        if (object10 != null && object10 != Boolean.FALSE) {
            ILookupThunk iLookupThunk3 = __thunk__2__;
            Object object11 = result__8982__auto__21657;
            result__8982__auto__21657 = null;
            ...
            Object object12 = result__8982__auto__21657;
            result__8982__auto__21657 = null;
    ...
    public Object invoke(Object object) {
        ...
        object = null;
        return peer$get_connection.invokeStatic(object2);
    }
}
