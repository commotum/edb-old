...
public final class cluster$fn__10424
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.cluster", (String)"Dbid");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__10426;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__10426 = var2;
        v__6457__auto__10426 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return cluster$fn__10424.invokeStatic();
    }
}
