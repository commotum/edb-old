...
public final class external_sort$fn__14416
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.external-sort", (String)"ExternalSort");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__14418;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__14418 = var2;
        v__6457__auto__14418 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return external_sort$fn__14416.invokeStatic();
    }
}
