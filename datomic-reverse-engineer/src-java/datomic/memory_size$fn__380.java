...
public final class memory_size$fn__380
extends AFunction {
    ...
    public static final AFn const__4 = (AFn)Symbol.intern(null, (String)"datomic.memory-size");
    ...
    public Object invoke() {
        return memory_size$fn__380.invokeStatic();
    }
}
