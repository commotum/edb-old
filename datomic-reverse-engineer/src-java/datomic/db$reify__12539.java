...
public final class db$reify__12539
...
IObj {
    ...
    public db$reify__12539(IPersistentMap iPersistentMap) {
        this.__meta = iPersistentMap;
    }

    public db$reify__12539() {
        this(null);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new db$reify__12539(iPersistentMap);
    }
