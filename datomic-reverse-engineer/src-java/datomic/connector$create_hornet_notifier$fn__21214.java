...
import datomic.connector$create_hornet_notifier$fn__21214$fn__21218;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public final class connector$create_hornet_notifier$fn__21214
extends AFunction {
    Object session;
    Object done_ref;
    Object hornet_consumer;
    Object result_queue;
    public static final AFn const__2 = (AFn)RT.map((Object[])new Object[]{RT.keyword(null, (String)"event"), RT.keyword((String)"connector", (String)"notify-cleanup")});
    ...
    public connector$create_hornet_notifier$fn__21214(Object object, Object object2, Object object3, Object object4) {
        this.session = object;
    ...
    public Object invoke() {
        ...
        AFn m_21215 = const__2;
        Logger logger = LoggerFactory.getLogger((String)"datomic.connector");
        if (logger.isDebugEnabled()) {
            Logger logger2 = logger;
            logger = null;
            logger2.debug((String)((IFn)const__3.getRawRoot()).invoke(((IFn)const__4.getRawRoot()).invoke((Object)m_21215, (Object)const__5, (Object)const__6)));
        }
        long start__8981__auto__21223 = System.nanoTime();
        Object result__8982__auto__21224 = ((IFn)new connector$create_hornet_notifier$fn__21214$fn__21218(this.session, this.done_ref, this.hornet_consumer, this.result_queue)).invoke();
        long elapsed_21216 = Numbers.minus((long)System.nanoTime(), (long)start__8981__auto__21223);
        Object msec_21217 = ((IFn)const__8.getRawRoot()).invoke((Object)Numbers.num((long)elapsed_21216));
        IFn iFn = (IFn)const__9.getRawRoot();
        AFn aFn = m_21215;
        m_21215 = null;
        Object object2 = msec_21217;
        msec_21217 = null;
        Object object3 = ((IFn)const__4.getRawRoot()).invoke((Object)aFn, (Object)const__10, object2, (Object)const__5, (Object)const__11);
        ILookupThunk iLookupThunk = __thunk__0__;
        Object object4 = result__8982__auto__21224;
        ...
        if (object5 != null && object5 != Boolean.FALSE) {
            ...
            Object object6 = result__8982__auto__21224;
        ...
        Object endmsg__8984__auto__21221 = iFn.invoke(object3, iPersistentMap);
        Logger logger3 = LoggerFactory.getLogger((String)"datomic.connector");
        if (logger3.isDebugEnabled()) {
            Logger logger4 = logger3;
            logger3 = null;
            Object object8 = endmsg__8984__auto__21221;
            endmsg__8984__auto__21221 = null;
            logger4.debug((String)((IFn)const__3.getRawRoot()).invoke(object8));
        }
        Object object9 = ((IFn)const__14.getRawRoot()).invoke(result__8982__auto__21224, (Object)const__15);
        if (object9 != null && object9 != Boolean.FALSE) {
            ILookupThunk iLookupThunk3 = __thunk__2__;
            Object object10 = result__8982__auto__21224;
            result__8982__auto__21224 = null;
            ...
            Object object11 = result__8982__auto__21224;
            result__8982__auto__21224 = null;
