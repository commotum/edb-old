...
public final class db$reify__12535
...
IObj {
    ...
    public db$reify__12535(IPersistentMap iPersistentMap) {
        this.__meta = iPersistentMap;
    }

    public db$reify__12535() {
        this(null);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new db$reify__12535(iPersistentMap);
    }
    ...
    public int compare(Object x, Object y) {
        ...
        y = null;
        Object y2 = object3;
        if (((IDatum)x2).getE() < ((IDatum)y2).getE()) {
            object = const__1;
