...
public final class impl$loading__6434__auto____283
extends AFunction {
    ...
    public Object invoke() {
        ...
        try {
            ...
            clazz = ((Namespace)RT.CURRENT_NS.deref()).importClass(RT.classForNameNonLoading((String)"java.util.concurrent.ConcurrentMap"));
        }
        finally {
