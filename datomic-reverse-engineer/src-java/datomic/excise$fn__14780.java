...
public final class excise$fn__14780
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.excise", (String)"ExcisePred");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__14782;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__14782 = var2;
        v__6457__auto__14782 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return excise$fn__14780.invokeStatic();
    }
}
