...
public final class db$fn__12445
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.db", (String)"LocalizeTempid");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__12447;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__12447 = var2;
        v__6457__auto__12447 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return db$fn__12445.invokeStatic();
    }
}
