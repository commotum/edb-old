...
public final class log$fn__20558
extends AFunction {
    ...
    public static final AFn const__4 = (AFn)((IObj)Symbol.intern(null, (String)"datomic.core2.log")).withMeta(RT.map((Object[])new Object[0]));
    ...
    public Object invoke() {
        return log$fn__20558.invokeStatic();
    }
}
