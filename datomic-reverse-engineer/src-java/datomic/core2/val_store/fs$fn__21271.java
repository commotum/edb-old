...
public final class fs$fn__21271
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.core2.val-store.fs", (String)"Impl");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6812__auto__21273;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6812__auto__21273 = var2;
        v__6812__auto__21273 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return fs$fn__21271.invokeStatic();
    }
}
