...
public final class process$fn__14893
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.process", (String)"CriticalFailure");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__14895;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__14895 = var2;
        v__6457__auto__14895 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return process$fn__14893.invokeStatic();
    }
}
