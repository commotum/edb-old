...
public final class queue$fn__12018
extends AFunction {
    public static final Var const__0 = RT.var((String)"datomic.queue", (String)"Consumer");
    ...
    public static Object invokeStatic() {
        Var var;
        Var v__6457__auto__12020;
        Var var2 = const__0;
        var2.setMeta((IPersistentMap)const__3);
        Var var3 = v__6457__auto__12020 = var2;
        v__6457__auto__12020 = null;
        if (var3.hasRoot()) {
            var = null;
        } else {
            Var var4 = const__0;
    ...
    public Object invoke() {
        return queue$fn__12018.invokeStatic();
    }
}
