...
public final class ConnectionState$reify__21314
...
IObj {
    ...
    public ConnectionState$reify__21314(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public ConnectionState$reify__21314(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new ConnectionState$reify__21314(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical((Object)((IFn)const__1.getRawRoot()).invoke(gtarget), (Object)this.gclass)) {
            ...
            gtarget = null;
            object = ((ConnectionState)object2).cleanup;
        } else {
            object = this;
        }
        return object;
