...
public final class db$fn__12386
extends AFunction {
    ...
    public static final AFn const__4 = (AFn)((IObj)Symbol.intern(null, (String)"datomic.db")).withMeta(RT.map((Object[])new Object[]{RT.keyword(null, (String)"author"), "Rich Hickey"}));
    ...
    public Object invoke() {
        return db$fn__12386.invokeStatic();
    }
}
