...
public final class IndexSet$reify__12774
...
IObj {
    ...
    public IndexSet$reify__12774(IPersistentMap iPersistentMap, Object object) {
        this.__meta = iPersistentMap;
        this.gclass = object;
    }

    public IndexSet$reify__12774(Object object) {
        this(null, object);
    }
    ...
    public IObj withMeta(IPersistentMap iPersistentMap) {
        return new IndexSet$reify__12774(iPersistentMap, this.gclass);
    }
    ...
    public Object get(Object gtarget) {
        ...
        if (Util.identical((Object)((IFn)const__1.getRawRoot()).invoke(gtarget), (Object)this.gclass)) {
            ...
            gtarget = null;
            object = ((IndexSet)object2).fulltext;
        } else {
            object = this;
        }
        return object;
