...
the same way as eager execution. See [query sources](queries.md) and the executable
...
See [native programs](programs.md) and [read_invoke.rs](../tests/read_invoke.rs).
